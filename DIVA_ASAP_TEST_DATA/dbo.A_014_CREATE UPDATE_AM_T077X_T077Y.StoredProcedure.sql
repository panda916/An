...
-- 14_02_2023 : Copy script from DIVA_MASTER_SCRIPT.
-- =============================================
CREATE       PROCEDURE [dbo].[A_014_CREATE/UPDATE_AM_T077X_T077Y]
AS
BEGIN
	/*
	...
	*/
	...
	FROM A_T077X
	WHERE NOT EXISTS (SELECT TOP 1 1 FROM AM_T077X WHERE A_T077X.T077X_SPRAS = AM_T077X.T077X_SPRAS AND A_T077X.T077X_KTOKD = AM_T077X.T077X_KTOKD)
	...
	*/
	...
	FROM A_T077Y
	WHERE NOT EXISTS (SELECT TOP 1 1 FROM AM_T077Y WHERE A_T077Y.T077Y_SPRAS = AM_T077Y.T077Y_SPRAS AND A_T077Y.T077Y_KTOKK = AM_T077Y.T077Y_KTOKK)
