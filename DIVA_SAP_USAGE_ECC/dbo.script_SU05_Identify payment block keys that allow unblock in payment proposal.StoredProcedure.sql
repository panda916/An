...
SELECT 
	...
	IIF( B11C_BSAIK_AUGDT BETWEEN ZF_CDHDR_UDATE_BLOCK AND ZF_CDHDR_UDATE_UNBLOCK,'X',''  ) AS ZF_BSAK_AUGDT_DURING_BLOCK
INTO SU05_08_XT_INVOICE_BETWEEN_BLOCK_UNBLOCK
FROM B11_06_IT_PTP_INV
INNER JOIN SU05_07_XT_CDHDR_CDPOS_UDATE_BLOCK_UNBLOCK
	ON ZF_CDHDR_OBJECTID_BLOCK =B11C_BSAIK_MANDT+B11C_BSAIK_BUKRS+B11C_BSAIK_BELNR+B11C_BSAIK_GJAHR
...
SELECT 
	B11_08_IT_PTP_PAY.*,ZF_BSAK_AUGDT_DURING_BLOCK
INTO SU05_09_XT_PAYMENT_RELATE_INV_PAYMENT_BLOCK
FROM
	B11_08_IT_PTP_PAY
INNER JOIN 
	SU05_08_XT_INVOICE_BETWEEN_BLOCK_UNBLOCK ON 
	B11C_BSAIK_AUGDT=B11E_BSAIK_AUGDT AND  
	B11C_BSAIK_AUGBL=B11E_BSAIK_AUGBL AND 
	B11C_BSAIK_BUKRS=B11E_BSAIK_BUKRS
