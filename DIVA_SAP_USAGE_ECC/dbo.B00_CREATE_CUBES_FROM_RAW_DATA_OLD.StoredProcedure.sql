...
-- =============================================
CREATE PROCEDURE [dbo].[B00_CREATE_CUBES_FROM_RAW_DATA_OLD](@DBNAME as NVARCHAR(MAX))
AS
BEGIN	
...
---- STep 2 SOD user
	EXEC SP_EXEC_DYNAMIC @DBNAME, 'script_B22_SOD_MATRIX_PART1_UPTO_STEP7'
...
--Step 3.1 Create JE infor cube
	...
	EXEC SP_EXEC_DYNAMIC @DBNAME, 'script_BC40_FIN_GENERAL_LEDGER'

----Step  3.2 Create Material movement cube
	EXEC SP_EXEC_DYNAMIC @DBNAME, 'script_BC39_MSEG_MKPF'
...
----STep 3.4 Create PTP cubes
	...
	EXEC SP_EXEC_DYNAMIC @DBNAME, 'script_BP02A_PURCHASE_ORDERS'
	EXEC SP_EXEC_DYNAMIC @DBNAME, 'script_BC41_FIN_AP_AUTOMAPPING'
	EXEC SP_EXEC_DYNAMIC @DBNAME, 'script_BC42_PTP_APA'
	EXEC SP_EXEC_DYNAMIC @DBNAME, 'script_BP02B_PO_HISTORY'
	...
	EXEC SP_EXEC_DYNAMIC @DBNAME, 'script_BP06_DUPLICATE_INVOICES'
...
----Step 3.5 Create OTC cube
	...
	EXEC SP_EXEC_DYNAMIC @DBNAME, 'script_BO02_SALES_ORDERS'
	EXEC SP_EXEC_DYNAMIC @DBNAME, 'script_BO03_GOODS_ISSUES'
	EXEC SP_EXEC_DYNAMIC @DBNAME, 'script_BO04A_SD_INVOICES'
	EXEC SP_EXEC_DYNAMIC @DBNAME, 'script_BO05_TVAK_SALES_DOCUMENT_TYPE'
	EXEC SP_EXEC_DYNAMIC @DBNAME, 'script_BO06_DELIVERY_DOC'
