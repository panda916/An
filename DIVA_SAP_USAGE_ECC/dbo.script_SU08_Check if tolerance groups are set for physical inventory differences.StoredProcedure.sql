...
ON B04_ZF_BKPF_AWKEY_DOC_NUM=BP03_01_MKPF_MBLNR AND
   B04_ZF_BKPF_AWKEY_YEAR=BP03_01_MKPF_MJAHR AND B04_BKPF_AWTYP='MKPF'
WHERE BP03_01_MKPF_TCODE2 LIKE 'MI%' AND 
	LEN(TRIM(BP03_01_MSEG_XAUTO)) = 0 AND 
	B04_BSEG_BUKRS IN (SELECT DISTINCT T001_BUKRS FROM SU08_03_XT_T001_BURKS_NOT_IN_T043);
...
SELECT DISTINCT 
	...
	BSEG_GJAHR,BSEG_BELNR,BSEG_BUKRS
	,BP03_01_IT_GR.*
...
--Then join back to MSEG-MKPF to get ther related MSEG_MKPF
INNER JOIN SU08_04_XT_JE_RELATE_MSEG_FILTERED 
ON B04_BSEG_GJAHR = BSEG_GJAHR AND	
	B04_BSEG_BELNR = BSEG_BELNR AND	
	B04_BSEG_BUKRS = BSEG_BUKRS
--Get the GR related, filter MKPF_TCODE2 and MSEG_XAUTO
LEFT JOIN  BP03_01_IT_GR
 ON B04_ZF_BKPF_AWKEY_DOC_NUM= BP03_01_MKPF_MBLNR AND
    B04_ZF_BKPF_AWKEY_YEAR= BP03_01_MKPF_MJAHR AND
	B04_BKPF_AWTYP='MKPF' AND  
...
EXEC SP_UNNAME_FIELD 'B04_','SU08_04_XT_JE_RELATE_MSEG_FILTERED'
...
EXEC SP_UNNAME_FIELD 'B04_','SU08_05_XT_MKPF_MSEG_ACCT_SCHEME'
