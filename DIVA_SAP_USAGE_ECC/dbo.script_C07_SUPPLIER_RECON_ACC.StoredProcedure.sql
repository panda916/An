...
LEFT JOIN 
	(
		SELECT 
			...
			SUM(BP03_01_ZF_MSEG_DMBTR_S_CUC) AS ZF_SUM_MSEG_DMBTR_S_CUC
		FROM BP03_01_IT_GR
...
LEFT JOIN 
	(
		...
		WHERE LEN(B04_BSEG_LIFNR) >0
		GROUP BY B04_BSEG_BUKRS,B04_BSEG_LIFNR
	) AS E ON
	B04_BSEG_BUKRS=BP04A_01_RBKP_BUKRS AND
	B04_BSEG_LIFNR=BP04A_01_LFA1_LIFNR
