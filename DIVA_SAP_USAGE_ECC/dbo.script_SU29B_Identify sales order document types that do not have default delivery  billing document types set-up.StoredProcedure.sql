...
EXEC SP_DROPTABLE 'SU29B_02_XT_VBAK_VBAP_SALES_DOC'
	SELECT B33_01_IT_SALE_DOCUMENTS.*,
		TVAKT_BEZEI,
		B33_ZF_DD07T_DDTEXT_VBTYP AS ZF_VBAK_VBTYP_DESCRIPTION
...
--Get the sale document where it do not have billing document
		AND  B33_VBAK_VBELN+B33_VBAP_POSNR  NOT IN   
		(
...
LEFT JOIN B34_01_IT_DELIVERY_DOCS
	ON B33_VBAK_VBELN = LIPS_VGBEL AND B33_VBAP_POSNR = LIPS_VGPOS
LEFT JOIN B36_01_IT_INVOICE_DOCS
	ON B33_VBAK_VBELN = B36_VBRP_VGBEL AND 
		B33_VBAP_POSNR = B36_VBRP_VGPOS
	-- Just get sales order document type
	WHERE B33_VBAK_VBTYP = 'C' AND 
...
EXEC SP_DROPTABLE 'SU29B_04_XT_LIKP_SOS_NO_DEFAULT_DELI_BILL'
	SELECT DISTINCT B34_01_IT_DELIVERY_DOCS.*,
		   B33_VBAK_VBELN,
		   B33_VBAP_POSNR,
		   B33_VBAK_AUART,
	...
	ON B33_VBAK_VBELN = LIPS_VGBEL AND B33_VBAP_POSNR = LIPS_VGPOS
	LEFT JOIN A_TVPT
	ON B33_VBAP_PSTYV = A_TVPT.TVPT_PSTYV
...
-- Unname the fields
EXEC SP_UNNAME_FIELD 'B33_', 'SU29B_02_XT_VBAK_VBAP_SALES_DOC'
EXEC SP_UNNAME_FIELD 'B33_', 'SU29B_03_XT_VBAK_VBAP_SOS_NO_DEFAULT_DELI_BILL'
EXEC SP_UNNAME_FIELD 'B36_', 'SU29B_03_XT_VBAK_VBAP_SOS_NO_DEFAULT_DELI_BILL'
EXEC SP_UNNAME_FIELD 'B33_', 'SU29B_04_XT_LIKP_SOS_NO_DEFAULT_DELI_BILL'
EXEC SP_UNNAME_FIELD 'B33_', 'SU29B_05_XT_VBAP_SOS_NO_DEFAULT_DELI_BILL'
EXEC SP_UNNAME_FIELD 'B36_', 'SU29B_05_XT_VBAP_SOS_NO_DEFAULT_DELI_BILL'
-- Rename the fields
