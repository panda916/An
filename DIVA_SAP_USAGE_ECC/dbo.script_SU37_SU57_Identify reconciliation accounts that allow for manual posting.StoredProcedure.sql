...
IIF(B04_BKPF_BUDAT<CDHDR_UDATE,'X','') AS ZF_BKPF_BUDAT_BEFORE_CDHDR_UDATE
INTO SU37_07_XT_FIN_GL_LFB1_AKONT_BLANK
FROM B04_11_IT_FIN_GL
INNER JOIN 
SU37_02_RT_LFB1_LFA1_T001_SKAT
ON SU37_02_LFB1_LIFNR=B04_BSEG_LIFNR AND SU37_02_LFB1_AKONT='' AND SU37_02_LFB1_LIFNR IN
(
...
ON CDHDR_OBJECTID=B04_BSEG_LIFNR AND CDPOS_FNAME='AKONT'
...
SELECT DISTINCT B04_11_IT_FIN_GL.*,
IIF(B04_BKPF_BUDAT<CDHDR_UDATE,'X','') AS ZF_BKPF_BUDAT_BEFORE_CDHDR_UDAT
INTO SU37_08_XT_FIN_GL_KNB1_AKONT_BLANK
FROM B04_11_IT_FIN_GL
INNER JOIN 
SU37_03_RT_KNB1_KNA1_T001_SKAT
ON SU37_03_KNB1_KUNNR=B04_BSEG_KUNNR AND SU37_03_KNB1_AKONT='' AND SU37_03_KNB1_KUNNR IN
(
...
ON B04_BSEG_KUNNR=CDHDR_OBJECTID  AND CDPOS_FNAME='AKONT'
...
ON B04_BSEG_ANLN1=ANLB_ANLN1 AND B04_BSEG_ANLN2=ANLB_ANLN2
...
CDHDR_OBJECTID=B04_BSEG_LIFNR AND CDPOS_FNAME='AKONT'
...
CDHDR_OBJECTID=B04_BSEG_KUNNR AND  CDPOS_FNAME='AKONT'


--Rename the fields
EXEC SP_UNNAME_FIELD 'B04_','SU37_07_XT_FIN_GL_LFB1_AKONT_BLANK'
EXEC SP_RENAME_FIELD 'SU37_07_','SU37_07_XT_FIN_GL_LFB1_AKONT_BLANK'

EXEC SP_UNNAME_FIELD 'B04_','SU37_08_XT_FIN_GL_KNB1_AKONT_BLANK'
EXEC SP_RENAME_FIELD 'SU37_08_','SU37_08_XT_FIN_GL_KNB1_AKONT_BLANK'

EXEC SP_UNNAME_FIELD 'B04_','SU37_09_XT_FIN_GL_ANLA_ANLB_REC_ACCOUNT_BLANK'
