...
-- 16_03_2022 AN : Remove MANDT field (join)
...
FROM 		A005D_01_TT_EKPO_MATNR_MATKL
	...
	LEFT JOIN B00_T134T
		ON A005D_02_TT_MARA_GROUPBY.MARA_MTART = B00_T134T.T134T_MTART
		
	-- Material descriptions
	LEFT JOIN B00_MAKT
		ON A005D_01_TT_EKPO_MATNR_MATKL.EKPO_MATNR = B00_MAKT.MAKT_MATNR
	
	-- Material group descriptions	
	LEFT JOIN B00_T023T
		ON A005D_01_TT_EKPO_MATNR_MATKL.EKPO_MATKL = B00_T023T.T023T_MATKL
