...
BEGIN
	...
	IF NOT EXISTS(SELECT TOP 1 1 FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'AM_SPEND_CATEGORY')
		BEGIN
			CREATE TABLE [dbo].[AM_SPEND_CATEGORY](
				...
				[SPCAT_SCIS_DESCRIPTION] [nvarchar](100) NULL,
	...
	*/
	...
	ON A_BSEG.BSEG_MANDT = A08_04_TT_AP_DOCS.BSEG_MANDT AND
	   A_BSEG.BSEG_BUKRS = A08_04_TT_AP_DOCS.BSEG_BUKRS AND
	...
	*/
	INSERT INTO [dbo].[AM_SPEND_CATEGORY] ([SPCAT_GL_ACCNT],[SPCAT_SCIS_DESCRIPTION])
	SELECT DISTINCT BSEG_HKONT, SKAT_TXT50
