...
CREATE   PROCEDURE [dbo].[A_004_CREATE_PROCUREMENT_CATEGORY_STRUCTURE_EXE] 
...
FROM 		A005D_01_TT_EKPO_MATNR_MATKL
	...
	LEFT JOIN A_T134T
		ON A005D_02_TT_MARA_GROUPBY.MARA_MANDT = A_T134T.T134T_MANDT 
		AND A005D_02_TT_MARA_GROUPBY.MARA_MTART = A_T134T.T134T_MTART
		
	-- Material descriptions
	LEFT JOIN A_MAKT
		ON A005D_01_TT_EKPO_MATNR_MATKL.EKPO_MANDT = A_MAKT.MAKT_MANDT 
		AND A005D_01_TT_EKPO_MATNR_MATKL.EKPO_MATNR = A_MAKT.MAKT_MATNR
	
	-- Material group descriptions	
	LEFT JOIN A_T023T
		ON A005D_01_TT_EKPO_MATNR_MATKL.EKPO_MANDT = A_T023T.T023T_MANDT 
		AND A005D_01_TT_EKPO_MATNR_MATKL.EKPO_MATKL = A_T023T.T023T_MATKL
	WHERE COALESCE(A005D_01_TT_EKPO_MATNR_MATKL.EKPO_MATNR,'') <> ''	
	GROUP BY A005D_01_TT_EKPO_MATNR_MATKL.EKPO_MATNR, A_T134T.T134T_MTBEZ, A005D_01_TT_EKPO_MATNR_MATKL.EKPO_MATKL, A_T023T.T023T_WGBEZ, A_MAKT.MAKT_MAKTX
