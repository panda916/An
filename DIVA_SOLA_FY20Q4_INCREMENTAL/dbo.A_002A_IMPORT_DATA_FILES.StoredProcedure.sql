...
ELSE
  ...
  END
	...
	PRINT CONCAT('@fieldtermdef: ', @fieldtermdef)
PRINT CONCAT('@rowtermdef: ', @rowtermdef)
PRINT CONCAT('@conversion_needed: ', @conversion_needed)
PRINT CONCAT('@TXTFileName: ', @TXTFileName)
	PRINT 'VINH-END'
...
--	Load staging results into stageDataLog
 ...
 -- HdG more informative error messages
    ...
    ******************************************************************/
    ...
    PRINT CONCAT('VINH_AGAIN: ', @createtable)
