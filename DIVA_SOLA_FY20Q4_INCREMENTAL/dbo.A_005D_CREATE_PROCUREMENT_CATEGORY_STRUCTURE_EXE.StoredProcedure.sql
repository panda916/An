...
SELECT 
		...
		COALESCE(B00_T134T.T134T_MTBEZ,'')				AS [PROC_CAT_L1],    
		COALESCE(A005D_01_TT_EKPO_MATNR_MATKL.EKPO_MATKL, '')	AS [PROC_CAT_MTRL_GRP_CODE],
		COALESCE(B00_T023T.T023T_WGBEZ, '')				AS [PROC_CAT_L2],
		COALESCE (B00_MAKT.MAKT_MAKTX,'')				AS [PROC_CAT_L3]
...
FROM 		A005D_01_TT_EKPO_MATNR_MATKL
	...
	LEFT JOIN A005D_02_TT_MARA_GROUPBY
		ON A005D_01_TT_EKPO_MATNR_MATKL.EKPO_MANDT = A005D_02_TT_MARA_GROUPBY.MARA_MANDT 
		AND A005D_01_TT_EKPO_MATNR_MATKL.EKPO_MATNR = A005D_02_TT_MARA_GROUPBY.MARA_MATNR 
	
	-- Material type descriptions
	LEFT JOIN B00_T134T
		ON A005D_02_TT_MARA_GROUPBY.MARA_MANDT = B00_T134T.T134T_MANDT 
		AND A005D_02_TT_MARA_GROUPBY.MARA_MTART = B00_T134T.T134T_MTART
		
	-- Material descriptions
	LEFT JOIN B00_MAKT
		ON A005D_01_TT_EKPO_MATNR_MATKL.EKPO_MANDT = B00_MAKT.MAKT_MANDT 
		AND A005D_01_TT_EKPO_MATNR_MATKL.EKPO_MATNR = B00_MAKT.MAKT_MATNR
	
	-- Material group descriptions	
	LEFT JOIN B00_T023T
		ON A005D_01_TT_EKPO_MATNR_MATKL.EKPO_MANDT = B00_T023T.T023T_MANDT 
		AND A005D_01_TT_EKPO_MATNR_MATKL.EKPO_MATKL = B00_T023T.T023T_MATKL
	WHERE COALESCE(A005D_01_TT_EKPO_MATNR_MATKL.EKPO_MATNR,'') <> ''	
	GROUP BY A005D_01_TT_EKPO_MATNR_MATKL.EKPO_MATNR, B00_T134T.T134T_MTBEZ, A005D_01_TT_EKPO_MATNR_MATKL.EKPO_MATKL, B00_T023T.T023T_WGBEZ, B00_MAKT.MAKT_MAKTX
