...
CREATE     PROCEDURE [dbo].[script_B04_FIN_GENERAL_LEDGER_080923]
...
EXEC sp_droptable    'B04_05_TT_BKPF_BSEG'
       ...
       ON A_BSEG.BSEG_KOKRS = B04_02_TT_CSKT_DATBI.CSKT_KOKRS AND 
		...
		ON	A_BSEG.BSEG_BUKRS = B04_04_TT_CEPCT_UNIQUE.CEPCT_KOKRS AND
			A_BSEG.BSEG_KOKRS = B04_04_TT_CEPCT_UNIQUE.CEPCT_KOKRS AND
	   ...
	   EXEC SP_CREATE_INDEX 'BSEG_BUKRS,BSEG_GJAHR,BSEG_BELNR,BSEG_SHKZG,GL_BANK_ACC_HKONT,SKA1_XBILK,SKA1_GVTYP,BSEG_KOART,BSEG_KOSTL,CSKT_KTEXT,CEPCT_MCTXT', 'B04_05_TT_BKPF_BSEG'
...
*/
	...
	EXEC SP_DROPTABLE 'B04_05_TT_BKPF_BSEG_GROUPPED'
	SELECT
	BSEG_BUKRS, BSEG_GJAHR, BSEG_BELNR, BSEG_SHKZG, SKAT_TXT20, BSEG_HKONT, BSEG_KOART, ZF_T012K_FEBKO_SKB1_HBKID_XGKON_FLAG, SKB1_XGKON, SKB1_XOPVW, SKA1_GVTYP,
	ROW_NUMBER() OVER (PARTITION BY BSEG_BUKRS, BSEG_GJAHR, BSEG_BELNR, BSEG_SHKZG ORDER BY ABS(SUM(BSEG_DMBTR)) DESC) RN, SUM(BSEG_DMBTR) AS ZF_BSEG_DMBTR_TOTAL
	INTO B04_05_TT_BKPF_BSEG_GROUPPED
	FROM B04_05_TT_BKPF_BSEG
	GROUP BY BSEG_BUKRS, BSEG_GJAHR, BSEG_BELNR, BSEG_SHKZG, SKAT_TXT20, BSEG_HKONT, BSEG_KOART, ZF_T012K_FEBKO_SKB1_HBKID_XGKON_FLAG, SKB1_XGKON, SKB1_XOPVW, SKA1_GVTYP

	CREATE CLUSTERED INDEX IDX ON B04_05_TT_BKPF_BSEG_GROUPPED(BSEG_BUKRS, BSEG_GJAHR, BSEG_BELNR, BSEG_SHKZG, RN)

	EXEC SP_DROPTABLE 'B04_05B_TT_BKPF_BSEG_GROUPED_CATEGORY'

	SELECT 
	BSEG_BUKRS, BSEG_GJAHR, BSEG_BELNR, BSEG_SHKZG,
	STUFF((SELECT B.SKAT_TXT20 + '_'
			  FROM B04_05_TT_BKPF_BSEG_GROUPPED B WHERE A.BSEG_BUKRS = B.BSEG_BUKRS AND A.BSEG_GJAHR = B.BSEG_GJAHR AND A.BSEG_BELNR = B.BSEG_BELNR AND A.BSEG_SHKZG = B.BSEG_SHKZG
			  ORDER BY ZF_BSEG_DMBTR_TOTAL DESC FOR XML PATH('')), 1, 0, '') SKAT_TXT20,
	STUFF((SELECT B.BSEG_HKONT + '_'
			  FROM B04_05_TT_BKPF_BSEG_GROUPPED B WHERE A.BSEG_BUKRS = B.BSEG_BUKRS AND A.BSEG_GJAHR = B.BSEG_GJAHR AND A.BSEG_BELNR = B.BSEG_BELNR AND A.BSEG_SHKZG = B.BSEG_SHKZG
			  ORDER BY ZF_BSEG_DMBTR_TOTAL DESC FOR XML PATH('')), 1, 0, '') BSEG_HKONT,
	STUFF((SELECT B.BSEG_KOART + '_'
			  FROM B04_05_TT_BKPF_BSEG_GROUPPED B WHERE A.BSEG_BUKRS = B.BSEG_BUKRS AND A.BSEG_GJAHR = B.BSEG_GJAHR AND A.BSEG_BELNR = B.BSEG_BELNR AND A.BSEG_SHKZG = B.BSEG_SHKZG
			  ORDER BY ZF_BSEG_DMBTR_TOTAL DESC FOR XML PATH('')), 1, 0, '') BSEG_KOART,
	STUFF((SELECT ZF_T012K_FEBKO_SKB1_HBKID_XGKON_FLAG + '_'
			  FROM B04_05_TT_BKPF_BSEG_GROUPPED B WHERE A.BSEG_BUKRS = B.BSEG_BUKRS AND A.BSEG_GJAHR = B.BSEG_GJAHR AND A.BSEG_BELNR = B.BSEG_BELNR AND A.BSEG_SHKZG = B.BSEG_SHKZG
			  ORDER BY ZF_BSEG_DMBTR_TOTAL DESC FOR XML PATH('')), 1, 0, '') ZF_T012K_FEBKO_SKB1_HBKID_XGKON_FLAG,
	STUFF((SELECT IIF(ISNULL(B.SKA1_GVTYP, '') = '', '', 'Y') + '_' 
			  FROM B04_05_TT_BKPF_BSEG_GROUPPED B WHERE A.BSEG_BUKRS = B.BSEG_BUKRS AND A.BSEG_GJAHR = B.BSEG_GJAHR AND A.BSEG_BELNR = B.BSEG_BELNR AND A.BSEG_SHKZG = B.BSEG_SHKZG
			  ORDER BY ZF_BSEG_DMBTR_TOTAL DESC FOR XML PATH('')), 1, 0, '') SKA1_GVTYP


	INTO B04_05B_TT_BKPF_BSEG_GROUPED_CATEGORY
	FROM (SELECT DISTINCT BSEG_BUKRS, BSEG_GJAHR, BSEG_BELNR, BSEG_SHKZG FROM B04_05_TT_BKPF_BSEG_GROUPPED) A

	-- Create clustered index to improve joining time.
	CREATE NONCLUSTERED INDEX IDX ON B04_05B_TT_BKPF_BSEG_GROUPED_CATEGORY(BSEG_BUKRS, BSEG_GJAHR, BSEG_BELNR, BSEG_SHKZG)
...
EXEC SP_DROPTABLE 'B04_06B_TT_BKPF_BSEG'
SELECT DISTINCT B04_05_TT_BKPF_BSEG.BSEG_BUKRS
                    ,B04_05_TT_BKPF_BSEG.BSEG_GJAHR
                    ,B04_05_TT_BKPF_BSEG.BSEG_BELNR
					 ,B04_05_TT_BKPF_BSEG.BKPF_TCODE INTO B04_06B_TT_BKPF_BSEG FROM B04_05_TT_BKPF_BSEG
...
EXEC SP_DROPTABLE    'B04_07_IT_BSEG_BKPF_ACC_SCH'
                    ...
                    SELECT
                    B04_06B_TT_BKPF_BSEG.BSEG_BUKRS
                    ,B04_06B_TT_BKPF_BSEG.BSEG_GJAHR
                    ,B04_06B_TT_BKPF_BSEG.BSEG_BELNR
					,B04_06B_TT_BKPF_BSEG.BKPF_TCODE
					 --Create a list of debit account types
                    ,GROUP_CATEGORY_DEBIT.BSEG_KOART ZF_DEBIT_ACCOUNT_TYPES
                     --Create a list of credit account types
					 ,GROUP_CATEGORY_CREDIT.BSEG_KOART ZF_CREDIT_ACCOUNT_TYPES      

					 --Create a list for indicator of G/L bank accounts from T012K, FEBKO, and SKB1 for credit
					 ,GROUP_CATEGORY_DEBIT.ZF_T012K_FEBKO_SKB1_HBKID_XGKON_FLAG ZF_DEBIT_T012K_FEBKO_SKB1_HBKID_XGKON_FLAG_LIST
					 --Create a list for indicator of G/L bank accounts from T012K, FEBKO, and SKB1 for debit
					 ,GROUP_CATEGORY_CREDIT.ZF_T012K_FEBKO_SKB1_HBKID_XGKON_FLAG ZF_CREDIT_T012K_FEBKO_SKB1_HBKID_XGKON_FLAG_LIST

					 --Create a list indicator of SKA1_GVTYP for debit
					 ,GROUP_CATEGORY_DEBIT.SKA1_GVTYP ZF_DEBIT_SKA1_GVTYP_FLAG_LIST
					 --Create a list indicator of SKA1_GVTYP for credit
					  ,GROUP_CATEGORY_CREDIT.SKA1_GVTYP ZF_CREDIT_SKA1_GVTYP_FLAG_LIST

					 ,GROUP_CATEGORY_DEBIT.BSEG_HKONT ZF_DEBIT_HKONT_LIST
					 ,GROUP_CATEGORY_CREDIT.BSEG_HKONT ZF_CREDIT_HKONT_LIST					 
					 ,GROUP_CATEGORY_DEBIT.SKAT_TXT20 ZF_DEBIT_SKAT_TXT20_LIST
					 ,GROUP_CATEGORY_CREDIT.SKAT_TXT20 ZF_CREDIT_SKAT_TXT20_LIST

					 --Create JE number line columns
                    INTO B04_07_IT_BSEG_BKPF_ACC_SCH
                    FROM B04_06B_TT_BKPF_BSEG
                    LEFT JOIN B04_05B_TT_BKPF_BSEG_GROUPED_CATEGORY GROUP_CATEGORY_DEBIT ON GROUP_CATEGORY_DEBIT.BSEG_BUKRS = B04_06B_TT_BKPF_BSEG.BSEG_BUKRS
                                                                                        AND GROUP_CATEGORY_DEBIT.BSEG_GJAHR = B04_06B_TT_BKPF_BSEG.BSEG_GJAHR
                                                                                        AND GROUP_CATEGORY_DEBIT.BSEG_BELNR = B04_06B_TT_BKPF_BSEG.BSEG_BELNR
                                                                                        AND GROUP_CATEGORY_DEBIT.BSEG_SHKZG = 'S'
                    LEFT JOIN B04_05B_TT_BKPF_BSEG_GROUPED_CATEGORY GROUP_CATEGORY_CREDIT ON GROUP_CATEGORY_CREDIT.BSEG_BUKRS = B04_06B_TT_BKPF_BSEG.BSEG_BUKRS
                                                                                        AND GROUP_CATEGORY_CREDIT.BSEG_GJAHR = B04_06B_TT_BKPF_BSEG.BSEG_GJAHR
                                                                                        AND GROUP_CATEGORY_CREDIT.BSEG_BELNR = B04_06B_TT_BKPF_BSEG.BSEG_BELNR
                                                                                        AND GROUP_CATEGORY_CREDIT.BSEG_SHKZG = 'H'
                    GROUP BY	
                    B04_06B_TT_BKPF_BSEG.BSEG_BUKRS
                    ,B04_06B_TT_BKPF_BSEG.BSEG_GJAHR
                    ,B04_06B_TT_BKPF_BSEG.BSEG_BELNR
					,B04_06B_TT_BKPF_BSEG.BKPF_TCODE
					,GROUP_CATEGORY_CREDIT.BSEG_KOART
					,GROUP_CATEGORY_DEBIT.BSEG_KOART
					,GROUP_CATEGORY_CREDIT.ZF_T012K_FEBKO_SKB1_HBKID_XGKON_FLAG
					,GROUP_CATEGORY_DEBIT.ZF_T012K_FEBKO_SKB1_HBKID_XGKON_FLAG
					,GROUP_CATEGORY_CREDIT.SKA1_GVTYP
					,GROUP_CATEGORY_DEBIT.SKA1_GVTYP
 
 					,GROUP_CATEGORY_DEBIT.BSEG_HKONT 
					 ,GROUP_CATEGORY_CREDIT.BSEG_HKONT 					 
					 ,GROUP_CATEGORY_DEBIT.SKAT_TXT20 
					 ,GROUP_CATEGORY_CREDIT.SKAT_TXT20 
...
EXEC SP_DROPTABLE    'B04_10_IT_BSAK_BSIK_AP_ACC_SCH'
	   ...
	   --Accounting schemes:
		,ISNULL(B04_07_IT_BSEG_BKPF_ACC_SCH.BKPF_TCODE, '') BKPF_TCODE
		,ISNULL(B04_07_IT_BSEG_BKPF_ACC_SCH.ZF_DEBIT_ACCOUNT_TYPES, '') ZF_DEBIT_ACCOUNT_TYPES
		,ISNULL(B04_07_IT_BSEG_BKPF_ACC_SCH.ZF_CREDIT_ACCOUNT_TYPES, '') ZF_CREDIT_ACCOUNT_TYPES
		,ISNULL(B04_07_IT_BSEG_BKPF_ACC_SCH.ZF_DEBIT_HKONT_LIST, '') ZF_DEBIT_HKONT_LIST
		,ISNULL(B04_07_IT_BSEG_BKPF_ACC_SCH.ZF_CREDIT_HKONT_LIST, '') ZF_CREDIT_HKONT_LIST
		,ISNULL(B04_07_IT_BSEG_BKPF_ACC_SCH.ZF_DEBIT_SKAT_TXT20_LIST, '') ZF_DEBIT_SKAT_TXT20_LIST
		,ISNULL(B04_07_IT_BSEG_BKPF_ACC_SCH.ZF_CREDIT_SKAT_TXT20_LIST, '') ZF_CREDIT_SKAT_TXT20_LIST
		,ISNULL(B04_07_IT_BSEG_BKPF_ACC_SCH.ZF_DEBIT_T012K_FEBKO_SKB1_HBKID_XGKON_FLAG_LIST, '') AS ZF_DEBIT_T012K_FEBKO_SKB1_HBKID_XGKON_FLAG_LIST
		,ISNULL(B04_07_IT_BSEG_BKPF_ACC_SCH.ZF_CREDIT_T012K_FEBKO_SKB1_HBKID_XGKON_FLAG_LIST, '') AS ZF_CREDIT_T012K_FEBKO_SKB1_HBKID_XGKON_FLAG_LIST
		,ISNULL(B04_07_IT_BSEG_BKPF_ACC_SCH.ZF_CREDIT_SKA1_GVTYP_FLAG_LIST, '') AS ZF_CREDIT_SKA1_GVTYP_FLAG_LIST
		,ISNULL(B04_07_IT_BSEG_BKPF_ACC_SCH.ZF_DEBIT_SKA1_GVTYP_FLAG_LIST, '') AS ZF_DEBIT_SKA1_GVTYP_FLAG_LIST
       ...
       -- Add the controlling area in order to be able to add cost center information		
		...
		-- Include profit centers descriptions
		LEFT JOIN B04_04_TT_CEPCT_UNIQUE
		ON	BSAIK_BUKRS = B04_04_TT_CEPCT_UNIQUE.CEPCT_KOKRS AND
...
EXEC SP_DROPTABLE    'B04_12_IT_BSAD_BSID_AR_ACC_SCH'
       ...
       -- Add the controlling area in order to be able to add cost center information		
		...
		-- Include profit centers descriptions
		LEFT JOIN B04_04_TT_CEPCT_UNIQUE
		ON	BSAID_BUKRS = B04_04_TT_CEPCT_UNIQUE.CEPCT_KOKRS AND
