...
CREATE     PROCEDURE [dbo].[script_B33_DUPLICATE_INVOICES]
...
/*
	Title			:	B33: Duplicate invoices ECC
...
EXEC sp_droptable 'B33_00_TT_PAY_DUP'
SELECT 
...
EXEC sp_droptable 'B33_01_TT_PAY_DUP'

SELECT 
	A.*
INTO B33_01_TT_PAY_DUP
FROM B33_00_TT_PAY_DUP 
LEFT JOIN B11_06_IT_PTP_INV AS A
ON CONVERT(nvarchar,A.B11C_BSAIK_LIFNR)+CONVERT(nvarchar,A.B11C_BSAIK_XBLNR)+CONVERT(nvarchar,A.B11C_BSAIK_BLDAT)+CONVERT(nvarchar,A.B11C_BSAIK_WRBTR) = ZF_DUP_KEY
...
EXEC sp_droptable 'B33_02_IT_PAY_DUP'
SELECT 
...
INTO B33_02_IT_PAY_DUP

FROM B33_01_TT_PAY_DUP
	LEFT JOIN A_BKPF
	...
	OUTER APPLY (SELECT TOP 1 B.B11C_BSAIK_BUKRS, CONCAT('LIFNR:', B.B11C_BSAIK_LIFNR, '_XBLNR:', B.B11C_BSAIK_XBLNR , '_BLDAT:', B.B11C_BSAIK_BLDAT, '_WRBTR:',B.B11C_BSAIK_WRBTR) AS ZF_SCENARIO_ID
						FROM B33_01_TT_PAY_DUP B WHERE B33_01_TT_PAY_DUP.B11C_BSAIK_LIFNR = B.B11C_BSAIK_LIFNR
												AND  B33_01_TT_PAY_DUP.B11C_BSAIK_BLDAT = B.B11C_BSAIK_BLDAT
												AND B33_01_TT_PAY_DUP.B11C_BSAIK_WRBTR = B.B11C_BSAIK_WRBTR
												AND B33_01_TT_PAY_DUP.B11C_BSAIK_XBLNR = B.B11C_BSAIK_XBLNR
												AND B33_01_TT_PAY_DUP.B11C_BSAIK_BUKRS + B33_01_TT_PAY_DUP.B11C_BSAIK_GJAHR + B33_01_TT_PAY_DUP.B11C_BSAIK_BELNR <> B.B11C_BSAIK_BUKRS + B.B11C_BSAIK_GJAHR + B.B11C_BSAIK_BELNR
												) SCENARIO_1
	...
	OUTER APPLY(SELECT TOP 1 B.B11C_BSAIK_BUKRS, CONCAT('_XBLNR:', B.B11C_BSAIK_XBLNR, '_BLDAT:', B.B11C_BSAIK_BLDAT, '_WRBTR:', B.B11C_BSAIK_WRBTR) AS ZF_SCENARIO_ID
							FROM B33_01_TT_PAY_DUP B 
							WHERE  B.B11C_BSAIK_BLDAT = B33_01_TT_PAY_DUP.B11C_BSAIK_BLDAT
														AND B.B11C_BSAIK_WRBTR = B33_01_TT_PAY_DUP.B11C_BSAIK_WRBTR
														AND B.B11C_BSAIK_XBLNR = B33_01_TT_PAY_DUP.B11C_BSAIK_XBLNR
														AND B33_01_TT_PAY_DUP.B11C_BSAIK_BUKRS + B33_01_TT_PAY_DUP.B11C_BSAIK_GJAHR + B33_01_TT_PAY_DUP.B11C_BSAIK_BELNR <> B.B11C_BSAIK_BUKRS + B.B11C_BSAIK_GJAHR + B.B11C_BSAIK_BELNR
														) SCENARIO_2
	...
	OUTER APPLY(SELECT TOP 1 B.B11C_BSAIK_BUKRS, CONCAT('LIFNR:', B.B11C_BSAIK_LIFNR, '_XBLNR:', B.B11C_BSAIK_XBLNR, '_WRBTR:', B.B11C_BSAIK_WRBTR) AS ZF_SCENARIO_ID
						FROM B33_01_TT_PAY_DUP B 
						WHERE B.B11C_BSAIK_LIFNR = B33_01_TT_PAY_DUP.B11C_BSAIK_LIFNR													 
													AND B.B11C_BSAIK_WRBTR = B33_01_TT_PAY_DUP.B11C_BSAIK_WRBTR
													AND B.B11C_BSAIK_XBLNR = B33_01_TT_PAY_DUP.B11C_BSAIK_XBLNR
													AND B33_01_TT_PAY_DUP.B11C_BSAIK_BUKRS + B33_01_TT_PAY_DUP.B11C_BSAIK_GJAHR + B33_01_TT_PAY_DUP.B11C_BSAIK_BELNR <> B.B11C_BSAIK_BUKRS + B.B11C_BSAIK_GJAHR + B.B11C_BSAIK_BELNR
													) SCENARIO_3
	...
	OUTER APPLY(SELECT TOP 1 B.B11C_BSAIK_BUKRS, CONCAT('LIFNR:', B.B11C_BSAIK_LIFNR, '_BLDAT:', B.B11C_BSAIK_BLDAT, '_XBLNR:', B.B11C_BSAIK_XBLNR) AS ZF_SCENARIO_ID
						FROM B33_01_TT_PAY_DUP B 
						WHERE B33_01_TT_PAY_DUP.B11C_BSAIK_LIFNR = B.B11C_BSAIK_LIFNR
													AND B.B11C_BSAIK_XBLNR = B33_01_TT_PAY_DUP.B11C_BSAIK_XBLNR
													AND B.B11C_BSAIK_BLDAT = B33_01_TT_PAY_DUP.B11C_BSAIK_BLDAT
													AND B33_01_TT_PAY_DUP.B11C_BSAIK_BUKRS + B33_01_TT_PAY_DUP.B11C_BSAIK_GJAHR + B33_01_TT_PAY_DUP.B11C_BSAIK_BELNR <> B.B11C_BSAIK_BUKRS + B.B11C_BSAIK_GJAHR + B.B11C_BSAIK_BELNR
													) SCENARIO_4
	...
	OUTER APPLY(SELECT TOP 1 B.B11C_BSAIK_BUKRS, CONCAT('LIFNR:',B.B11C_BSAIK_LIFNR , '_BLDAT:', B.B11C_BSAIK_BLDAT,'_WRBTR:',B.B11C_BSAIK_WRBTR ) AS ZF_SCENARIO_ID
						FROM B33_01_TT_PAY_DUP B WHERE B.B11C_BSAIK_LIFNR = B33_01_TT_PAY_DUP.B11C_BSAIK_LIFNR
													AND B.B11C_BSAIK_WRBTR = B33_01_TT_PAY_DUP.B11C_BSAIK_WRBTR
													AND B.B11C_BSAIK_BLDAT = B33_01_TT_PAY_DUP.B11C_BSAIK_BLDAT
													AND B33_01_TT_PAY_DUP.B11C_BSAIK_BUKRS + B33_01_TT_PAY_DUP.B11C_BSAIK_GJAHR + B33_01_TT_PAY_DUP.B11C_BSAIK_BELNR <> B.B11C_BSAIK_BUKRS + B.B11C_BSAIK_GJAHR + B.B11C_BSAIK_BELNR
													) SCENARIO_5
	...
	OUTER APPLY(SELECT TOP 1 B.B11C_BSAIK_BUKRS, CONCAT('NAME1:',B.B11C_LFA1_NAME1 ,'_WRBTR:',B.B11C_BSAIK_WRBTR,'_XBLNR:', B.B11C_BSAIK_XBLNR ) AS ZF_SCENARIO_ID
						FROM B33_01_TT_PAY_DUP B WHERE B.B11C_LFA1_NAME1 = B33_01_TT_PAY_DUP.B11C_LFA1_NAME1
													AND B.B11C_BSAIK_WRBTR = B33_01_TT_PAY_DUP.B11C_BSAIK_WRBTR
													AND B.B11C_BSAIK_XBLNR = B33_01_TT_PAY_DUP.B11C_BSAIK_XBLNR
													AND B33_01_TT_PAY_DUP.B11C_BSAIK_BUKRS + B33_01_TT_PAY_DUP.B11C_BSAIK_GJAHR + B33_01_TT_PAY_DUP.B11C_BSAIK_BELNR <> B.B11C_BSAIK_BUKRS + B.B11C_BSAIK_GJAHR + B.B11C_BSAIK_BELNR
													) SCENARIO_6		
...
ALTER TABLE B33_02_IT_PAY_DUP ADD ZF_INV_PAID_FLAG VARCHAR(3)

UPDATE B33_02_IT_PAY_DUP
...
ALTER TABLE B33_02_IT_PAY_DUP  ADD  ZF_INV_PAID_KZ_ZP VARCHAR(3)
...
ALTER TABLE B33_02_IT_PAY_DUP ADD  ZF_DOC_NOT_CLEAR VARCHAR(3)
...
ALTER TABLE B33_02_IT_PAY_DUP ADD  ZF_INV_BOTH_PAID VARCHAR(3)
...
(
	...
	IN ( SELECT CONVERT(nvarchar,B11C_BSAIK_LIFNR)+CONVERT(nvarchar,B11C_BSAIK_XBLNR)+CONVERT(nvarchar,B11C_BSAIK_BLDAT)+CONVERT(nvarchar,B11C_BSAIK_WRBTR) 
		 FROM B33_02_IT_PAY_DUP
		 WHERE ZF_INV_PAID_FLAG = 'YES'
		 GROUP BY B11C_BSAIK_LIFNR,B11C_BSAIK_XBLNR,B11C_BSAIK_BLDAT,B11C_BSAIK_WRBTR
...
INNER JOIN (SELECT * FROM 		 
			...
			SELECT *, 'YES' ZF_INV_EQUAL_SUP_PAY FROM (SELECT  B11C_BSAIK_AUGBL,B11C_BSAIK_AUGDT , SUM(B11C_BSAIK_DMBTR)AS ZF_AMOUNT_INV FROM B33_02_IT_PAY_DUP
...
-- Step 5: Create table that LIFRN from B11_04_IT_PTP_APA table in B33_02_IT_PAY_DUP table

EXEC SP_DROPTABLE 'B33_03_IT_SUP_IN_DUP_INV'
SELECT *
INTO B33_03_IT_SUP_IN_DUP_INV
FROM B11_04_IT_PTP_APA
WHERE B11B_BSAIK_LIFNR IN
(

	SELECT DISTINCT B11C_BSAIK_LIFNR FROM B33_02_IT_PAY_DUP
)
 

-- Step 6: Create key to link AP talbe to duplicate INV table base on test field
-- Just get data from B33_03_IT_SUP_IN_DUP_INV table 
...
EXEC SP_DROPTABLE 'B33_04_IT_SUP_IN_DUP_INV_TEST_CASE'

SELECT *
INTO B33_04_IT_SUP_IN_DUP_INV_TEST_CASE
FROM (

-- Get data from B33_04_TT_SUP_IN_DUP_INV table base on SUPPLIER/DOC DATE/DOC VALUE/EXTERNAL DOC NUMBER 
...
UNION
-- Get data from B33_04_TT_SUP_IN_DUP_INV table base on DOC DATE/DOC VALUE/EXTERNAL DOC NUMBER 
...
UNION
-- Get data from B33_04_TT_SUP_IN_DUP_INV table base on SUPPLIER/DOC VALUE/EXTERNAL DOC NUMBER 
...
--Step 7/ Create a copy table of B33_03_IT_SUP_IN_DUP_INV to join with it's self by AUGDT and AUGBL
EXEC SP_DROPTABLE 'B33_05_IT_SUP_IN_DUP_INV_COPY'
SELECT * 
INTO B33_05_IT_SUP_IN_DUP_INV_COPY
FROM B33_03_IT_SUP_IN_DUP_INV
...
EXEC SP_DROPTABLE 'B33_07_IT_SUMMARY_TABLE'

SELECT A.*
INTO B33_07_IT_SUMMARY_TABLE
FROM (
	SELECT A.ZF_DUP_INDEX,A.B11B_BSAIK_AUGBL,B11B_ZF_FLAG_SUMMARY, A.B11B_BSAIK_AUGDT, SUM(A.B11B_ZF_BSAIK_DMBTR_S) AS TOTAL_VALUE  FROM (
		SELECT B.ZF_DUP_INDEX,
				...
				A.*
		FROM B33_03_IT_SUP_IN_DUP_INV AS A
		LEFT JOIN B33_02_IT_PAY_DUP AS B
...
EXEC SP_UNNAME_FIELD 'B11B_', 'B33_03_IT_SUP_IN_DUP_INV'
EXEC SP_UNNAME_FIELD 'B11B_', 'B33_04_IT_SUP_IN_DUP_INV_TEST_CASE'
EXEC SP_UNNAME_FIELD 'B11B_', 'B33_05_IT_SUP_IN_DUP_INV_COPY'
EXEC SP_UNNAME_FIELD 'B11C_', 'B33_06_IT_KPI'
EXEC SP_UNNAME_FIELD 'B11B_', 'B33_07_IT_SUMMARY_TABLE'
 
EXEC SP_RENAME_FIELD 'B33_03_', 'B33_03_IT_SUP_IN_DUP_INV'
EXEC SP_RENAME_FIELD 'B33_04_', 'B33_04_IT_SUP_IN_DUP_INV_TEST_CASE'
EXEC SP_RENAME_FIELD 'B33_05_', 'B33_05_IT_SUP_IN_DUP_INV_COPY'
EXEC SP_RENAME_FIELD 'B33_06_', 'B33_06_IT_KPI'
EXEC SP_RENAME_FIELD 'B33_07_', 'B33_07_IT_SUMMARY_TABLE'
...
INSERT INTO [DBO].[LOG_SP_EXECUTION] ([DATABASE],[OBJECT],[OBJECT_TYPE],[USER],[DATE],[TIME],[DESCRIPTION],[TABLE],[ROWS])
SELECT DB_NAME(),OBJECT_NAME(@@PROCID),'P',SYSTEM_USER,CONVERT(DATE,GETDATE()),CONVERT(TIME,GETDATE()),'Cube completed','B33_02_IT_PAY_DUP',(SELECT COUNT(*) FROM B33_02_IT_PAY_DUP) 

INSERT INTO [DBO].[LOG_SP_EXECUTION] ([DATABASE],[OBJECT],[OBJECT_TYPE],[USER],[DATE],[TIME],[DESCRIPTION],[TABLE],[ROWS])
SELECT DB_NAME(),OBJECT_NAME(@@PROCID),'P',SYSTEM_USER,CONVERT(DATE,GETDATE()),CONVERT(TIME,GETDATE()),'Cube completed','B33_03_IT_SUP_IN_DUP_INV',(SELECT COUNT(*) FROM B33_03_IT_SUP_IN_DUP_INV) 

INSERT INTO [DBO].[LOG_SP_EXECUTION] ([DATABASE],[OBJECT],[OBJECT_TYPE],[USER],[DATE],[TIME],[DESCRIPTION],[TABLE],[ROWS])
SELECT DB_NAME(),OBJECT_NAME(@@PROCID),'P',SYSTEM_USER,CONVERT(DATE,GETDATE()),CONVERT(TIME,GETDATE()),'Cube completed','B33_04_IT_SUP_IN_DUP_INV_TEST_CASE',(SELECT COUNT(*) FROM B33_04_IT_SUP_IN_DUP_INV_TEST_CASE) 

INSERT INTO [DBO].[LOG_SP_EXECUTION] ([DATABASE],[OBJECT],[OBJECT_TYPE],[USER],[DATE],[TIME],[DESCRIPTION],[TABLE],[ROWS])
SELECT DB_NAME(),OBJECT_NAME(@@PROCID),'P',SYSTEM_USER,CONVERT(DATE,GETDATE()),CONVERT(TIME,GETDATE()),'Cube completed','B33_05_IT_SUP_IN_DUP_INV_COPY',(SELECT COUNT(*) FROM B33_05_IT_SUP_IN_DUP_INV_COPY) 

INSERT INTO [DBO].[LOG_SP_EXECUTION] ([DATABASE],[OBJECT],[OBJECT_TYPE],[USER],[DATE],[TIME],[DESCRIPTION],[TABLE],[ROWS])
SELECT DB_NAME(),OBJECT_NAME(@@PROCID),'P',SYSTEM_USER,CONVERT(DATE,GETDATE()),CONVERT(TIME,GETDATE()),'Cube completed','B33_06_IT_KPI',(SELECT COUNT(*) FROM B33_06_IT_KPI) 

INSERT INTO [DBO].[LOG_SP_EXECUTION] ([DATABASE],[OBJECT],[OBJECT_TYPE],[USER],[DATE],[TIME],[DESCRIPTION],[TABLE],[ROWS])
SELECT DB_NAME(),OBJECT_NAME(@@PROCID),'P',SYSTEM_USER,CONVERT(DATE,GETDATE()),CONVERT(TIME,GETDATE()),'Cube completed','B33_07_IT_SUMMARY_TABLE',(SELECT COUNT(*) FROM B33_07_IT_SUMMARY_TABLE) 
