...
-- =============================================
CREATE       PROCEDURE [dbo].[A03_CREATE_AM_SCOPE]
AS
BEGIN
		...
		*/
		EXEC SP_REMOVE_TABLES 'A03_01_TT_ACTV_COMPANY'
		SELECT DISTINCT BKPF_MANDT, BKPF_BUKRS, T001_BUTXT
		INTO A03_01_TT_ACTV_COMPANY
	    FROM
		(
		...
		*/
		...
		FROM A03_01_TT_ACTV_COMPANY
		WHERE NOT EXISTS (SELECT TOP 1 1 FROM AM_SCOPE WHERE AM_SCOPE.SCOPE_MANDANT = A03_01_TT_ACTV_COMPANY.BKPF_MANDT AND AM_SCOPE.SCOPE_CMPNY_CODE = A03_01_TT_ACTV_COMPANY.BKPF_BUKRS)
