...
SELECT 
 ...
 --Create a list of debit account types
                  ...
                  REPLACE(ISNULL(STUFF((SELECT '_' + COALESCE(IIF(LEN( B.BSEG_KOSTL+':'+B.ZF_CSKT_MCTXT)=1 ,'_' ,B.BSEG_KOSTL+':'+B.ZF_CSKT_MCTXT),'_')
                     FROM B04_11_TT_JE_ACCOUNT_TEMP B
                     WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
                           AND B.BSEG_GJAHR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_GJAHR
                           AND B.BSEG_BELNR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BELNR
                           AND    B.BSEG_SHKZG = 'S')
    ...
    REPLACE(ISNULL(STUFF((SELECT '_' + COALESCE(NULLIF( B.BSEG_KOART ,'' ),'_')
    FROM B04_11_TT_JE_ACCOUNT_TEMP B
    WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
        AND B.BSEG_GJAHR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_GJAHR
        AND B.BSEG_BELNR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BELNR
...
--Debit customer name
					,REPLACE(ISNULL(STUFF((SELECT '_' + COALESCE(NULLIF(B.BSEG_KNA1_NAME1 ,'' ),'_')
				   FROM B04_11_TT_JE_ACCOUNT_TEMP B
				   WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS
								 AND B.BSEG_GJAHR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_GJAHR
								 AND B.BSEG_BELNR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BELNR
				   ...
				   ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
				   FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
				,1,1,''), '_') , '__', '_') ZF_BSEG_KUNNR_NAME1_DEBIT_LIST
					 ...
					 ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
                     FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
                     ,1,1,''), '_') , '__', '_') ZF_BSEG_KUNNR_NAME1_CREDIT_LIST
					 --Debit supplier name
					 ,REPLACE(ISNULL(STUFF((SELECT '_'+ COALESCE(NULLIF(B.BSEG_LFA1_NAME1 ,'' ),'_')
                     FROM B04_11_TT_JE_ACCOUNT_TEMP B
                     WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
                           AND B.BSEG_GJAHR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_GJAHR
                           AND B.BSEG_BELNR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BELNR
					 ...
					 ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
                     FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
                     ,1,1,''), '_') , '__', '_') ZF_BSEG_LIFNR_NAME1_DEBIT_LIST
					 ...
					 ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
                     FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
                     ,1,1,''), '_') , '__', '_') ZF_BSEG_LIFNR_NAME1_CREDIT_LIST
					 --Debit material group
					 ,REPLACE(ISNULL(STUFF((SELECT '_'+ COALESCE(NULLIF(B.MARA_MATKL ,'' ),'_')
                     FROM B04_11_TT_JE_ACCOUNT_TEMP B
                     WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
                           AND B.BSEG_GJAHR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_GJAHR
                           AND B.BSEG_BELNR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BELNR
					 ...
					 ,REPLACE(ISNULL(STUFF((SELECT '_' + COALESCE(NULLIF(B.T023T_WGBEZ,'' ),'_')
                     FROM B04_11_TT_JE_ACCOUNT_TEMP B
                     WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
                           AND B.BSEG_GJAHR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_GJAHR
                           AND B.BSEG_BELNR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BELNR
					 ...
					 ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
                     FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
                     ,1,1,''), '_') , '__', '_') ZF_BSEG_MATNR_T023T_WGBEZ_DEBIT_LIST
					 ...
					 ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
                     FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
                     ,1,1,''), '_') , '__', '_') ZF_BSEG_MATNR_T023T_WGBEZ_CREDIT_LIST
					 --Debit asset
					 ,REPLACE(ISNULL(STUFF((SELECT '_'  +  COALESCE(IIF(LEN(B.BSEG_ANLN1+ ':' + B.BSEG_ANLN2)=1 ,'_',B.BSEG_ANLN1+ ':' + B.BSEG_ANLN2 ),'_')
                     FROM B04_11_TT_JE_ACCOUNT_TEMP B
                     WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
                           AND B.BSEG_GJAHR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_GJAHR
                           AND B.BSEG_BELNR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BELNR
					 ...
					 ,REPLACE(ISNULL(STUFF((SELECT '_'   +  COALESCE(NULLIF(B.ANLT_TXT50 ,'' ),'_')
                     FROM B04_11_TT_JE_ACCOUNT_TEMP B
                     WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
                           AND B.BSEG_GJAHR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_GJAHR
                           AND B.BSEG_BELNR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BELNR
					 ...
					 ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
                     FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
                     ,1,1,''), '_') , '__', '_') ZF_BSEG_ANLN1_ANLT_DEBIT_LIST
					 --Credit asset
					 ,REPLACE(ISNULL(STUFF((SELECT '_' + COALESCE(IIF(LEN( B.BSEG_ANLN1+ ':' + B.BSEG_ANLN2)=1 ,'_',B.BSEG_ANLN1+ ':' + B.BSEG_ANLN2 ),'_')
                     FROM B04_11_TT_JE_ACCOUNT_TEMP B
                     WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
					 ...
					 ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
                     FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
                     ,1,1,''), '_') , '__', '_') ZF_BSEG_ANLN1_ANLT_CREDIT_LIST
					 --Debit LFA1_KUNNR
					 ,REPLACE(ISNULL(STUFF((SELECT '_'  + COALESCE(NULLIF(B.BSEG_LFA1_KUNNR ,'' ),'_')
                     FROM B04_11_TT_JE_ACCOUNT_TEMP B
                     WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
                           AND B.BSEG_GJAHR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_GJAHR
                           AND B.BSEG_BELNR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BELNR
					 ...
					 ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
                     FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
                     ,1,1,''), '_') , '__', '_') ZF_LFA1_KUNNR_BSEG_DEBIT_LIST
					 --Debit LFA1_KUNNR name
					 ,REPLACE(ISNULL(STUFF((SELECT '_'  +  COALESCE(NULLIF(B.BSEG_LFA1_KUNNR_NAME1 ,'' ),'_')
                     FROM B04_11_TT_JE_ACCOUNT_TEMP B
                     WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
                           AND B.BSEG_GJAHR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_GJAHR
                           AND B.BSEG_BELNR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BELNR
					 ...
					 ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
                     FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
                     ,1,1,''), '_') , '__', '_') ZF_LFA1_KUNNR_NAME1_BSEG_DEBIT_LIST
					 --Credit LFA1_KUNNR
					 ,REPLACE(ISNULL(STUFF((SELECT '_'  +  COALESCE(NULLIF(B.BSEG_LFA1_KUNNR ,'' ),'_')
                     FROM B04_11_TT_JE_ACCOUNT_TEMP B
                     WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
					 ...
					 ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
                     FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
                     ,1,1,''), '_') , '__', '_') ZF_LFA1_KUNNR_BSEG_CREDIT_LIST
					 ...
					 ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
                     FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
                     ,1,1,''), '_') , '__', '_') ZF_LFA1_KUNNR_NAME1_BSEG_CREDIT_LIST
					 --Debit KNA1_LIFNR
					 ,REPLACE(ISNULL(STUFF((SELECT '_'  +  COALESCE(NULLIF(B.BSEG_KNA1_LIFNR ,'' ),'_')
                     FROM B04_11_TT_JE_ACCOUNT_TEMP B
                     WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
                           AND B.BSEG_GJAHR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_GJAHR
                           AND B.BSEG_BELNR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BELNR
					 ...
					 ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
                     FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
                     ,1,1,''), '_') , '__', '_') ZF_KNA1_LIFNR_BSEG_DEBIT_LIST
					-- Debit KNA1_LIFNR name
					,REPLACE(ISNULL(STUFF((SELECT '_'  +  COALESCE(NULLIF(B.BSEG_KNA1_LIFNR_NAME1 ,'' ),'_')
                     FROM B04_11_TT_JE_ACCOUNT_TEMP B
                     WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
                           AND B.BSEG_GJAHR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_GJAHR
                           AND B.BSEG_BELNR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BELNR
					 ...
					 ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
                     FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
                     ,1,1,''), '_') , '__', '_') ZF_KNA1_LIFNR_NAME1_BSEG_DEBIT_LIST
					 --Credit KNA1_LIFNR
					 ,REPLACE(ISNULL(STUFF((SELECT '_'  +  COALESCE(NULLIF(B.BSEG_KNA1_LIFNR ,'' ),'_')
                     FROM B04_11_TT_JE_ACCOUNT_TEMP B
                     WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
					 ...
					 ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
                     FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
                     ,1,1,''), '_') , '__', '_') ZF_KNA1_LIFNR_BSEG_CREDIT_LIST
					--Credit KNA1_LIFNR name
					 ...
					 ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
                     FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
                     ,1,1,''), '_') , '__', '_') ZF_KNA1_LIFNR_NAME1_BSEG_CREDIT_LIST
...
-- Add account type desc debit
	REPLACE(ISNULL(STUFF((SELECT '_' + COALESCE(NULLIF(    B.ZF_BKPF_KOART_DESC ,'' ),'_')
    FROM B04_11_TT_JE_ACCOUNT_TEMP B
    WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
        AND B.BSEG_GJAHR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_GJAHR
        AND B.BSEG_BELNR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BELNR
	...
	ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
    FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
    ,1,1,''), '_') , '__', '_') ZF_DEBIT_ZF_BSEG_KOART_DESC_LIST,
...
-- Add account type desc credit
	...
	ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
    FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
    ,1,1,''), '_') , '__', '_') ZF_CREDIT_ZF_BSEG_KOART_DESC_LIST,

-- Supplier number debit
	REPLACE(ISNULL(STUFF((SELECT '_' + COALESCE(NULLIF(    B.BSEG_LIFNR ,'' ),'_')
    FROM B04_11_TT_JE_ACCOUNT_TEMP B
    WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
        AND B.BSEG_GJAHR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_GJAHR
        AND B.BSEG_BELNR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BELNR
...
-- Supplier group debit
	REPLACE(ISNULL(STUFF((SELECT '_' + COALESCE(NULLIF(    B.LFA1_KTOKK ,'' ),'_')
    FROM B04_11_TT_JE_ACCOUNT_TEMP B
    WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
        AND B.BSEG_GJAHR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_GJAHR
        AND B.BSEG_BELNR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BELNR
...
-- Supplier group desc debit
	REPLACE(ISNULL(STUFF((SELECT '_' + COALESCE(NULLIF(    B.T077Y_TXT30 ,'' ),'_')
    FROM B04_11_TT_JE_ACCOUNT_TEMP B
    WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
        AND B.BSEG_GJAHR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_GJAHR
        AND B.BSEG_BELNR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BELNR
	...
	ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
    FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
    ,1,1,''), '_') , '__', '_') ZF_DEBIT_T077Y_TXT30_LIST,
...
-- Supplier group desc credit
	...
	ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
    FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
    ,1,1,''), '_') , '__', '_') ZF_CREDIT_T077Y_TXT30_LIST,

-- Customer number debit
	REPLACE(ISNULL(STUFF((SELECT '_' + COALESCE(NULLIF(    B.BSEG_KUNNR ,'' ),'_')
    FROM B04_11_TT_JE_ACCOUNT_TEMP B
    WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
        AND B.BSEG_GJAHR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_GJAHR
        AND B.BSEG_BELNR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BELNR
...
-- Customer group  debit
	REPLACE(ISNULL(STUFF((SELECT '_' + COALESCE(NULLIF(    B.KNA1_KTOKD ,'' ),'_')
    FROM B04_11_TT_JE_ACCOUNT_TEMP B
    WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
        AND B.BSEG_GJAHR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_GJAHR
        AND B.BSEG_BELNR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BELNR
...
-- Customer group desc debit
	REPLACE(ISNULL(STUFF((SELECT '_' + COALESCE(NULLIF(    B.T077X_TXT30 ,'' ),'_')
    FROM B04_11_TT_JE_ACCOUNT_TEMP B
    WHERE (B.BSEG_BUKRS = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BUKRS  
        AND B.BSEG_GJAHR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_GJAHR
        AND B.BSEG_BELNR = B04_11_TT_JE_ACCOUNT_TEMP.BSEG_BELNR
	...
	ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
    FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
    ,1,1,''), '_') , '__', '_') ZF_DEBIT_T077X_TXT30_LIST,
...
-- Customer group desc credit
	...
	ORDER BY SUM(ABS(B.ZF_BSEG_DMBTR_S)) DESC, B.BSEG_HKONT
    FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)')
    ,1,1,''), '_') , '__', '_') ZF_CREDIT_T077X_TXT30_LIST,
-- TANGO_ACCT debit
