...
GO
CREATE   PROCEDURE [dbo].[script_B33_SALE_ORDER_CUBE_041023]
AS
	...
	SELECT VBAK_MANDT, -- Client
		...
		VBAP_ERZET,
		  ...
		  @CURRENCY AS ZF_CUSTOM_CURRENCY,
		   ...
		   VBAP_NETPR * ISNULL(CURRENCY_FACTOR_ITEM.TCURX_FACTOR,1)*VBAP_STCUR * COALESCE(TCURF_COC.TCURF_TFACT,1)/COALESCE(TCURF_COC.TCURF_FFACT,1) * COALESCE(CAST(TCURR_CUC.TCURR_UKURS AS FLOAT),1) * COALESCE(TCURF_CUC.TCURF_TFACT,1) / COALESCE(TCURF_CUC.TCURF_FFACT,1) ZF_VBAP_NETPR_COC_S_CUC,
		   T001_WAERS,
		   VBAP_STCUR,
