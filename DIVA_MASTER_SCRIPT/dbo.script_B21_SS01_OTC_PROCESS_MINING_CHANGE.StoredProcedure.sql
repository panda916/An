...
GO
CREATE   PROCEDURE [dbo].[script_B21_SS01_OTC_PROCESS_MINING_CHANGE]
AS
...
EXEC SP_DROPTABLE 'B21_18_TT_CDHDR_CDPOS_DEBI'
	...
	1 AS ZF_STAGE
	INTO B21_18_TT_CDHDR_CDPOS_DEBI
	FROM A_CDHDR 
	INNER JOIN A_CDPOS
...
EXEC SP_DROPTABLE B21_19_IT_CDHDR_CDPOS_DEBI

		 SELECT B21_18_TT_CDHDR_CDPOS_DEBI.*,
				V_USERNAME_NAME_TEXT,	
				DDFTX_SCRTEXT_L,	--field name
				DD02T_DDTEXT		--table name
	INTO B21_19_IT_CDHDR_CDPOS_DEBI
	FROM B21_18_TT_CDHDR_CDPOS_DEBI
...
EXEC SP_DROPTABLE B21_20_TT_CHANGE_VERBELEG
	...
	CASE
		...
		3 AS ZF_STAGE
		INTO B21_20_TT_CHANGE_VERBELEG
		FROM A_CDHDR 
		INNER JOIN A_CDPOS
		ON 
			 CDHDR_OBJECTCLAS=CDPOS_OBJECTCLAS AND
...
EXEC SP_DROPTABLE B21_21_IT_CHANGE_VERBELEG

	SELECT DISTINCT B21_20_TT_CHANGE_VERBELEG.*,
	V_USERNAME_NAME_TEXT,
	DDFTX_SCRTEXT_L,	--field name
	DD02T_DDTEXT		--table name	
	INTO B21_21_IT_CHANGE_VERBELEG
	FROM B21_20_TT_CHANGE_VERBELEG 
	LEFT JOIN A_V_USERNAME
		ON CDHDR_USERNAME=V_USERNAME_BNAME
	LEFT JOIN B00_DD02T_ENGLISH ON 
		CDPOS_TABNAME = B00_DD02T_ENGLISH.DD02T_TABNAME
...
EXEC SP_DROPTABLE B21_22_TT_CHANGE_LIEFERUNG
...
ELSE '' END AS ZF_CHANGE_DESC,
5 AS ZF_STAGE
INTO B21_22_TT_CHANGE_LIEFERUNG
	FROM A_CDHDR 
	INNER JOIN A_CDPOS
	ON 
		 CDHDR_OBJECTCLAS=CDPOS_OBJECTCLAS AND
...
EXEC SP_DROPTABLE B21_23_IT_CHANGE_LIEFERUNG


	SELECT DISTINCT B21_22_TT_CHANGE_LIEFERUNG.*,
	V_USERNAME_NAME_TEXT,
	DDFTX_SCRTEXT_L,	--field name
	DD02T_DDTEXT		--table name	
	INTO B21_23_IT_CHANGE_LIEFERUNG
	FROM B21_22_TT_CHANGE_LIEFERUNG 
	LEFT JOIN A_V_USERNAME
		ON CDHDR_USERNAME=V_USERNAME_BNAME
	LEFT JOIN B00_DD02T_ENGLISH ON 
		CDPOS_TABNAME = B00_DD02T_ENGLISH.DD02T_TABNAME
...
EXEC SP_DROPTABLE B21_24_TT_CHANGE_FAKT
...
EXEC SP_DROPTABLE B21_25_IT_CHANGE_FAKT

	SELECT DISTINCT B21_24_TT_CHANGE_FAKT.*,
	V_USERNAME_NAME_TEXT,
	DDFTX_SCRTEXT_L,	--field name
	DD02T_DDTEXT		--table name	
	INTO B21_25_IT_CHANGE_FAKT
	FROM B21_24_TT_CHANGE_FAKT 
	LEFT JOIN A_V_USERNAME
		ON CDHDR_USERNAME=V_USERNAME_BNAME
	LEFT JOIN B00_DD02T_ENGLISH ON 
		CDPOS_TABNAME = B00_DD02T_ENGLISH.DD02T_TABNAME
...
EXEC SP_RENAME_FIELD 'B21_25_',B21_25_IT_CHANGE_FAKT
EXEC SP_RENAME_FIELD 'B21_23_',B21_23_IT_CHANGE_LIEFERUNG
EXEC SP_RENAME_FIELD 'B21_21_',B21_21_IT_CHANGE_VERBELEG
EXEC SP_RENAME_FIELD 'B21_19_',B21_19_IT_CDHDR_CDPOS_DEBI
GO
