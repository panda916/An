...
CREATE   PROCEDURE [dbo].[script_DC10_SOD_OTC]
...
EXEC SP_DROPTABLE 	'DC10_01_IT_MATERIAL_DOCS' 
...
EXEC SP_DROPTABLE 	'DC10_02_IT_INVOICE_DOCS' 
...
SELECT 
	...
	A.B20_09_VBRK_GJAHR,
	A.B20_09_VBRK_FKDAT,
	A.B20_09_VBRK_WAERK AS B20_09_VBRK_WAERK,
	A_T001.T001_WAERS,
...
INNER JOIN (SELECT DISTINCT B20_09_VBRK_VBELN,
	...
	AND A.B20_09_VBRK_BUKRS = B.B20_09_VBRK_BUKRS
	AND A.B20_09_VBRK_GJAHR = B.B20_09_VBRK_GJAHR

INNER JOIN A_VBRP
	ON A.B20_09_VBRK_VBELN = VBRP_VBELN

LEFT JOIN A_T001
	ON  A.B20_09_VBRK_BUKRS = A_T001.T001_BUKRS	   
-- Exchange rates 
LEFT JOIN AM_EXCHNG
...
EXEC SP_UNNAME_FIELD 'B20_08_',DC10_01_IT_MATERIAL_DOCS
EXEC SP_RENAME_FIELD 'DC10_01_',DC10_01_IT_MATERIAL_DOCS

EXEC SP_UNNAME_FIELD 'B20_09_',DC10_02_IT_INVOICE_DOCS
EXEC SP_RENAME_FIELD 'DC10_02_',DC10_02_IT_INVOICE_DOCS
