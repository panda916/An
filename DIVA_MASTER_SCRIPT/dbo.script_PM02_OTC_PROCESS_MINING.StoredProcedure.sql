...
GO
CREATE   PROCEDURE [dbo].[script_PM02_OTC_PROCESS_MINING]
AS
...
SELECT B37_05_IT_CENTER_FACT_TABLE_ADD_INV_PAY.*,
CASE WHEN  
	ISNULL(B33_VBAK_VBELN,'')<>'' AND ISNULL(B14_01_ZF_CUSTOMER_INVOICE_KEY,'')<>'' THEN 'X'
	ELSE '' END  ZF_INVOICE_HAS_SO_FLAG,
CASE WHEN 
	ISNULL(B33_VBAK_VBELN,'')<>'' AND ISNULL(B14_03_ZF_CUSTOMER_PAYMENT_KEY,'') <>'' THEN 'X'
	ELSE '' END   ZF_PAYMENT_HAS_SO_FLAG
INTO PM_OTC_01_TT_ADD_FLAG_GLOBAL
FROM B37_05_IT_CENTER_FACT_TABLE_ADD_INV_PAY
...
SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,
		B33_ZF_SALE_ORDER_KEY AS ZF_DOCUMENT_NUMBER,
		B33_VBAP_ERDAT AS  'ZF_DATE_USED_IN_MODEL',
		B33_VBAP_ERZET AS  'ZF_TIME_USED_IN_MODEL',
		B33_VBAK_ERNAM AS 'ZF_USER',
		B33_ZF_VBAK_ERNAM_TEXT AS 'ZF_NAME_OF_USER',
		B33_ZF_VBAP_NETWR_S_COC AS 'ZF_AMOUNT_COC',
		B33_ZF_VBAP_NETWR_S_CUC AS 'ZF_AMOUNT_CUC',
		B33_VBAK_KUNNR AS 'ZF_CUSTOMER',
		B33_TVKO_BUKRS AS 'ZF_COMPANY_CODE',
		CONCAT('2_',IIF(B33_ZF_DD07T_DDTEXT_VBTYP='Delivery','Delivery(SO)',B33_ZF_DD07T_DDTEXT_VBTYP)) AS ZF_CONCECPT_NAME_WITH_NUM,
		IIF(B33_ZF_DD07T_DDTEXT_VBTYP='Delivery','Delivery(SO)',B33_ZF_DD07T_DDTEXT_VBTYP) AS ZF_CONCECPT_NAME,
		B33_VBAK_AUART AS ZF_DOCUMENT_TYPE,
		ZF_INVOICE_HAS_SO_FLAG,
		ZF_PAYMENT_HAS_SO_FLAG,
		2 AS ZF_STAGE,
		'' AS ZF_BILLING_DOCUMENT,
		'X' AS ZF_SALE_DOC,
		B33_T001_WAERS AS ZF_COMPANY_CURRENCY
	INTO PM_OTC_02_TT_VERTICAL_TABLE
FROM PM_OTC_01_TT_ADD_FLAG_GLOBAL 
WHERE ISNULL(B33_VBAP_ERDAT,'')<>''
----Add delivery keys
UNION
SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,
		B34_ZF_SALE_DELIVERY_DOC_KEY AS ZF_DOCUMENT_NUMBER,
		B34_LIKP_ERDAT AS  'ZF_DATE_USED_IN_MODEL',
		B34_LIPS_ERZET AS 'ZF_TIME_USED_IN_MODEL',
		B34_LIKP_ERNAM AS 'ZF_USER',
		B34_ZF_LIKP_ERNAM_TEXT,
		B34_ZF_LIPS_NETWR_COC AS 'ZF_AMOUNT_COC',
		B34_ZF_LIPS_NETWR_CUC AS 'ZF_AMOUNT_CUC',
		B34_LIKP_KUNAG AS 'ZF_CUSTOMER',
		B34_TVKO_BUKRS AS 'ZF_COMPANY_CODE',
		'4_Delivery' AS 'ZF_CONCECPT_NAME_WITH_NUM',
		'Delivery' AS ZF_CONCECPT_NAME,
		B34_LIKP_LFART AS ZF_DOCUMENT_TYPE,
		ZF_INVOICE_HAS_SO_FLAG,
		ZF_PAYMENT_HAS_SO_FLAG,
		4 AS ZF_STAGE,
		'' AS ZF_BILLING_DOCUMENT,
		'',
		B34_T001_WAERS  AS ZF_COMPANY_CURRENCY
FROM PM_OTC_01_TT_ADD_FLAG_GLOBAL 
WHERE ISNULL(B34_LIKP_ERDAT,'')<>'' 

--Add Good issue key
UNION
SELECT  ZF_DOCUMENT_FLOW_KEY,
		B24_03_ZF_SALE_MATERIAL_DOC_KEY AS ZF_DOCUMENT_NUMBER,
		B24_03_MKPF_CPUDT AS  'ZF_DATE_USED_IN_MODEL',
		B24_03_MKPF_CPUTM AS 'ZF_TIME_USED_IN_MODEL',
		B24_03_MKPF_USNAM AS 'ZF_USER',
		B24_03_V_USERNAME_NAME_TEXT,
		B24_03_ZF_MSEG_DMBTR_SIGNED AS 'ZF_AMOUNT_COC',
		B24_03_ZF_MSEG_DMBTR_SIGNED_CUC AS 'ZF_AMOUNT_CUC',
		B24_03_MSEG_KUNNR AS 'ZF_CUSTOMER',
		B24_03_MSEG_BUKRS AS 'ZF_COMPANY_CODE',
		'6_Good_issue' AS ZF_CONCECPT_NAME_WITH_NUM,
		'Good issue' AS ZF_CONCECPT_NAME,
		B24_03_MKPF_BLART AS ZF_DOCUMENT_TYPE,
		ZF_INVOICE_HAS_SO_FLAG,
		ZF_PAYMENT_HAS_SO_FLAG,
		6 AS ZF_STAGE,
		'' AS ZF_BILLING_DOCUMENT,
		...
		B24_03_MSEG_WAERS
FROM PM_OTC_01_TT_ADD_FLAG_GLOBAL
WHERE ISNULL(B24_03_MKPF_CPUDT,'')<>''
	--Add Billing document keys
UNION
SELECT  ZF_DOCUMENT_FLOW_KEY,
		B36_ZF_SALE_INVOICE_DOC_KEY AS ZF_DOCUMENT_NUMBER,
		B36_VBRP_ERDAT AS  'ZF_DATE_USED_IN_MODEL',
		B36_VBRK_ERZET AS 'ZF_TIME_USED_IN_MODEL',
		B36_VBRK_ERNAM AS 'ZF_USER',
		B36_VBRK_ERNAM_NAME_TEXT,
		B36_ZF_VBRP_NETWR_S_COC AS 'ZF_AMOUNT_COC',
		B36_ZF_VBRP_NETWR_S_CUC AS 'ZF_AMOUNT_CUC',
		B36_VBRK_KUNAG AS 'ZF_CUSTOMER',
		B36_TVKO_BUKRS AS 'ZF_COMPANY_CODE',
		CONCAT('8_',B36_ZF_DD07T_DDTEXT_FKTYP) AS ZF_CONCECPT_NAME_WITH_NUM,
		B36_ZF_DD07T_DDTEXT_FKTYP AS ZF_CONCECPT_NAME,
		B36_VBRK_FKART AS ZF_DOCUMENT_TYPE,
		ZF_INVOICE_HAS_SO_FLAG,
		ZF_PAYMENT_HAS_SO_FLAG,
		8 AS ZF_STAGE,
		'X' AS ZF_BILLING_DOCUMENT,
		'',
		B36_T001_WAERS AS ZF_COMPANY_CURRENCY
FROM PM_OTC_01_TT_ADD_FLAG_GLOBAL 
WHERE ISNULL(B36_VBRP_ERDAT,'')<>''
--Add FI invoice keys
UNION
SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,
		B14_01_ZF_CUSTOMER_INVOICE_KEY AS ZF_DOCUMENT_NUMBER,
		B14_01_BSAID_CPUDT AS  'ZF_DATE_USED_IN_MODEL',
		B14_01_BKPF_CPUTM AS 'ZF_TIME_USED_IN_MODEL',
		B14_01_BKPF_USNAM AS 'ZF_USER',
		B14_01_V_USERNAME_NAME_TEXT,
		B14_01_ZF_BSAID_DMBTR_COC AS 'ZF_AMOUNT_COC',
		B14_01_ZF_BSAID_DMBTR_CUC AS 'ZF_AMOUNT_CUC',
		B14_01_BSAID_KUNNR AS 'ZF_CUSTOMER',
		B14_01_BSAID_BUKRS AS 'ZF_COMPANY_CODE',
		'10_FI_invoice' AS ZF_CONCECPT_NAME_WITH_NUM,
		'FI invoice' AS ZF_CONCECPT_NAME,
		B14_01_BSAID_BLART AS ZF_DOCUMENT_TYPE,
		ZF_INVOICE_HAS_SO_FLAG,
		ZF_PAYMENT_HAS_SO_FLAG,
		10 AS ZF_STAGE,
		'' AS ZF_BILLING_DOCUMENT,
		...
		B14_01_T001_WAERS
FROM PM_OTC_01_TT_ADD_FLAG_GLOBAL 
WHERE ISNULL(B14_01_BSAID_CPUDT,'')<>''
--Add Credit note
UNION
SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,
		B14_02_ZF_CUSTOMER_CREDIT_NOTE AS ZF_DOCUMENT_NUMBER,
		B14_02_BSAID_AUGDT AS  'ZF_DATE_USED_IN_MODEL',
		'000000' AS 'ZF_TIME_USED_IN_MODEL',
		B14_02_BKPF_USNAM AS 'ZF_USER',
		B14_02_V_USERNAME_NAME_TEXT,
		B14_02_ZF_BSAID_DMBTR_COC AS 'ZF_AMOUNT_COC',
		B14_02_ZF_BSAID_DMBTR_CUC AS 'ZF_AMOUNT_CUC',
		'' AS 'ZF_CUSTOMER',
		B14_02_BSAID_BUKRS AS 'ZF_COMPANY_CODE',
		'11_Credit note' AS ZF_CONCECPT_NAME_WITH_NUM,
		'Credit note' AS ZF_CONCECPT_NAME,
		B14_02_BSAID_BLART AS ZF_DOCUMENT_TYPE,
		ZF_INVOICE_HAS_SO_FLAG,
		ZF_PAYMENT_HAS_SO_FLAG,
		11 AS ZF_STAGE,
		'' AS ZF_BILLING_DOCUMENT,
		...
		B14_02_T001_WAERS
FROM PM_OTC_01_TT_ADD_FLAG_GLOBAL 
WHERE ISNULL(B14_02_BSAID_AUGDT,'')<>''

--Add payment keys
UNION
SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,
		B14_03_ZF_CUSTOMER_PAYMENT_KEY AS ZF_DOCUMENT_NUMBER,
		B14_03_BSAID_AUGDT AS  'ZF_DATE_USED_IN_MODEL',
		'000000' AS 'ZF_TIME_USED_IN_MODEL',
		B14_03_BKPF_USNAM AS 'ZF_USER',
		B14_03_V_USERNAME_NAME_TEXT,
		B14_03_ZF_BSAID_DMBTR_COC AS 'ZF_AMOUNT_COC',
		B14_03_ZF_BSAID_DMBTR_CUC AS 'ZF_AMOUNT_CUC',
		'' AS 'ZF_CUSTOMER',
		B14_03_BSAID_BUKRS AS 'ZF_COMPANY_CODE',
		'12_Payment' AS ZF_CONCECPT_NAME_WITH_NUM,
		'Payment' AS ZF_CONCECPT_NAME,
		B14_03_BSAID_BLART AS ZF_DOCUMENT_TYPE,
		ZF_INVOICE_HAS_SO_FLAG,
		ZF_PAYMENT_HAS_SO_FLAG,
		12 AS ZF_STAGE,
		'' AS ZF_BILLING_DOCUMENT,
		...
		B14_03_T001_WAERS
FROM PM_OTC_01_TT_ADD_FLAG_GLOBAL 
WHERE ISNULL(B14_03_BSAID_AUGDT,'')<>''
--Add payment cancellatioN keys
UNION
SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,
		B14_04_ZF_CUSTOMER_PAYMENT_CANCELLATION AS ZF_DOCUMENT_NUMBER,
		B14_04_BSAID_AUGDT AS  'ZF_DATE_USED_IN_MODEL',
		'000000' AS 'ZF_TIME_USED_IN_MODEL',
		B14_04_BKPF_USNAM AS 'ZF_USER',
		B14_04_V_USERNAME_NAME_TEXT,
		B14_04_ZF_BSAID_DMBTR_COC AS 'ZF_AMOUNT_COC',
		B14_04_ZF_BSAID_DMBTR_CUC AS 'ZF_AMOUNT_CUC',
		'' AS 'ZF_CUSTOMER',
		B14_04_BSAID_BUKRS AS 'ZF_COMPANY_CODE',
		'13_Payment_cancellation' AS ZF_CONCECPT_NAME_WITH_NUM,
		'Payment cancellation' AS ZF_CONCECPT_NAME,
		B14_04_BSAID_BLART AS ZF_DOCUMENT_TYPE,
		ZF_INVOICE_HAS_SO_FLAG,
		ZF_PAYMENT_HAS_SO_FLAG,
		13 AS ZF_STAGE,
		'' AS ZF_BILLING_DOCUMENT,
		...
		B14_04_T001_WAERS
FROM PM_OTC_01_TT_ADD_FLAG_GLOBAL 
WHERE ISNULL(B14_04_BSAID_AUGDT,'')<>''


--Add other activity keys
UNION
SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,
		B14_05_ZF_OTHERS AS ZF_DOCUMENT_NUMBER,
		B14_05_BSAID_AUGDT AS  'ZF_DATE_USED_IN_MODEL',
		'000000' AS 'ZF_TIME_USED_IN_MODEL',
		B14_05_BKPF_USNAM AS 'ZF_USER',
		B14_05_V_USERNAME_NAME_TEXT,
		B14_05_ZF_BSAID_DMBTR_COC AS 'ZF_AMOUNT_COC',
		B14_05_ZF_BSAID_DMBTR_CUC AS 'ZF_AMOUNT_CUC',
		'' AS 'ZF_CUSTOMER',
		B14_04_BSAID_BUKRS AS 'ZF_COMPANY_CODE',
		'14_Other' AS ZF_CONCECPT_NAME_WITH_NUM,
		'Other' AS ZF_CONCECPT_NAME,
		B14_04_BSAID_BLART AS ZF_DOCUMENT_TYPE,
		ZF_INVOICE_HAS_SO_FLAG,
		ZF_PAYMENT_HAS_SO_FLAG,
		13 AS ZF_STAGE,
		...
		B14_04_T001_WAERS
FROM PM_OTC_01_TT_ADD_FLAG_GLOBAL 
WHERE ISNULL(B14_05_BSAID_AUGDT,'')<>''
...
SELECT DISTINCT A.ZF_DOCUMENT_FLOW_KEY,
	CONCAT(
		DBO.TRIM(B21_21_CDHDR_OBJECTCLAS),'-',
		DBO.TRIM(B21_21_CDHDR_OBJECTID),'-',
		DBO.TRIM(B21_21_CDHDR_CHANGENR)) AS ZF_DOCUMENT_NUMBER,
		B21_21_CDHDR_UDATE AS  'ZF_DATE_USED_IN_MODEL',
		B21_21_CDHDR_UTIME AS 'ZF_TIME_USED_IN_MODEL',
		B21_21_CDHDR_USERNAME AS ZF_USER,
		B21_21_V_USERNAME_NAME_TEXT AS ZF_NAME_OF_USER,
		0 AS ZF_AMOUNT_COC,
		0 AS ZF_AMOUNT_CUC,
		B33_VBAK_KUNNR AS 'ZF_CUSTOMER',
		B33_TVKO_BUKRS AS 'ZF_COMPANY_CODE',
		CONCAT(B21_21_ZF_STAGE,'_',B21_21_ZF_CHANGE_DESC) AS ZF_CONCECPT_NAME_WITH_NUM,
		B21_21_ZF_CHANGE_DESC,
		'' AS ZF_DOCUMENT_TYPE,
		ZF_INVOICE_HAS_SO_FLAG,
		ZF_PAYMENT_HAS_SO_FLAG,
		B21_21_ZF_STAGE AS ZF_STAGE,
		'' AS ZF_BILLING_DOCUMENT,'' AS ZF_SALE_DOC,
		B33_T001_WAERS AS ZF_COMPANY_CURRENCY
	INTO PM_OTC_05A_TT_VERBELEG
		FROM  B21_21_IT_CHANGE_VERBELEG
	JOIN  PM_OTC_05_IT_ADD_START_END AS A
	ON   B21_21_CDHDR_OBJECTID=B33_VBAK_VBELN
	WHERE 
	 B21_21_CDHDR_UDATE BETWEEN A.ZF_START_DATE AND A.ZF_END_DATE
...
SELECT DISTINCT A.ZF_DOCUMENT_FLOW_KEY,
	CONCAT(
		DBO.TRIM(B21_23_CDHDR_OBJECTCLAS),'-',
		DBO.TRIM(B21_23_CDHDR_OBJECTID),'-',
		DBO.TRIM(B21_23_CDHDR_CHANGENR)) AS ZF_DOCUMENT_NUMBER,
		B21_23_CDHDR_UDATE AS  'ZF_DATE_USED_IN_MODEL',
		B21_23_CDHDR_UTIME AS 'ZF_TIME_USED_IN_MODEL',
		B21_23_CDHDR_USERNAME AS ZF_USER,
		B21_23_V_USERNAME_NAME_TEXT AS ZF_NAME_OF_USER,
		0 AS ZF_AMOUNT_COC,
		0 AS ZF_AMOUNT_CUC,
		B34_LIKP_KUNAG AS 'ZF_CUSTOMER',
		B34_TVKO_BUKRS AS 'ZF_COMPANY_CODE',
		CONCAT(B21_23_ZF_STAGE,'_',B21_23_ZF_CHANGE_DESC) AS ZF_CONCECPT_NAME_WITH_NUM,
		B21_23_ZF_CHANGE_DESC,
		'' AS ZF_DOCUMENT_TYPE,
		ZF_INVOICE_HAS_SO_FLAG,
		ZF_PAYMENT_HAS_SO_FLAG,
		B21_23_ZF_STAGE AS ZF_STAGE,
		'' AS ZF_BILLING_DOCUMENT,'' AS ZF_SALE_DOC,
		B34_T001_WAERS  AS ZF_COMPANY_CURRENCY
	INTO PM_OTC_05B_TT_LIEFERUNG
		FROM  B21_23_IT_CHANGE_LIEFERUNG
	JOIN  PM_OTC_05_IT_ADD_START_END AS A
	ON   B21_23_CDHDR_OBJECTID=B34_LIKP_VBELN
	WHERE 
	 B21_23_CDHDR_UDATE BETWEEN A.ZF_START_DATE AND A.ZF_END_DATE
...
SELECT DISTINCT A.ZF_DOCUMENT_FLOW_KEY,
	CONCAT(
		...
		DBO.TRIM(B21_25_CDHDR_CHANGENR)) AS ZF_DOCUMENT_NUMBER,
		B21_25_CDHDR_UDATE AS  'ZF_DATE_USED_IN_MODEL',
		B21_25_CDHDR_UTIME AS 'ZF_TIME_USED_IN_MODEL',
		B21_25_CDHDR_USERNAME AS ZF_USER,
		B21_25_V_USERNAME_NAME_TEXT AS ZF_NAME_OF_USER,
		0 AS ZF_AMOUNT_COC,
		0 AS ZF_AMOUNT_CUC,
		B36_VBRK_KUNAG AS 'ZF_CUSTOMER',
		B36_TVKO_BUKRS AS 'ZF_COMPANY_CODE',
		CONCAT(B21_25_ZF_STAGE,'_',B21_25_ZF_CHANGE_DESC) AS ZF_CONCECPT_NAME_WITH_NUM,
		B21_25_ZF_CHANGE_DESC,
		'' AS ZF_DOCUMENT_TYPE,
		ZF_INVOICE_HAS_SO_FLAG,
		ZF_PAYMENT_HAS_SO_FLAG,
		B21_25_ZF_STAGE AS ZF_STAGE,
		'' AS ZF_BILLING_DOCUMENT,'' AS ZF_SALE_DOC,
		B36_T001_WAERS AS ZF_COMPANY_CURRENCY
	INTO PM_OTC_05C_TT_FAKTBELEG
		FROM  B21_25_IT_CHANGE_FAKT
	JOIN  PM_OTC_05_IT_ADD_START_END AS A
	ON   B21_25_CDHDR_OBJECTID=B36_VBRK_VBELN
	WHERE 
	 B21_25_CDHDR_UDATE BETWEEN A.ZF_START_DATE AND A.ZF_END_DATE
...
A.ZF_DOCUMENT_FLOW_KEY,
	CONCAT(
		DBO.TRIM(B21_19_CDHDR_OBJECTCLAS),'-',
		DBO.TRIM(B21_19_CDHDR_OBJECTID),'-',
		DBO.TRIM(B21_19_CDHDR_CHANGENR)) AS ZF_DOCUMENT_NUMBER,
		B21_19_CDHDR_UDATE AS  'ZF_DATE_USED_IN_MODEL',
		B21_19_CDHDR_UTIME AS 'ZF_TIME_USED_IN_MODEL',
		B21_19_CDHDR_USERNAME AS ZF_USER,
		B21_19_V_USERNAME_NAME_TEXT AS ZF_NAME_OF_USER,
		0 AS ZF_AMOUNT_COC,
		0 AS ZF_AMOUNT_CUC,
		ZF_CUSTOMER,
		ZF_COMPANY_CODE,
		CONCAT(B21_19_ZF_STAGE,'_',B21_19_ZF_CHANGE_DESC) AS ZF_CONCECPT_NAME_WITH_NUM,
		B21_19_ZF_CHANGE_DESC,
		'' AS ZF_DOCUMENT_TYPE,
		A.ZF_INVOICE_HAS_SO_FLAG,
		A.ZF_PAYMENT_HAS_SO_FLAG,
		B21_19_ZF_STAGE AS ZF_STAGE,
		'' AS ZF_BILLING_DOCUMENT,'' AS ZF_SALE_DOC,
		ZF_COMPANY_CURRENCY
	INTO PM_OTC_05D_TT_DEBI
		FROM  B21_19_IT_CDHDR_CDPOS_DEBI
	JOIN  PM_OTC_02_TT_VERTICAL_TABLE AS A
	ON   B21_19_CDHDR_OBJECTID=ZF_CUSTOMER AND LEN(ZF_CUSTOMER)>0
	JOIN PM_OTC_05_IT_ADD_START_END 
	ON PM_OTC_05_IT_ADD_START_END.ZF_DOCUMENT_FLOW_KEY=A.ZF_DOCUMENT_FLOW_KEY
		AND B21_19_CDHDR_UDATE BETWEEN ZF_START_DATE AND ZF_END_DATE
...
EXEC SP_DROPTABLE PM_OTC_06_TT_GLOBAL_VERTICAL_SORT
	...
	*,'' AS ZF_SO_HAS_PRICE_CHANGE INTO PM_OTC_06_TT_GLOBAL_VERTICAL_SORT FROM PM_OTC_05_TT_VERTICAL_ADD_CHANGE
	...
	ON PM_OTC_06_TT_GLOBAL_VERTICAL_SORT(ZF_DOCUMENT_FLOW_KEY, ZF_DATE_USED_IN_MODEL,ZF_TIME_USED_IN_MODEL, ZF_STAGE)
...
SELECT  A.ZF_DOCUMENT_FLOW_KEY,
		...
		STUFF((SELECT '->' + E.ZF_CONCECPT_NAME
							 ...
							 ORDER BY E.ZF_DOCUMENT_FLOW_KEY, E.ZF_DATE_USED_IN_MODEL,E.ZF_TIME_USED_IN_MODEL,E.ZF_STAGE
		...
		A.ZF_SALE_DOC,A.ZF_COMPANY_CURRENCY
...
CREATE CLUSTERED INDEX PM_OTC_05_TT_PROCESS_MINING ON PM_OTC_08_TT_NODE_FROM_TO_SORT(ZF_DOCUMENT_FLOW_KEY, ZF_DATE_USED_IN_MODEL,ZF_TIME_USED_IN_MODEL,ZF_STAGE)
...
SELECT DISTINCT A.ZF_DOCUMENT_FLOW_KEY,
				...
				C.ZF_SALE_DOC,C.ZF_COMPANY_CURRENCY
...
OUTER APPLY(
			...
			ORDER BY B.ZF_DOCUMENT_FLOW_KEY,B.ZF_DATE_USED_IN_MODEL,B.ZF_TIME_USED_IN_MODEL
			) AS C
...
FROM B37_05_IT_CENTER_FACT_TABLE_ADD_INV_PAY
 WHERE B14_01_BSAID_CPUDT IS NOT NULL
...
FROM B37_05_IT_CENTER_FACT_TABLE_ADD_INV_PAY
 WHERE B14_03_BSAID_AUGDT IS NOT NULL
...
EXEC SP_DROPTABLE TEMP1
SELECT ZF_DOCUMENT_FLOW_KEY,ZF_INTEGER_FOR_USER,COUNT(DISTINCT ZF_NODE_FROM) AS A,ZF_NAME_OF_USER
INTO TEMP1
FROM TT_TEMP3
WHERE ZF_NODE_FROM <>'0_START'
...
SELECT DISTINCT A.ZF_DOCUMENT_FLOW_KEY, A.ZF_INTEGER_FOR_USER,A.ZF_NAME_OF_USER,'User who enters '+SUBSTRING(
        (
...
CASE
	WHEN DATEDIFF(DAY,A.ZF_DATE_USED_IN_MODEL,B.ZF_DATE_USED_IN_MODEL)<-365 THEN '<-365 days'
	WHEN DATEDIFF(DAY,A.ZF_DATE_USED_IN_MODEL,B.ZF_DATE_USED_IN_MODEL) BETWEEN -271 AND -365 THEN '-365 to -271 days'
	...
	WHEN DATEDIFF(DAY,A.ZF_DATE_USED_IN_MODEL,B.ZF_DATE_USED_IN_MODEL) BETWEEN 1 AND 30 THEN '1-30 days'
	...
	WHEN DATEDIFF(DAY,A.ZF_DATE_USED_IN_MODEL,B.ZF_DATE_USED_IN_MODEL) BETWEEN 271 AND 365 THEN '271-365 days'
...
--Step 19.1 Creata a list of SOD user, and flag their activity
	...
	EXEC SP_DROPTABLE TEMP1
SELECT DISTINCT ZF_INTEGER_FOR_USER,ZF_NAME_OF_USER,ZF_SOD_DESC,
IIF(
...
IIF(ZF_SOD_DESC LIKE '% Credit_note %','X','') AS ZF_CREDIT_NOTE_FLAG,
...
MAX(ZF_CREDIT_NOTE_FLAG) AS ZF_CREDIT_NOTE_FLAG
