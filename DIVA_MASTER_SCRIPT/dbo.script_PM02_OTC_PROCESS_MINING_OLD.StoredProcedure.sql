...
GO
CREATE   PROCEDURE [dbo].[script_PM02_OTC_PROCESS_MINING_OLD]
AS
...
SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,
		...
		B33_ZF_VBAP_NETWR_S AS 'ZF_AMOUNT_COC',
		B33_ZF_VBAP_NETWR_S_CUC AS 'ZF_AMOUNT_CUC',
		B33_ZF_VBAP_NETWR_S_CUC AS 'ZF_AMOUNT_CUC2',
		B33_ZF_VBAP_NETWR_S_CUC AS 'ZF_AMOUNT_CUC3',
		...
		'X' AS ZF_SALE_DOC,
		B33_VBAK_WAERK AS ZF_DOCUMENT_CURRENCY
...
SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,
		...
		B34_ZF_LIPS_NETWR AS 'ZF_AMOUNT_COC',
		B34_ZF_LIPS_NETWR_CUC AS 'ZF_AMOUNT_CUC',
		B34_ZF_LIPS_NETWR_CUC AS 'ZF_AMOUNT_CUC2',
		B34_ZF_LIPS_NETWR_CUC AS 'ZF_AMOUNT_CUC3',
		...
		'' AS ZF_BILLING_DOCUMENT,
		'',
		B34_LIKP_WAERK  AS ZF_DOCUMENT_CURRENCY
FROM PM_OTC_01_TT_ADD_FLAG_GLOBAL 
...
SELECT  ZF_DOCUMENT_FLOW_KEY,
		...
		B24_03_ZF_MSEG_DMBTR_SIGNED_CUC,
		B24_03_ZF_MSEG_DMBTR_SIGNED_CUC,
...
SELECT  ZF_DOCUMENT_FLOW_KEY,
		...
		B36_ZF_VBRP_NETWR_S AS 'ZF_AMOUNT_COC',
		...
		'',
		B36_VBRK_WAERK AS ZF_DOCUMENT_CURRENCY
FROM PM_OTC_01_TT_ADD_FLAG_GLOBAL 
...
SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,
		...
		B14_01_BSAID_BLDAT AS  'ZF_DATE_USED_IN_MODEL',
		...
		B14_01_T001_WAERS
FROM PM_OTC_01_TT_ADD_FLAG_GLOBAL 
WHERE ISNULL(B14_01_BSAID_BLDAT,'')<>''
--Add payment keys
UNION
SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,
		B14_03_ZF_CUSTOMER_PAYMENT_KEY AS ZF_DOCUMENT_NUMBER,
		B14_03_BSAID_BLDAT AS  'ZF_DATE_USED_IN_MODEL',
		...
		B14_03_BSAID_DMBE2,
		B14_03_BSAID_DMBE3,
		B14_03_BSAID_KUNNR AS 'ZF_CUSTOMER',
...
SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,
		...
		B14_04_BSAID_DMBE2,
		B14_04_BSAID_DMBE3,
		B14_04_BSAID_KUNNR AS 'ZF_CUSTOMER',
		...
		B14_04_T001_WAERS
FROM PM_OTC_01_TT_ADD_FLAG_GLOBAL 
WHERE ISNULL(B14_04_BSAID_BLDAT,'')<>''
...
SELECT DISTINCT A.ZF_DOCUMENT_FLOW_KEY,
	...
	ON   B21_19_CDHDR_OBJECTID=ZF_CUSTOMER
...
FROM B37_05_IT_CENTER_FACT_TABLE_ADD_INV_PAY
 WHERE B14_01_BSAID_BLDAT IS NOT NULL
...
FROM B37_05_IT_CENTER_FACT_TABLE_ADD_INV_PAY
 WHERE B14_03_BSAID_BLDAT IS NOT NULL
...
SELECT DISTINCT A.ZF_DOCUMENT_FLOW_KEY, A.ZF_INTEGER_FOR_USER,'User who enters '+SUBSTRING(
        (
...
--Step 19.1 Creata a list of SOD user, and flag their activity
	...
	EXEC SP_DROPTABLE TEMP1
SELECT DISTINCT ZF_INTEGER_FOR_USER,ZF_SOD_DESC,
IIF(
