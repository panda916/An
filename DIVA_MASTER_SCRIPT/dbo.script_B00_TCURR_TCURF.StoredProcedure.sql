...
CREATE           PROCEDURE [dbo].[script_B00_TCURR_TCURF]
...
/* Initialize parameters from globals table */
     ...
     DECLARE  
					 ...
					 ,@ZV_EXCHANGE_RATE_TYPE NVARCHAR(MAX) = (SELECT GLOBALS_VALUE FROM [AM_GLOBALS] WHERE GLOBALS_PARAMETER = 'ZV_EXCHANGE_RATE_TYPE')
