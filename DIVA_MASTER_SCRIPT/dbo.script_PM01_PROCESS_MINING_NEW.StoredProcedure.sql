...
GO
--/****** Object:  StoredProcedure [dbo].[script_PM01_PROCESS_MINING_NEW]    Script Date: 7/26/2023 2:09:00 PM ******/
--SET ANSI_NULLS ON
--GO
--SET QUOTED_IDENTIFIER ON
--GO
CREATE       PROCEDURE [dbo].[script_PM01_PROCESS_MINING_NEW]
AS
...
/* Initialize parameters from globals table */
     ...
     DECLARE 	 
			...
			--,@ZV_LIMIT nvarchar(max)		    = (SELECT [GLOBALS_VALUE] FROM [AM_GLOBALS] WHERE [GLOBALS_PARAMETER] = 'LIMIT_PERIODS')
...
SELECT  ZF_DOCUMENT_FLOW_KEY AS ZF_DOCUMENT_FLOW_KEY,
		...
		EKPO_T001_WAERS AS ZF_COMPANY_CURRENCY,
		ZF_PO_CATEGORY AS ZF_DOCUMENT_TYPE
FROM PM_01_TT_ADD_FLAG_GLOBAL
WHERE ISNULL(EKKO_AEDAT,'')<>'' 
UNION
SELECT  ZF_DOCUMENT_FLOW_KEY AS ZF_DOCUMENT_FLOW_KEY,
		ZF_MSEG_EBELN_EBELP_BUKRS AS ZF_DOCUMENT_NUMBER,
		MKPF_CPUDT AS  'ZF_DATE_USED_IN_MODEL',
		MKPF_CPUTM AS 'ZF_TIME_USED_IN_MODEL',
		'7_GOOD_RECEIPT' AS ZF_CONCECPT_NAME,
		7 AS ZF_STAGE,
		ZF_PAYMENT_HAS_PO_FLAG AS ZF_PAYMENT_HAS_PO_FLAG ,
		ZF_INVOICE_HAS_PO_FLAG AS ZF_INVOICE_HAS_PO_FLAG,
		ZF_PRODUCT_FLAG AS ZF_PRODUCT_FLAG,
		ZF_MSEG_DMBTR_SIGNED_CUC AS ZF_AMOUNT_CUC,	
		ZF_MSEG_DMBTR_SIGNED_CUC AS ZF_AMOUNT_CUC2,
		ZF_MSEG_DMBTR_SIGNED_CUC AS ZF_AMOUNT_CUC3,
		ZF_MSEG_DMBTR_SIGNED AS ZF_AMOUNT_COC,
		MKPF_USNAM AS ZF_USER,
		V_USERNAME_NAME_TEXT_MSEG AS ZF_NAME_OF_USER,
		MSEG_BUKRS AS ZF_COMPANY_CODE,
		MSEG_WAERS AS ZF_COMPANY_CURRENCY,
		MKPF_T003T_LTEXT AS ZF_DOCUMENT_TYPE			
FROM PM_01_TT_ADD_FLAG_GLOBAL
WHERE ISNULL(MKPF_CPUDT,'')<>''
...
SELECT  ZF_DOCUMENT_FLOW_KEY AS ZF_DOCUMENT_FLOW_KEY,
		...
		ZF_RSEG_WRBTR_S_COC AS ZF_AMOUNT_COC,
		RBKP_USNAM AS ZF_USER,
		V_USERNAME_NAME_TEXT_RBKP AS ZF_NAME_OF_USER,
		RSEG_BUKRS AS ZF_COMPANY_CODE,
		RBKP_T001_WAERS AS ZF_COMPANY_CURRENCY,
		RBKP_T003T_LTEXT AS ZF_DOCUMENT_TYPE			
FROM PM_01_TT_ADD_FLAG_GLOBAL
WHERE ISNULL(RBKP_CPUDT,'')<>''
UNION 
SELECT  ZF_DOCUMENT_FLOW_KEY AS ZF_DOCUMENT_FLOW_KEY,
		ZF_BSEG_BUKRS_GJAHR_BELNR_BUZEI AS ZF_DOCUMENT_NUMBER,
		BKPF_CPUDT_INV AS  'ZF_DATE_USED_IN_MODEL',
		BKPF_CPUTM_INV AS 'ZF_TIME_USED_IN_MODEL',
		'8.2_INVOICE_RECEIPT' AS ZF_CONCECPT_NAME,
		8.1 AS ZF_STAGE,
		ZF_PAYMENT_HAS_PO_FLAG AS ZF_PAYMENT_HAS_PO_FLAG ,
		ZF_INVOICE_HAS_PO_FLAG AS ZF_INVOICE_HAS_PO_FLAG,
		ZF_PRODUCT_FLAG AS ZF_PRODUCT_FLAG,
		ZF_BSEG_DMBTR_S_CUC_INV AS ZF_AMOUNT_CUC,
		ZF_BSEG_DMBE2_S_INV AS ZF_AMOUNT_CUC2,
		ZF_BSEG_DMBE3_S_INV AS ZF_AMOUNT_CUC3,
		ZF_BSEG_DMBTR_S_INV AS ZF_AMOUNT_COC,
		BKPF_USNAM_INV AS ZF_USER,
		V_USERNAME_NAME_TEXT_INV AS ZF_NAME_OF_USER,
		BSEG_BUKRS_INV AS ZF_COMPANY_CODE,
		BSEG_T001_WAERS_INV AS ZF_COMPANY_CURRENCY,
		B11B_SS02_T003T_LTEXT_INV AS ZF_DOCUMENT_TYPE		
FROM PM_01_TT_ADD_FLAG_GLOBAL
WHERE ISNULL(BKPF_CPUDT_INV,'')<>''
UNION 
SELECT  ZF_DOCUMENT_FLOW_KEY AS ZF_DOCUMENT_FLOW_KEY,
		ZF_BSAIK_BUKRS_GJAHR_BELNR_BUZEI_PAY AS ZF_DOCUMENT_NUMBER,
		BSAIK_CPUDT_PAY AS  'ZF_DATE_USED_IN_MODEL',
		BSAIK_CPUTM_PAY AS 'ZF_TIME_USED_IN_MODEL',
		'17_PAYMENT' AS ZF_CONCECPT_NAME,
		17 AS ZF_STAGE,
		ZF_PAYMENT_HAS_PO_FLAG AS ZF_PAYMENT_HAS_PO_FLAG ,
		ZF_INVOICE_HAS_PO_FLAG AS ZF_INVOICE_HAS_PO_FLAG,
		ZF_PRODUCT_FLAG AS ZF_PRODUCT_FLAG,
		ZF_BSAIK_DMBTR_S_CUC_PAY AS ZF_AMOUNT_CUC,
		ZF_BSAIK_DMBE2_S_PAY AS ZF_AMOUNT_CUC2,
		ZF_BSAIK_DMBE3_S_PAY AS ZF_AMOUNT_CUC3,
		ZF_BSAIK_DMBTR_S_PAY AS ZF_AMOUNT_COC,
		BKPF_USNAM_PAY AS ZF_USER,
		V_USERNAME_NAME_TEXT_PAY AS ZF_NAME_OF_USER,
		BSAIK_BUKRS_PAY AS ZF_COMPANY_CODE,
		B11B_SS02_T001_WAERS AS ZF_COMPANY_CURRENCY,
		B11B_SS02_T003T_LTEXT_PAY AS ZF_DOCUMENT_TYPE		
FROM PM_01_TT_ADD_FLAG_GLOBAL
WHERE ISNULL(BSAIK_CPUDT_PAY,'')<>''
...
SELECT DISTINCT A.ZF_DOCUMENT_FLOW_KEY,
	CONCAT(
		DBO.TRIM(B21_02_CDHDR_OBJECTCLAS),'-',
		DBO.TRIM(B21_02_CDHDR_OBJECTID),'-',
		DBO.TRIM(B21_02_CDHDR_CHANGENR)) AS ZF_DOCUMENT_NUMBER,
		B21_02_CDHDR_UDATE AS  'ZF_DATE_USED_IN_MODEL',
		B21_02_CDHDR_UTIME AS 'ZF_TIME_USED_IN_MODEL',
		B21_02_ZF_CHANGE_DESC AS ZF_CONCECPT_NAME,
		B21_02_ZF_STAGE AS ZF_STAGE,
		ZF_PAYMENT_HAS_PO_FLAG AS ZF_PAYMENT_HAS_PO_FLAG ,
		ZF_INVOICE_HAS_PO_FLAG AS ZF_INVOICE_HAS_PO_FLAG,
		ZF_PRODUCT_FLAG AS ZF_PRODUCT_FLAG,
		0 AS ZF_AMOUNT_CUC,
		...
		0 AS ZF_AMOUNT_CUC3,
		0 AS ZF_AMOUNT_COC,
		B21_02_CDHDR_USERNAME AS ZF_USER,
		B21_02_V_USERNAME_NAME_TEXT AS ZF_NAME_OF_USER,
		EKPO_BUKRS AS ZF_COMPANY_CODE,
		EKPO_T001_WAERS AS ZF_COMPANY_CURRENCY,
		'' AS ZF_DOCUMENT_TYPE	
		INTO PM_05A_TT_EINKBELEG
		FROM  B21_02_IT_CDHDR_CDPOS_EINKBELEG
	JOIN  PM_05_IT_ADD_START_END AS A
	ON   B21_02_CDHDR_OBJECTID=EKPO_EBELN
	WHERE 
	 B21_02_CDHDR_UDATE BETWEEN A.ZF_START_DATE AND A.ZF_END_DATE
--6.2 INCOMINGINVOICE
EXEC SP_DROPTABLE PM_05B_TT_INCOMINGINVOICE

SELECT DISTINCT A.ZF_DOCUMENT_FLOW_KEY,
	CONCAT(
		DBO.TRIM(B21_04_CDHDR_OBJECTCLAS),'-',
		DBO.TRIM(B21_04_CDHDR_OBJECTID),'-',
		DBO.TRIM(B21_04_CDHDR_CHANGENR)) AS ZF_DOCUMENT_NUMBER,
		B21_04_CDHDR_UDATE AS  'ZF_DATE_USED_IN_MODEL',
		B21_04_CDHDR_UTIME AS 'ZF_TIME_USED_IN_MODEL',
		B21_04_ZF_CHANGE_DESC AS ZF_CONCECPT_NAME,
		B21_04_ZF_STAGE AS ZF_STAGE,
		ZF_PAYMENT_HAS_PO_FLAG AS ZF_PAYMENT_HAS_PO_FLAG ,
		ZF_INVOICE_HAS_PO_FLAG AS ZF_INVOICE_HAS_PO_FLAG,
		ZF_PRODUCT_FLAG AS ZF_PRODUCT_FLAG,
		0 AS ZF_AMOUNT_CUC,
		...
		0 AS ZF_AMOUNT_CUC3,
		0 AS ZF_AMOUNT_COC,
		B21_04_CDHDR_USERNAME AS ZF_USER,
		B21_04_V_USERNAME_NAME_TEXT AS ZF_NAME_OF_USER,
		RSEG_BUKRS AS ZF_COMPANY_CODE,
		RBKP_T001_WAERS AS ZF_COMPANY_CURRENCY,
		'' AS ZF_DOCUMENT_TYPE	
		INTO PM_05B_TT_INCOMINGINVOICE
		FROM  B21_04_IT_CDHDR_CDPOS_INCOMINGINVOICE 
 JOIN  PM_05_IT_ADD_START_END AS A
ON   DBO.TRIM(B21_04_CDHDR_OBJECTID)  = CONCAT(RSEG_BELNR,RSEG_GJAHR)
	WHERE 
	 B21_04_CDHDR_UDATE BETWEEN A.ZF_START_DATE AND A.ZF_END_DATE
...
SELECT DISTINCT A.ZF_DOCUMENT_FLOW_KEY,
	CONCAT(
		DBO.TRIM(B21_06_CDHDR_OBJECTCLAS),'-',
		DBO.TRIM(B21_06_CDHDR_OBJECTID),'-',
		DBO.TRIM(B21_06_CDHDR_CHANGENR)) AS ZF_DOCUMENT_NUMBER,
		B21_06_CDHDR_UDATE AS  'ZF_DATE_USED_IN_MODEL',
		B21_06_CDHDR_UTIME AS 'ZF_TIME_USED_IN_MODEL',
		B21_06_ZF_CHANGE_DESC AS ZF_CONCECPT_NAME,
		B21_06_ZF_STAGE AS ZF_STAGE,
		ZF_PAYMENT_HAS_PO_FLAG AS ZF_PAYMENT_HAS_PO_FLAG ,
		ZF_INVOICE_HAS_PO_FLAG AS ZF_INVOICE_HAS_PO_FLAG,
		ZF_PRODUCT_FLAG AS ZF_PRODUCT_FLAG,
		0 AS ZF_AMOUNT_CUC,
		...
		0 AS ZF_AMOUNT_CUC3,
		0 AS ZF_AMOUNT_COC,
		B21_06_CDHDR_USERNAME AS ZF_USER,
		B21_06_V_USERNAME_NAME_TEXT AS ZF_NAME_OF_USER,
		BSEG_BUKRS_INV AS ZF_COMPANY_CODE,
		B11B_SS02_T001_WAERS AS ZF_COMPANY_CURRENCY,
		'' AS ZF_DOCUMENT_TYPE	
		INTO PM_05C_TT_IBAN
		FROM  B21_06_IT_CDHDR_CDPOS_IBAN
 JOIN  PM_05_IT_ADD_START_END AS A
	ON  B21_06_LFBK_LIFNR=BSEG_LIFNR_INV
	WHERE 
	 B21_06_CDHDR_UDATE BETWEEN A.ZF_START_DATE AND A.ZF_END_DATE
...
SELECT DISTINCT A.ZF_DOCUMENT_FLOW_KEY,
	CONCAT(
		DBO.TRIM(B21_10_CDHDR_OBJECTCLAS),'-',
		DBO.TRIM(B21_10_CDHDR_OBJECTID),'-',
		DBO.TRIM(B21_10_CDHDR_CHANGENR)) AS ZF_DOCUMENT_NUMBER,
		B21_10_CDHDR_UDATE AS  'ZF_DATE_USED_IN_MODEL',
		B21_10_CDHDR_UTIME AS 'ZF_TIME_USED_IN_MODEL',
		B21_10_ZF_CHANGE_DESC AS ZF_CONCECPT_NAME,
		B21_10_ZF_STAGE AS ZF_STAGE,
		ZF_PAYMENT_HAS_PO_FLAG AS ZF_PAYMENT_HAS_PO_FLAG ,
		ZF_INVOICE_HAS_PO_FLAG AS ZF_INVOICE_HAS_PO_FLAG,
		ZF_PRODUCT_FLAG AS ZF_PRODUCT_FLAG,
		0 AS ZF_AMOUNT_CUC,
		...
		0 AS ZF_AMOUNT_CUC3,
		0 AS ZF_AMOUNT_COC,
		B21_10_CDHDR_USERNAME AS ZF_USER,
		B21_10_V_USERNAME_NAME_TEXT AS ZF_NAME_OF_USER,
		BSEG_BUKRS_INV AS ZF_COMPANY_CODE,
		'' AS ZF_DOCUMENT_TYPE	
		INTO PM_05D_TT_BELEG_INV
		FROM  B21_10_IT_CDHDR_CDPOS_BELEG
 JOIN  PM_05_IT_ADD_START_END AS A
	ON 
	SUBSTRING(DBO.TRIM(B21_10_CDHDR_OBJECTID),4,LEN(DBO.TRIM(B21_10_CDHDR_OBJECTID))-3) =
	CONCAT(DBO.TRIM(BSEG_BUKRS_INV),DBO.TRIM(BSEG_BELNR_INV),DBO.TRIM(BSEG_GJAHR_INV))
	WHERE 
	 B21_10_CDHDR_UDATE BETWEEN A.ZF_START_DATE AND A.ZF_END_DATE
	AND (ISNULL(BSEG_BUKRS_INV,'')<>'' AND ISNULL(BSEG_BELNR_INV,'')<>'' AND ISNULL(BSEG_GJAHR_INV,'')<>'')
...
SELECT DISTINCT A.ZF_DOCUMENT_FLOW_KEY,
	CONCAT(
		...
		FROM  B21_10_IT_CDHDR_CDPOS_BELEG
 JOIN  PM_05_IT_ADD_START_END AS A
	ON SUBSTRING(DBO.TRIM(B21_10_CDHDR_OBJECTID),4,LEN(DBO.TRIM(B21_10_CDHDR_OBJECTID))-3) = 
	CONCAT(DBO.TRIM(BSAIK_BUKRS_PAY),DBO.TRIM(BSAIK_BELNR_PAY),DBO.TRIM(BSAIK_GJAHR_PAY))
	WHERE 
	 B21_10_CDHDR_UDATE BETWEEN A.ZF_START_DATE AND A.ZF_END_DATE
	AND ( ISNULL(BSAIK_BUKRS_PAY,'')<>'' AND ISNULL(BSAIK_BELNR_PAY,'')<>'' AND ISNULL(BSAIK_GJAHR_PAY,'')<>'')
--KRED(LFB1)
EXEC SP_DROPTABLE PM_05F_TT_KRED_LFB1

SELECT DISTINCT  A.ZF_DOCUMENT_FLOW_KEY,
	CONCAT(
		DBO.TRIM(B21_08_CDHDR_OBJECTCLAS),'-',
		DBO.TRIM(B21_08_CDHDR_OBJECTID),'-',
		DBO.TRIM(B21_08_CDHDR_CHANGENR)) AS ZF_DOCUMENT_NUMBER,
		B21_08_CDHDR_UDATE AS  'ZF_DATE_USED_IN_MODEL',
		B21_08_CDHDR_UTIME AS 'ZF_TIME_USED_IN_MODEL',
		B21_08_ZF_CHANGE_DESC AS ZF_CONCECPT_NAME,
		B21_08_ZF_STAGE AS ZF_STAGE,
		ZF_PAYMENT_HAS_PO_FLAG AS ZF_PAYMENT_HAS_PO_FLAG ,
		ZF_INVOICE_HAS_PO_FLAG AS ZF_INVOICE_HAS_PO_FLAG,
		ZF_PRODUCT_FLAG AS ZF_PRODUCT_FLAG,
		0 AS ZF_AMOUNT_CUC,
		...
		0 AS ZF_AMOUNT_CUC3,
		0 AS ZF_AMOUNT_COC,
		B21_08_CDHDR_USERNAME AS ZF_USER,
		B21_08_V_USERNAME_NAME_TEXT AS ZF_NAME_OF_USER,
		BSEG_BUKRS_INV AS ZF_COMPANY_CODE,
		BSEG_T001_WAERS_INV AS ZF_COMPANY_CURRENCY,
		'' AS ZF_DOCUMENT_TYPE	
		INTO PM_05F_TT_KRED_LFB1
		FROM  B21_08_IT_CDHDR_CDPOS_KRED
		JOIN  PM_05_IT_ADD_START_END AS A
	ON DBO.TRIM(RIGHT(B21_08_CDPOS_TABKEY,LEN(B21_08_CDPOS_TABKEY)-3)) =  CONCAT(DBO.TRIM(BSEG_LIFNR_INV),DBO.TRIM(BSEG_BUKRS_INV))
	WHERE 
	 B21_08_CDHDR_UDATE BETWEEN A.ZF_START_DATE AND A.ZF_END_DATE
	 AND B21_08_CDPOS_TABNAME='LFB1' 
	 AND (ISNULL(BSEG_LIFNR_INV,'')<>'' AND  ISNULL(BSEG_BUKRS_INV,'')<>'')
--KRED(LFA1)
...
SELECT DISTINCT  A.ZF_DOCUMENT_FLOW_KEY,
	CONCAT(
		...
		FROM  B21_08_IT_CDHDR_CDPOS_KRED
 JOIN  PM_05_IT_ADD_START_END AS A
		ON DBO.TRIM(B21_08_CDHDR_OBJECTID) =  BSEG_LIFNR_INV
	WHERE 
		 B21_08_CDHDR_UDATE BETWEEN A.ZF_START_DATE AND A.ZF_END_DATE
		 AND B21_08_CDPOS_TABNAME='LFA1'


--Create the list of bank accounts, and their document flows,
--TO check if the document flow has the bank changes or not
EXEC SP_DROPTABLE XTEMP

SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,ZF_START_DATE,ZF_END_DATE,
 LFBK_BANKN AS LFBK_BANKN_PAY,
 REGUH_ZBNKN AS REGUH_ZBNKN_PAY,
 BSAIK_BUKRS_PAY,
 		ZF_PAYMENT_HAS_PO_FLAG ,
		ZF_INVOICE_HAS_PO_FLAG,
		ZF_PRODUCT_FLAG,
		B11B_SS02_T001_WAERS 
INTO XTEMP
FROM 
PM_05_IT_ADD_START_END
INNER JOIN B11_SS02_06_IT_PTP_APA_PAY_ACCOUNT_LINE
ON CONCAT(BSAIK_BUKRS,'-',BSAIK_GJAHR,'-',BSAIK_BELNR)=ZF_BSAIK_BUKRS_GJAHR_BELNR_BUZEI_PAY
WHERE
BSAIK_BUKRS_PAY IS NOT NULL AND ( LFBK_BANKN IS NOT NULL OR REGUH_ZBNKN IS NOT NULL)

--Get the REGUH pay bank change
EXEC SP_DROPTABLE PM_05H_TT_REGUH

SELECT DISTINCT  A.ZF_DOCUMENT_FLOW_KEY,
	CONCAT(
		DBO.TRIM(B21_12_CDHDR_OBJECTCLAS),'-',
		DBO.TRIM(B21_12_CDHDR_OBJECTID),'-',
		DBO.TRIM(B21_12_CDHDR_CHANGENR)) AS ZF_DOCUMENT_NUMBER,
		B21_12_CDHDR_UDATE AS  'ZF_DATE_USED_IN_MODEL',
		B21_12_CDHDR_UTIME AS 'ZF_TIME_USED_IN_MODEL',
		'16_PAY_BANK_CHANGE' AS ZF_CONCECPT_NAME,
		16 AS ZF_STAGE,
		ZF_PAYMENT_HAS_PO_FLAG AS ZF_PAYMENT_HAS_PO_FLAG ,
		ZF_INVOICE_HAS_PO_FLAG AS ZF_INVOICE_HAS_PO_FLAG,
		ZF_PRODUCT_FLAG AS ZF_PRODUCT_FLAG,
		...
		0 AS ZF_AMOUNT_CUC3,
		0 AS ZF_AMOUNT_COC,
		B21_12_CDHDR_USERNAME AS ZF_USER,
		B21_12_V_USERNAME_NAME_TEXT AS ZF_NAME_OF_USER,
		BSAIK_BUKRS_PAY AS ZF_COMPANY_CODE,
		B11B_SS02_T001_WAERS AS ZF_COMPANY_CURRENCY,
		'' AS ZF_DOCUMENT_TYPE	
		INTO PM_05H_TT_REGUH
		FROM  B21_12_IT_REGUH_BANK
 JOIN  XTEMP AS A 
		ON DBO.TRIM(REGUH_ZBNKN_PAY)= DBO.TRIM(B21_12_CDPOS_VALUE_NEW) 
	WHERE 
	 B21_12_CDHDR_UDATE BETWEEN A.ZF_START_DATE AND A.ZF_END_DATE
--Add the LFBK pay bank change
EXEC SP_DROPTABLE PM_05I_TT_LFBK

SELECT DISTINCT  A.ZF_DOCUMENT_FLOW_KEY,
	CONCAT(
		DBO.TRIM(B21_17_CDHDR_OBJECTCLAS),'-',
		DBO.TRIM(B21_17_CDHDR_OBJECTID),'-',
		DBO.TRIM(B21_17_CDHDR_CHANGENR)) AS ZF_DOCUMENT_NUMBER,
		B21_17_CDHDR_UDATE AS  'ZF_DATE_USED_IN_MODEL',
		B21_17_CDHDR_UTIME AS 'ZF_TIME_USED_IN_MODEL',
		...
		0 AS ZF_AMOUNT_CUC3,
		0 AS ZF_AMOUNT_COC,
		B21_17_CDHDR_USERNAME AS ZF_USER,
		B21_17_V_USERNAME_NAME_TEXT AS ZF_NAME_OF_USER,
		BSAIK_BUKRS_PAY AS ZF_COMPANY_CODE,
		B11B_SS02_T001_WAERS AS ZF_COMPANY_CURRENCY,
		'' AS ZF_DOCUMENT_TYPE	
		INTO PM_05I_TT_LFBK
		FROM  B21_17_IT_CHANGE_LFBK_INSERT_DEL
 JOIN  PM_05_IT_ADD_START_END AS A
		ON   DBO.TRIM(LFBK_BANKN_PAY) = DBO.TRIM(B21_17_ZF_LFBK_BANKN_NEW)
	WHERE 
	 B21_17_CDHDR_UDATE BETWEEN A.ZF_START_DATE AND A.ZF_END_DATE
...
UNION 
SELECT * FROM PM_05H_TT_REGUH
UNION 
SELECT * FROM PM_05I_TT_LFBK
...
SELECT  A.ZF_DOCUMENT_FLOW_KEY,
		...
		A.ZF_COMPANY_CURRENCY,
		STUFF((SELECT '->' + E.ZF_CONCECPT_NAME 
							 FROM TEMP2 AS E
							 WHERE E.ZF_DOCUMENT_FLOW_KEY = A.ZF_DOCUMENT_FLOW_KEY 
							  ORDER BY E.ZF_DOCUMENT_FLOW_KEY, E.ZF_DATE_USED_IN_MODEL,
									   E.ZF_TIME_USED_IN_MODEL,E.ZF_STAGE
		...
		A.ZF_COMPANY_CODE,
		A.ZF_DOCUMENT_TYPE,
		ROW_NUMBER() OVER (PARTITION BY A.ZF_DOCUMENT_FLOW_KEY 
		ORDER BY A.ZF_DOCUMENT_FLOW_KEY,A.ZF_DATE_USED_IN_MODEL,A.ZF_TIME_USED_IN_MODEL,A.ZF_STAGE) AS ZF_STAGE
...
CREATE CLUSTERED INDEX PM_05_TT_PROCESS_MINING
ON PM_08_TT_NODE_FROM_TO_SORT(ZF_DOCUMENT_FLOW_KEY, ZF_DATE_USED_IN_MODEL,ZF_TIME_USED_IN_MODEL,ZF_STAGE)
...
SELECT DISTINCT A.ZF_DOCUMENT_FLOW_KEY,
				...
				C.ZF_TIME_USED_IN_MODEL AS ZF_TIME_USED_IN_MODEL,
...
OUTER APPLY(
			...
			ORDER BY B.ZF_DOCUMENT_FLOW_KEY,B.ZF_DATE_USED_IN_MODEL,B.ZF_TIME_USED_IN_MODEL,B.ZF_STAGE) AS C
...
FROM B25_01_IT_PTP_GLOBAL_TABLE
 WHERE BKPF_CPUDT_INV IS NOT NULL
...
FROM B25_01_IT_PTP_GLOBAL_TABLE
 WHERE BSAIK_CPUDT_PAY IS NOT NULL
...
INTO TT_TEMP3
FROM TT_TEMP2
WHERE NOT(ZF_FLAG IS NOT NULL AND ZF_NODE_FROM='8.2_MM_INVOICE')
...
--EXEC SP_DROPTABLE PM_17_RT_SOD_TABLE
--SELECT ZF_DOCUMENT_FLOW_KEY,ZF_INTEGER_FOR_USER,COUNT(DISTINCT ZF_NODE_FROM) AS A,
--'Users who enters' + dbo.GROUP_CONCAT(CONCAT(ZF_NODE_FROM,' and ' )) AS ZF_SOD_DESC
...
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC,'1_PURCHASE_REQUEST' , 'Purchase request')
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC,'2_PURCHASE_ORDER' , 'Purchase order')
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC,'7_GOOD_RECEIPT' , 'Good receipt')
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC,'8.2_INVOICE_RECEIPT' , 'Invoice receipt')
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC,'8.1_MM_INVOICE' , 'MM invoice receipt')
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC,'17_PAYMENT' , 'Payment' )
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC, '4_PO_APPROVALS' , 'PO approval')
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC, '6_PO_PRICE_CHANGE' , 'PO price change')
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC, '5_CHANGE_TO_PO_AMOUNT' , 'PO amount change')
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC, '9_CHANGE_TO_INVOICE_VALUE' , 'invoice value change')
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC, '9_CHANGE_TO_FI_INVOICE_VALUE' , 'FI invoice value change')
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC, '10_RELEASE_OF_INVOICE_REQUIRED' , 'relase of invoice required')
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC, '11_SUPPLIER_IS_BLOCKED' , 'supplier is block')
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC, '12_SUPPLIER_PAYMENT_TERMS' , 'supplier payment term')
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC, '13_CHANGE_TO_PAYMENT_METHOD', 'supplier payment method')
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC, '14_CHANGE_TO_PAYMENT_BLOCK' , 'supplier payment block change')
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC, '15_CHANGE_TO_RELEASE_GROUP' , 'supplier release group change')
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC, '16_CHANGE_TO_RELEASE_STRATEGY' , 'supplier release strategy change')
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC, '16_PAY_BANK_CHANGE' , 'payment bank change')
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC, '16_SUPPLIER_PAY_BANK_CHANGE' , 'payment supplier bank change')
UPDATE PM_17_RT_SOD_TABLE SET ZF_SOD_DESC=REPLACE(ZF_SOD_DESC, '3_CHANGE_TO_IBAN' , 'IBAN change')
...
CASE
	WHEN DATEDIFF(DAY,A.ZF_DATE_USED_IN_MODEL,B.ZF_DATE_USED_IN_MODEL)<-360 THEN '<-360 days'
	WHEN DATEDIFF(DAY,A.ZF_DATE_USED_IN_MODEL,B.ZF_DATE_USED_IN_MODEL) BETWEEN -270 AND -365 THEN '-365 to -271 days'
	...
	WHEN DATEDIFF(DAY,A.ZF_DATE_USED_IN_MODEL,B.ZF_DATE_USED_IN_MODEL) BETWEEN 1 AND 30 THEN '0 to 30 days'
...
(
 ...
 JOIN PM_18_TT_FILTER_FLOW AS B
	ON A.ZF_DOCUMENT_FLOW_KEY=B.ZF_DOCUMENT_FLOW_KEY 
	AND B.ZF_NODE_FROM='8_INVOICE_RECEIPT'
	AND A.ZF_DATE_USED_IN_MODEL<=B.ZF_DATE_USED_IN_MODEL
UNION
SELECT DISTINCT A.ZF_DOCUMENT_FLOW_KEY,
A.ZF_NODE_FROM AS ZF_FROM,
...
IIF(ZF_SOD_DESC LIKE '% and Payment%' OR ZF_SOD_DESC LIKE '% enters Payment%'  ,'X','') AS ZF_PAYMENT_FLAG,
