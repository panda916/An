...
/*
	   ...
	   23-09-2024					HL						Add more fields to the table B22_09_IT_UST10S_AGR_PROFILE_OBJCT_AUTH_FIELD_VALUE as we need them for SAP USAGE
*/
...
EXEC SP_REMOVE_TABLES 'B22A[_]%[_]TT%'
	...
	BEGIN
		...
		EXEC SP_RENAME_FIELD 'USOBX_', 'A_USOBT_C'
	END
...
-- Step 7: Combine Authorization objects from Profile and Role
	...
	SELECT DISTINCT AGR_USERS_UNAME, AGR_1251_AUTH, AGR_1251_OBJECT, AGR_1251_FIELD, AGR_1251_LOW, AGR_1251_HIGH , '' AS ZF_PROFILE  -- HL: Added from SAP USAGE
	FROM A_AGR_USERS
	...
	SELECT DISTINCT AGR_USERS_UNAME, UST12_AUTH, UST12_OBJCT, UST12_FIELD, UST12_VON, UST12_BIS, AGR_1016_PROFILE -- HL: Added from SAP USAGE
	FROM A_AGR_USERS
	-- Limit on active users
	INNER JOIN B22_00_TT_USR02_BNAME_ACTIVE 
					ON AGR_USERS_UNAME = USR02_BNAME
	...
	SELECT DISTINCT AGR_USERS_UNAME, UST12_AUTH, AU.UST12_OBJCT, AU.UST12_FIELD, AU.UST12_VON, AU.UST12_BIS, AGR_PROF_PROFILE -- HL: Added from SAP USAGE
	FROM A_AGR_USERS
	INNER JOIN B22_00_TT_USR02_BNAME_ACTIVE 
					ON AGR_USERS_UNAME = USR02_BNAME
	LEFT JOIN B22_06B_TT_AGR_ROLE_NORMALIZED 
	...
	-- Export B22_09_TT_UST10S_AGR_PROFILE_OBJCT_AUTH_FIELD_VALUE to an IT table so it can be used for SAP USAGE
...
-- Step 20: combine outputs from step 18 & step 19 to final table
	...
	LEFT JOIN A_TSTCT ON TSTCT_SPRSL in ('E', 'EN') AND dbo.REMOVE_LEADING_ZEROES(TSTCT_TCODE) = dbo.REMOVE_LEADING_ZEROES(A.B22A_ZF_AGR_UST12_VON)
...
--Step 26: Create SOD matrix table
    ...
    USR02_BNAME + TCODE_1 + TCODE_2 + TCODE_3 + TCODE_4 AS ZF_RISK_ID
...
EXEC SP_RENAME_FIELD 'B22D_', 'B22D_41_IT_BNAME_AUTH_FULL_MAPPING_TSTCA_USOBT_VALID'
 ...
 -- TCODE 3 conflicts with TCODE 4
 	...
 	SELECT DISTINCT A.B22C_USR02_BNAME, A.ZF_RISK_ID,
	B1.ZF_AGR_UST12_FIELD, 1 as ZF_TCODE_1_NUMBER, 2 as ZF_TCODE_2_NUMBER, 
	B1.ZF_AGR_UST12_VON ZF_TCODE_1_VON, B1.ZF_AGR_UST12_BIS ZF_TCODE_1_BIS, 
	B2.ZF_AGR_UST12_VON ZF_TCODE_2_VON, B2.ZF_AGR_UST12_BIS ZF_TCODE_2_BIS, 
	A.USOBT_LOW_1, B1.SOURCE_TABLE
    ...
    FROM B22_44_TT_SOD_MATRIX_WITH_USOBT_TSTCA_VALUE_CONFLICT A
 	...
 	SELECT DISTINCT A.B22C_USR02_BNAME, A.ZF_RISK_ID,
	B1.ZF_AGR_UST12_FIELD, 1 as ZF_TCODE_1_NUMBER, 3 as ZF_TCODE_2_NUMBER, 
	B1.ZF_AGR_UST12_VON ZF_TCODE_1_VON, B1.ZF_AGR_UST12_BIS ZF_TCODE_1_BIS, 
	B2.ZF_AGR_UST12_VON ZF_TCODE_2_VON, B2.ZF_AGR_UST12_BIS ZF_TCODE_2_BIS, 
	A.USOBT_LOW_1, B1.SOURCE_TABLE
 	FROM B22_44_TT_SOD_MATRIX_WITH_USOBT_TSTCA_VALUE_CONFLICT A
 	...
 	SELECT DISTINCT A.B22C_USR02_BNAME, A.ZF_RISK_ID,
	B1.ZF_AGR_UST12_FIELD, 1 as ZF_TCODE_1_NUMBER, 4 as ZF_TCODE_2_NUMBER, 
	B1.ZF_AGR_UST12_VON ZF_TCODE_1_VON, B1.ZF_AGR_UST12_BIS ZF_TCODE_1_BIS, 
	B2.ZF_AGR_UST12_VON ZF_TCODE_2_VON, B2.ZF_AGR_UST12_BIS ZF_TCODE_2_BIS, 
	A.USOBT_LOW_1, B1.SOURCE_TABLE
 	FROM B22_44_TT_SOD_MATRIX_WITH_USOBT_TSTCA_VALUE_CONFLICT A
 	...
 	SELECT DISTINCT A.B22C_USR02_BNAME, A.ZF_RISK_ID,
	B1.ZF_AGR_UST12_FIELD, 2 as ZF_TCODE_1_NUMBER, 3 as ZF_TCODE_2_NUMBER, 
	B1.ZF_AGR_UST12_VON ZF_TCODE_1_VON, B1.ZF_AGR_UST12_BIS ZF_TCODE_1_BIS, 
	B2.ZF_AGR_UST12_VON ZF_TCODE_2_VON, B2.ZF_AGR_UST12_BIS ZF_TCODE_2_BIS, 
	A.USOBT_LOW_1, B1.SOURCE_TABLE
 	FROM B22_44_TT_SOD_MATRIX_WITH_USOBT_TSTCA_VALUE_CONFLICT A
 	...
 	SELECT DISTINCT A.B22C_USR02_BNAME, A.ZF_RISK_ID,
	B1.ZF_AGR_UST12_FIELD, 2 as ZF_TCODE_1_NUMBER, 4 as ZF_TCODE_2_NUMBER, 
	B1.ZF_AGR_UST12_VON ZF_TCODE_1_VON, B1.ZF_AGR_UST12_BIS ZF_TCODE_1_BIS, 
	B2.ZF_AGR_UST12_VON ZF_TCODE_2_VON, B2.ZF_AGR_UST12_BIS ZF_TCODE_2_BIS, 
	A.USOBT_LOW_1, B1.SOURCE_TABLE
 	FROM B22_44_TT_SOD_MATRIX_WITH_USOBT_TSTCA_VALUE_CONFLICT A
 	...
 	SELECT DISTINCT A.B22C_USR02_BNAME, A.ZF_RISK_ID,
	B1.ZF_AGR_UST12_FIELD, 3 as ZF_TCODE_1_NUMBER, 4 as ZF_TCODE_2_NUMBER, 
	B1.ZF_AGR_UST12_VON ZF_TCODE_1_VON, B1.ZF_AGR_UST12_BIS ZF_TCODE_1_BIS, 
	B2.ZF_AGR_UST12_VON ZF_TCODE_2_VON, B2.ZF_AGR_UST12_BIS ZF_TCODE_2_BIS, 
	A.USOBT_LOW_1, B1.SOURCE_TABLE
 	FROM B22_44_TT_SOD_MATRIX_WITH_USOBT_TSTCA_VALUE_CONFLICT A
...
-- Step 31: combine the assigned values in each users' TCODE
EXEC SP_DROPTABLE 'B22D_45B_IT_BNAME_AUTH_FULL_MAPPING_USOBT_TSTCA_UNION'
SELECT DISTINCT B22C_USR02_BNAME, ZF_RISK_ID, ZF_AGR_UST12_FIELD, ZF_TCODE_1_NUMBER, ZF_TCODE_1_VON, ZF_TCODE_1_BIS, USOBT_LOW_1, SOURCE_TABLE 
INTO B22D_45B_IT_BNAME_AUTH_FULL_MAPPING_USOBT_TSTCA_UNION
FROM B22D_45_IT_BNAME_AUTH_FULL_MAPPING_USOBT_TSTCA_VALID
UNION
SELECT DISTINCT B22C_USR02_BNAME, ZF_RISK_ID, ZF_AGR_UST12_FIELD, ZF_TCODE_2_NUMBER, ZF_TCODE_2_VON, ZF_TCODE_2_BIS, USOBT_LOW_1, SOURCE_TABLE 
FROM B22D_45_IT_BNAME_AUTH_FULL_MAPPING_USOBT_TSTCA_VALID

-- -- Step 32: gather value conflicts that relate to BUKRS for the summary table
 EXEC SP_DROPTABLE 'B22_46_IT_BNAME_TCODE_VALUE_CONFLICT'
 SELECT DISTINCT B22C_USR02_BNAME, ZF_RISK_ID
 INTO B22_46_IT_BNAME_TCODE_VALUE_CONFLICT
 FROM B22D_45_IT_BNAME_AUTH_FULL_MAPPING_USOBT_TSTCA_VALID
 WHERE USOBT_LOW_1 = '$BUKRS'

 ALTER TABLE B22D_45B_IT_BNAME_AUTH_FULL_MAPPING_USOBT_TSTCA_UNION ALTER COLUMN ZF_RISK_ID NVARCHAR(50)
 CREATE NONCLUSTERED INDEX IDX ON B22D_45B_IT_BNAME_AUTH_FULL_MAPPING_USOBT_TSTCA_UNION(B22C_USR02_BNAME, ZF_RISK_ID)
 ALTER TABLE B22D_45_IT_BNAME_AUTH_FULL_MAPPING_USOBT_TSTCA_VALID ALTER COLUMN ZF_RISK_ID NVARCHAR(50)
 CREATE NONCLUSTERED INDEX IDX ON B22D_45_IT_BNAME_AUTH_FULL_MAPPING_USOBT_TSTCA_VALID(B22C_USR02_BNAME, ZF_RISK_ID)
 ...
 IIF(EXISTS(SELECT * FROM B22_46_IT_BNAME_TCODE_VALUE_CONFLICT B
 				WHERE A.B22C_ZF_RISK_ID = B.ZF_RISK_ID), 1, 0) B22C_VALUE_CONFLICTS,
 dbo.GROUP_CONCAT_D(DISTINCT IIF(ZF_TCODE_1_NUMBER = 1, B1.ZF_TCODE_1_VON, NULL), ', ') B22C_TCODE_1_CONFLICT_VALUE,
 dbo.GROUP_CONCAT_D(DISTINCT IIF(ZF_TCODE_1_NUMBER = 2, B1.ZF_TCODE_1_VON, NULL), ', ') B22C_TCODE_2_CONFLICT_VALUE,
 dbo.GROUP_CONCAT_D(DISTINCT IIF(ZF_TCODE_1_NUMBER = 3, B1.ZF_TCODE_1_VON, NULL), ', ') B22C_TCODE_3_CONFLICT_VALUE,
 dbo.GROUP_CONCAT_D(DISTINCT IIF(ZF_TCODE_1_NUMBER = 4, B1.ZF_TCODE_1_VON, NULL), ', ') B22C_TCODE_4_CONFLICT_VALUE
 INTO B22C_47_IT_SOD_CONFLICT
 FROM B22C_40_IT_SOD_MATRIX A
 LEFT JOIN B22D_45B_IT_BNAME_AUTH_FULL_MAPPING_USOBT_TSTCA_UNION B1 ON A.B22C_USR02_BNAME = B1.B22C_USR02_BNAME AND A.B22C_ZF_RISK_ID = B1.ZF_RISK_ID
 GROUP BY A.B22C_USR02_BNAME, B22C_TCODE_1, B22C_TCODE_2, B22C_TCODE_3, B22C_TCODE_4, B22C_DETAIL_RISK_DESCRIPTION, B22C_BP_PROC, B22C_SUB_BP, B22C_RISK_CLASSIFICATION, B22C_RISK_ID, B22C_FUNC_1, B22C_FUNC_2, B22C_FUNC_3, B22C_FUNC_4, B22C_TSTCT_TTEXT_TCODE1, B22C_TSTCT_TTEXT_TCODE2, B22C_TSTCT_TTEXT_TCODE3, B22C_TSTCT_TTEXT_TCODE4, B22C_ROLE_1, B22C_ROLE_2, B22C_ROLE_3, B22C_ROLE_4, B22C_ZF_RISK_ID
...
SELECT DISTINCT B22C_USR02_BNAME B22F_USR02_BNAME, B22C_TCODE_1 B22F_TCODE, B22C_USR02_BNAME + B22C_TCODE_1 + B22C_TCODE_2 + B22C_TCODE_3 + B22C_TCODE_4 B22F_SOD_KEY, B22C_VALUE_CONFLICTS ZF_TCODE_REQUIRE_BUKRS_FLAG
INTO B22F_49_IT_SOD_USER_ACCESS_KEY_MAP
FROM B22C_47_IT_SOD_CONFLICT
UNION
SELECT DISTINCT B22C_USR02_BNAME, B22C_TCODE_2, B22C_USR02_BNAME + B22C_TCODE_1 + B22C_TCODE_2 + B22C_TCODE_3 + B22C_TCODE_4 B22F_SOD_KEY , B22C_VALUE_CONFLICTS ZF_TCODE_REQUIRE_BUKRS_FLAG
FROM B22C_47_IT_SOD_CONFLICT
UNION
SELECT DISTINCT B22C_USR02_BNAME, B22C_TCODE_3, B22C_USR02_BNAME + B22C_TCODE_1 + B22C_TCODE_2 + B22C_TCODE_3 + B22C_TCODE_4 B22F_SOD_KEY , B22C_VALUE_CONFLICTS ZF_TCODE_REQUIRE_BUKRS_FLAG
FROM B22C_47_IT_SOD_CONFLICT
WHERE ISNULL(B22C_TCODE_3, '') <> ''
UNION
SELECT DISTINCT B22C_USR02_BNAME, B22C_TCODE_4, B22C_USR02_BNAME + B22C_TCODE_1 + B22C_TCODE_2 + B22C_TCODE_3 + B22C_TCODE_4 B22F_SOD_KEY , B22C_VALUE_CONFLICTS ZF_TCODE_REQUIRE_BUKRS_FLAG
FROM B22C_47_IT_SOD_CONFLICT
