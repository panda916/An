...
SELECT A.B10_EKKO_EBELN,
	...
	MAX(AM_EXCHNG.EXCHNG_RATIO) AS EXCH_RATE_DMBTR_OLD,
	...
	MAX(AM_EXCHNG.EXCHNG_RATIO) AS EXCH_RATE_AREWR_OLD,
	...
	MAX(AM_EXCHNG_DOC.EXCHNG_RATIO) AS EXCH_RATE_WBRTR_OLD,
