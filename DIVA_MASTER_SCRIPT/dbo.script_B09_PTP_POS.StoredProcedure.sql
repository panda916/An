...
/* 
	...
	09-08-2024		HL		Add fields and joins according to SAP USAGE script
	27-08-2024		Tan		Add fields for SAP USAGE
*/
...
--Fields are being calculated as mentioned in SELECT clause below*/
   ...
   EXEC SP_DROPTABLE 'B09_09_IT_PO_HIST_TOTALS'
	SELECT  
		A_EKBE.EKBE_MANDT,
		A_EKBE.EKBE_EBELN,
		A_EKBE.EKBE_EBELP,
		...
		MAX(IIF(EKBE_VGABE IN ('1'), T001_WAERS, NULL)) ZF_GR_T001_WAERS, -- Tan: Added from SAP USAGE Script
...
------check with Thuan whether below should be commented 
 ...
 --   WHERE TCURF_KURST = 'M' AND TCURF_GDATU < 90000000
   ...
   EXEC SP_DROPTABLE 'B09_13_IT_PTP_POS'
	...
	SELECT
		A_EKKO.EKKO_MANDT,
		A_EKPO.EKPO_MEINS, -- Hanh Lam: Added from SAP USAGE
		A_EKPO.EKPO_BUKRS,
		A_EKKO.EKKO_BSART,
