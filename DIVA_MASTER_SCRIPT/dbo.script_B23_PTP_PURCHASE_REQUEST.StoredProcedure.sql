...
-- Description:	Create the purchase request cube
-- =============================================
CREATE     PROCEDURE [dbo].[script_B23_PTP_PURCHASE_REQUEST]
...
EXEC SP_DROPTABLE B23_01_IT_PURCHASE_REQUEST
SELECT DISTINCT
	A_EBAN.*,
	T161T_BATXT,
	T163Y_PSTYP ,
...
INTO B23_01_IT_PURCHASE_REQUEST
FROM A_EBAN
...
LEFT JOIN A_T001W ON EBAN_WERKS=T001W_WERKS
...
EXEC SP_RENAME_FIELD 'B23_','B23_01_IT_PURCHASE_REQUEST'
