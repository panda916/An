...
WHERE B28_VBAK_VBTYP='C' AND EXISTS
(
	SELECT TOP 1 1 FROM BO05_01_IT_TVAK_SALE_DOCUMENT_TYPE
	WHERE B28_VBAK_AUART=TVAK_AUART
	AND LEN(TVAK_KLIMP) = 0
)


-- Rename the fields
EXEC SP_UNNAME_FIELD 'B28_', 'SU28_04_RT_TVAK_CUS_CRE_LIMIT'
EXEC SP_RENAME_FIELD 'SU28_04_', 'SU28_04_RT_TVAK_CUS_CRE_LIMIT'

EXEC SP_UNNAME_FIELD 'B28_', 'SU28_05_XT_SALE_ORDER_NO_CRE_LIMIT'
