...
IIF(REGUP_BUKRS IS NOT NULL OR LEN(TRIM(REGUP_BUKRS))>0, 'X','') AS ZF_ACDOCA_IN_REGUP_FLAG
INTO SU32_02_XT_PTP_PAY_1TV
FROM B11_08_IT_PTP_PAY
INNER JOIN BP01_01_IT_SUPP 
ON B11E_ACDOCA_LIFNR=BP01_01_LFA1_LIFNR
LEFT JOIN A_REGUP
ON B11E_ACDOCA_RBUKRS=REGUP_BUKRS AND	B11E_ACDOCA_GJAHR=REGUP_GJAHR AND B11E_ACDOCA_BELNR=REGUP_BELNR AND B11E_ACDOCA_BUZEI=REGUP_BUZEI
WHERE BP01_01_LFA1_XCPDK='X'
