...
GO
CREATE  PROCEDURE [dbo].[SP_REPLACE_NAME_FIELD](@OLDPREFIX AS NVARCHAR(MAX),@NEWPREFIX AS NVARCHAR(MAX), @TABLE_NAME AS VARCHAR(MAX))
as
...
OPEN FIELDLIST_CURSOR
	...
	BEGIN
		...
		PRINT 'Old Namw: '+@ZV_OLD_NAME
		SET @ZV_NEW_NAME = REPLACE(@ZV_FIELD_NAME, @OLDPREFIX, @NEWPREFIX)
		PRINT 'New Name: ' +@ZV_NEW_NAME
