...
GO
CREATE     PROCEDURE [dbo].[script_PM02_OTC_PROCESS_MINING_BK]
AS
...
--UNION
--SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,
--		B14_02_ZF_CUSTOMER_INVOICE_CANCELLATION_KEY AS ZF_DOCUMENT_NUMBER,
...
--		'11_Invoice_cancellation' AS ZF_CONCECPT_NAME_WITH_NUM,
--		'Invoice cancellation' AS ZF_CONCECPT_NAME,
