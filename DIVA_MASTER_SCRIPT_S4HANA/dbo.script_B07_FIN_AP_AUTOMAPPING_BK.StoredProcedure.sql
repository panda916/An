...
CREATE      PROC [dbo].[script_B07_FIN_AP_AUTOMAPPING_BK]
...
SELECT DB_NAME(),OBJECT_NAME(@@PROCID),'P',SYSTEM_USER,CONVERT(DATE,GETDATE()),CONVERT(TIME,GETDATE()),'Procedure started',NULL,NULL
  ...
  */
	  ...
	  */
	  ...
	  SELECT DISTINCT
		  B04_11_IT_AP_ACC_SCH.BKPF_TCODE,
		  B04_11_IT_AP_ACC_SCH.ACDOCA_AWTYP,
		  B04_11_IT_AP_ACC_SCH.LFA1_KTOKK,
		  B04_11_IT_AP_ACC_SCH.ACDOCA_XANET,
--		  B04_11_IT_AP_ACC_SCH.ACDOCA_LIFNR,
--		  B04_11_IT_AP_ACC_SCH.ACDOCA_DRCRK,
		  B04_11_IT_AP_ACC_SCH.ZF_DEBIT_ACCOUNT_TYPES,
		  B04_11_IT_AP_ACC_SCH.ZF_CREDIT_ACCOUNT_TYPES,
		  B04_11_IT_AP_ACC_SCH.ZF_DEBIT_T012K_FEBKO_SKB1_HBKID_XGKON_FLAG_LIST,
		  B04_11_IT_AP_ACC_SCH.ZF_CREDIT_T012K_FEBKO_SKB1_HBKID_XGKON_FLAG_LIST,
		  B04_11_IT_AP_ACC_SCH.ZF_DEBIT_SKA1_GVTYP_FLAG_LIST,
		  B04_11_IT_AP_ACC_SCH.ZF_CREDIT_SKA1_GVTYP_FLAG_LIST,
		  B04_11_IT_AP_ACC_SCH.ZF_DOC_CLEARING_FLAG,
		  B04_11_IT_AP_ACC_SCH.ZF_REGUH_PAYMENT_FLAG,
		  B04_11_IT_AP_ACC_SCH.ZF_REGUP_INVOICE_FLAG,
		  B04_11_IT_AP_ACC_SCH.ZF_LIFNR_KUNNR_IS_SAME_FLAG,
	  ...
	  */
	  ...
	  /*
		Step 3: Update the AP document type base on ACL logic from Claire
	  */
		 /*
				Step 3.2: Flag all documents have
							Debit on account type 'K'
							Credit on (SKA1_GVTYP_BSEG<> "" OR  BSEG_KOART = S) AND NOT(ZF_BSEG_HKONT_PAYFLAG) AND ACDOCA _XANET ="" 
							BELNR = AUGBL
							AWTYP <> 'RMRP'
						 to "Others" bucket 
		  */
	  ...
	  */
		...
		ON 
		 ISNULL(B04_11_IT_AP_ACC_SCH.BKPF_TCODE, '') = ISNULL(B07_01_TT_FIN_AP_INV_PAY_FLAGS.BKPF_TCODE, '') AND
		 ISNULL(B04_11_IT_AP_ACC_SCH.ACDOCA_AWTYP, '') = ISNULL(B07_01_TT_FIN_AP_INV_PAY_FLAGS.ACDOCA_AWTYP, '') AND
		 ISNULL(B04_11_IT_AP_ACC_SCH.LFA1_KTOKK, '') = ISNULL(B07_01_TT_FIN_AP_INV_PAY_FLAGS.LFA1_KTOKK, '') AND
		 ISNULL(B04_11_IT_AP_ACC_SCH.ACDOCA_XANET, '') = ISNULL(B07_01_TT_FIN_AP_INV_PAY_FLAGS.ACDOCA_XANET, '') AND
--		 ISNULL(B04_11_IT_AP_ACC_SCH.ACDOCA_DRCRK, '') = ISNULL(B07_01_TT_FIN_AP_INV_PAY_FLAGS.ACDOCA_DRCRK, '') AND
--		 ISNULL(B04_11_IT_AP_ACC_SCH.ACDOCA_LIFNR, '') = ISNULL(B07_01_TT_FIN_AP_INV_PAY_FLAGS.ACDOCA_LIFNR, '') AND
		 ISNULL(B04_11_IT_AP_ACC_SCH.ZF_DEBIT_ACCOUNT_TYPES, '') = ISNULL(B07_01_TT_FIN_AP_INV_PAY_FLAGS.ZF_DEBIT_ACCOUNT_TYPES, '') AND
		 ISNULL(B04_11_IT_AP_ACC_SCH.ZF_CREDIT_ACCOUNT_TYPES, '') = ISNULL(B07_01_TT_FIN_AP_INV_PAY_FLAGS.ZF_CREDIT_ACCOUNT_TYPES, '') AND
		 ISNULL(B04_11_IT_AP_ACC_SCH.ZF_DEBIT_T012K_FEBKO_SKB1_HBKID_XGKON_FLAG_LIST, '') = ISNULL(B07_01_TT_FIN_AP_INV_PAY_FLAGS.ZF_DEBIT_T012K_FEBKO_SKB1_HBKID_XGKON_FLAG_LIST , '')AND 
		 ISNULL(B04_11_IT_AP_ACC_SCH.ZF_CREDIT_T012K_FEBKO_SKB1_HBKID_XGKON_FLAG_LIST, '') = ISNULL(B07_01_TT_FIN_AP_INV_PAY_FLAGS.ZF_CREDIT_T012K_FEBKO_SKB1_HBKID_XGKON_FLAG_LIST, '') AND
		 ISNULL(B04_11_IT_AP_ACC_SCH.ZF_DEBIT_SKA1_GVTYP_FLAG_LIST, '') = ISNULL(B07_01_TT_FIN_AP_INV_PAY_FLAGS.ZF_DEBIT_SKA1_GVTYP_FLAG_LIST, '') AND
		 ISNULL(B04_11_IT_AP_ACC_SCH.ZF_CREDIT_SKA1_GVTYP_FLAG_LIST, '') = ISNULL(B07_01_TT_FIN_AP_INV_PAY_FLAGS.ZF_CREDIT_SKA1_GVTYP_FLAG_LIST, '') AND
		 ISNULL(B04_11_IT_AP_ACC_SCH.ZF_DOC_CLEARING_FLAG, '') = ISNULL(B07_01_TT_FIN_AP_INV_PAY_FLAGS.ZF_DOC_CLEARING_FLAG, '') AND
		 ISNULL(B04_11_IT_AP_ACC_SCH.ZF_REGUH_PAYMENT_FLAG, '') = ISNULL(B07_01_TT_FIN_AP_INV_PAY_FLAGS.ZF_REGUH_PAYMENT_FLAG, '') AND 
		 ISNULL(B04_11_IT_AP_ACC_SCH.ZF_REGUP_INVOICE_FLAG, '') = ISNULL(B07_01_TT_FIN_AP_INV_PAY_FLAGS.ZF_REGUP_INVOICE_FLAG, '') AND 
		 ISNULL(B04_11_IT_AP_ACC_SCH.ZF_LIFNR_KUNNR_IS_SAME_FLAG, '') = ISNULL(B07_01_TT_FIN_AP_INV_PAY_FLAGS.ZF_LIFNR_KUNNR_IS_SAME_FLAG, '') 
