...
BEGIN
    ...
    */
		...
		SET B20_23_ZF_CUSTOMER_ORDER_DELIVERY_AND_MATERIAL_RISK_FLAG = 'Yes',
			B20_23_ZF_KNA1_ERNAM_SAME_VBAK_VBAP_ERNAM_SAME_LIKP_LIPS_SAME_MATDOC_USNAM_FLAG = 'Yes',
            B20_23_ZF_CUSTOMER_ORDER_DELIVERY_AND_MATERIAL_RISK_USER = B20_20_KNA1_ERNAM
		WHERE B20_22_ZF_KNA1_ERNAM_SAME_VBAK_VBAP_ERNAM_SAME_LIKP_LIPS_ERNAM_FLAG = 'Yes' AND B20_20_MATDOC_USNAM = B20_20_KNA1_ERNAM AND B20_20_KNA1_ERNAM <> ''
    ...
    */
        UPDATE B20_20_CENTER_FACT_TABLE
		SET B20_23_ZF_CUSTOMER_ORDER_DELIVERY_AND_MATERIAL_RISK_FLAG = 'Yes',
			B20_23_ZF_KNA1_ERNAM_SAME_VBAK_VBAP_ERNAM_SAME_MATDOC_USNAM_FLAG = 'Yes',
            B20_23_ZF_CUSTOMER_ORDER_AND_MATERIAL_RISK_USER = B20_20_KNA1_ERNAM
		WHERE B20_21_ZF_KNA1_ERNAM_SAME_VBAK_VBAP_ERNAM_FLAG = 'Yes' AND B20_20_MATDOC_USNAM = B20_20_KNA1_ERNAM AND B20_20_MATDOC_USNAM <> ''
    ...
    */
        UPDATE B20_20_CENTER_FACT_TABLE
		SET B20_23_ZF_CUSTOMER_ORDER_DELIVERY_AND_MATERIAL_RISK_FLAG = 'Yes',
			B20_23_ZF_VBAK_VBAP_ERNAM_SAME_LIKP_LIPS_SAME_MATDOC_USNAM_FLAG = 'Yes',
		...
		AND B20_20_MATDOC_USNAM = B20_22_ZF_ORDER_AND_DELIVERY_RISK_USER AND B20_20_MATDOC_USNAM <> ''
    ...
    */
		UPDATE B20_20_CENTER_FACT_TABLE
		SET B20_23_ZF_CUSTOMER_ORDER_DELIVERY_AND_MATERIAL_RISK_FLAG = 'Yes',
			B20_23_ZF_VBAK_VBAP_ERNAM_SAME_MATDOC_USNAM_FLAG = 'Yes',
            B20_23_ZF_ORDER_AND_MATERIAL_RISK_USER = B20_20_MATDOC_USNAM
		WHERE (
                B20_20_VBAK_ERNAM = B20_20_MATDOC_USNAM OR
                B20_20_VBAP_ERNAM = B20_20_MATDOC_USNAM
			   ) AND B20_20_MATDOC_USNAM <> ''
    ...
    */
		...
		SET B20_24_ZF_CUSTOMER_ORDER_DELIVERY_MATERIAL_AND_INVOICE_RISK_FLAG = 'Yes',
			B20_24_ZF_KNA1_ERNAM_SAME_VBAK_VBAP_ERNAM_SAME_MATDOC_USNAM_SAME_VBRK_VBRP_ERNAM_FLAG = 'Yes',
    ...
    */  
        UPDATE B20_20_CENTER_FACT_TABLE
		SET B20_24_ZF_CUSTOMER_ORDER_DELIVERY_MATERIAL_AND_INVOICE_RISK_FLAG = 'Yes',
			B20_24_ZF_VBAK_VBAP_ERNAM_SAME_MATDOC_USNAM_SAME_VBRK_VBRP_ERNAM_FLAG = 'Yes',
            B20_24_ZF_ORDER_MATERIAL_AND_INVOICE_RISK_USER = B20_20_MATDOC_USNAM
		WHERE (
            B20_20_VBAK_ERNAM = B20_20_MATDOC_USNAM OR
            B20_20_VBAP_ERNAM = B20_20_MATDOC_USNAM
        ) AND (
            B20_20_VBRK_ERNAM = B20_20_MATDOC_USNAM OR
            B20_20_VBRP_ERNAM = B20_20_MATDOC_USNAM
        ) AND B20_20_MATDOC_USNAM <> ''
    ...
    */ 
        UPDATE B20_20_CENTER_FACT_TABLE
		SET B20_24_ZF_CUSTOMER_ORDER_DELIVERY_MATERIAL_AND_INVOICE_RISK_FLAG = 'Yes',
			B20_24_ZF_VBAK_VBAP_ERNAM_SAME_LIKP_LIPS_ERNAM_SAME_MATDOC_USNAM_SAME_VBRK_VBRP_ERNAM_FLAG = 'Yes',
            B20_24_ZF_ORDER_DELIVERY_MATERIAL_AND_INVOICE_RISK_USER = B20_20_MATDOC_USNAM
		WHERE (
            B20_20_VBAK_ERNAM = B20_20_MATDOC_USNAM OR
            B20_20_VBAP_ERNAM = B20_20_MATDOC_USNAM
        )AND (
            B20_20_LIKP_ERNAM = B20_20_MATDOC_USNAM OR
            B20_20_LIPS_ERNAM = B20_20_MATDOC_USNAM
        ) AND (
            B20_20_VBRK_ERNAM = B20_20_MATDOC_USNAM OR
            B20_20_VBRP_ERNAM = B20_20_MATDOC_USNAM
        ) AND B20_20_MATDOC_USNAM <> ''
    ...
    */ 
        UPDATE B20_20_CENTER_FACT_TABLE
		SET B20_24_ZF_CUSTOMER_ORDER_DELIVERY_MATERIAL_AND_INVOICE_RISK_FLAG = 'Yes',
			B20_24_ZF_KNA1_ERNAM_SAME_VBAK_VBAP_ERNAM_SAME_LIKP_LIPS_ERNAM_SAME_MATDOC_USNAM_SAME_VBRK_VBRP_ERNAM_FLAG = 'Yes',
            B20_24_ZF_CUSTOMER_ORDER_DELIVERY_MATERIAL_AND_INVOICE_RISK_USER = B20_20_MATDOC_USNAM
		WHERE (
            B20_20_VBAK_ERNAM = B20_20_MATDOC_USNAM OR
            B20_20_VBAP_ERNAM = B20_20_MATDOC_USNAM
        )AND (
            ...
            B20_20_VBRK_ERNAM = B20_20_MATDOC_USNAM OR
            B20_20_VBRP_ERNAM = B20_20_MATDOC_USNAM
        ) AND B20_20_MATDOC_USNAM = B20_20_KNA1_ERNAM AND B20_20_MATDOC_USNAM <> ''
    ...
    */
		...
		WHERE B20_20_INV_KNA1_ERNAM <> ''
              AND B20_20_INV_KNA1_ERNAM = B20_20_INV_ACDOCA_USNAM
              AND B20_20_INV_KNA1_ERNAM = B20_20_PAYMENT_ACDOCA_USNAM
              --AND EXISTS (
    ...
    */
		...
		SET B20_25_ZF_CUSTOMER_FI_INVOICE_AND_FI_PAYMENT_RISK_FLAG = 'Yes',
            ...
            B20_25_ZF_FI_INVOICE_AND_FI_PAYMENT_RISK_USER = B20_20_INV_ACDOCA_USNAM
		WHERE B20_20_INV_ACDOCA_USNAM <> ''
              AND B20_20_INV_ACDOCA_USNAM = B20_20_PAYMENT_ACDOCA_USNAM
              --AND EXISTS (
              --    SELECT TOP 1 1 FROM B20_10_IT_OTC_CLEARING_DOC_TYP_BUCKET
              --    WHERE B20_20_CENTER_FACT_TABLE.B20_11_ZF_CLEARING_INVOICE_DOC_KEY =  B20_10_IT_OTC_CLEARING_DOC_TYP_BUCKET.B20_10_ZF_CLEARING_INVOICE_DOC_KEY
              --    AND B20_10_IT_OTC_CLEARING_DOC_TYP_BUCKET.B20_10_ZF_AR_DOC_TYPE_BUCKET LIKE '%payment%'
