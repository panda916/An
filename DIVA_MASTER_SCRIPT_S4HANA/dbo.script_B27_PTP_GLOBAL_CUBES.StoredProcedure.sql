...
B26_02_MKPF_CPUDT AS MKPF_CPUDT,--Good receipt date
B26_02_MKPF_CPUTM AS MKPF_CPUTM,
...
B26_02_MSEG_WAERS AS SEG_WAERS,
...
CONCAT( DBO.TRIM(B.B04_GL_ACDOCA_RBUKRS),'-',
		...
		DBO.TRIM(B.B04_GL_ACDOCA_BUZEI)
		) AS ZF_ACDOCA_BUKRS_GJAHR_BELNR_BUZEI,--Invoice key
...
C.B11B_SS02_T001_WAERS AS T001_WAERS_PAY
-- Join PR_PO_GR_INV with Payment table,base on AUGBL and AUGDT
