...
/* 
	...
	05-08-2019	   VL		 Update for S4 HANA logic
...
*/
      ...
      SELECT ACDOCA_RCLNT, ACDOCA_RBUKRS, ACDOCA_KUNNR FROM B00_ACDOCA WHERE (ACDOCA_BUDAT >= @date1) AND ACDOCA_KOART = 'D'
...
--step 6: create final Simple cube
      ...
      SELECT B13_00_TT_KNA1_KNB1.KNB1_MANDT --							AS [Mandant] 
	  ...
	  LEFT JOIN B00_T077X 
      ON (B13_00_TT_KNA1_KNB1.KNA1_KTOKD = B00_T077X.T077X_KTOKD) 
