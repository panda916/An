...
SELECT  ZF_DOCUMENT_FLOW_KEY AS ZF_DOCUMENT_FLOW_KEY,
		...
		EBAN_T161T_BATXT AS ZF_DOCUMENT_TYPE,'' AS ZF_COMPANY_CURRENCY
...
UPDATE PM_11_RT_PROCESS_MINING
SET ZF_PO_HAS_PRICE_CHANGE=''

UPDATE PM_11_RT_PROCESS_MINING
SET ZF_PO_HAS_PRICE_CHANGE='X'
WHERE ZF_PATH_DESC LIKE '%6_PO_PRICE_CHANGE%' AND ZF_PATH_DESC LIKE '%2_PURCHASE_ORDER%'
