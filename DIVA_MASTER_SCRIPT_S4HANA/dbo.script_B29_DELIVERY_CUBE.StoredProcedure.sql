...
GO
CREATE   PROCEDURE [dbo].[script_B29_DELIVERY_CUBE]
AS
...
*/
   ...
   DECLARE   
	...
	EXEC SP_REMOVE_TABLES 'B29_01_IT_DELIVERY_DOCS'
	SELECT 
		   LIKP_MANDT, -- Client
		   ...
		   B00_TVKO.TVKO_BUKRS,T001_WAERS,
		   ...
		   -- HL: Added from SAP USAGE
		   A_KNA1_KUNNR.KNA1_NAME1 AS ZF_KNA1_NAME1_SHIP_TO,
		   A_KNA1_KUNAG.KNA1_NAME1 AS ZF_KNA1_NAME1_SOLD_TO,
...
-- Add exchange rate from company currency to USD
	...
	-- HL Added from SAP USAGE: Get sales order is required as basis for delivery description
		LEFT JOIN A_TVLK
		ON LIKP_LFART = TVLK_LFART
	-- HL added from SAP USAGE: Get material description
	LEFT JOIN BC12_01_IT_MARA_VS_MAKT_ADD_MAKT_MAKTX
	ON LIPS_MATNR = MARA_MATNR

	EXEC SP_RENAME_FIELD 'B29_',B29_01_IT_DELIVERY_DOCS
