...
CREATE  PROCEDURE [dbo].[script_DC08_BANK_CHANGE]
...
EXEC SP_DROPTABLE 'DC08_01_IT_BANK_CHANGE'
SELECT       A.B19H_REGUP_LAUFI,
			 ...
			 MAX(ISNULL(EXCHNG_RATIO,1)) AS ZF_OLD_EXCHNG_RATE,
			 MAX(COALESCE(CAST(TCURR_CUC.TCURR_UKURS AS FLOAT),1) * COALESCE(TCURF_CUC.TCURF_TFACT,1) / COALESCE(TCURF_CUC.TCURF_FFACT,1)) AS ZF_NEW_EXCHNG_RATE
INTO DC08_01_IT_BANK_CHANGE
FROM (SELECT 
             B19H_REGUP_LAUFI,
			 B19H_REGUP_ZBUKR,
			 B19H_REGUP_KUNNR,
...
EXEC SP_UNNAME_FIELD 'B19H_',DC08_01_IT_BANK_CHANGE;
EXEC SP_RENAME_FIELD 'DC08_01_',DC08_01_IT_BANK_CHANGE;
GO
