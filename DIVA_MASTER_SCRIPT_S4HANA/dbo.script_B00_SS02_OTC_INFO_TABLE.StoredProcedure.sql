...
GO
CREATE PROCEDURE [dbo].[script_B00_SS02_OTC_INFO_TABLE]
AS
...
--DYNAMIC_SCRIPT_START
	...
	SELECT TVKO_VKORG,TVKO_BUKRS,BUKRS_MAPPING AS TVKO_BUKRS_MAPPING
	INTO B00_TVKO
	FROM A_TVKO
	 JOIN AM_COMPANY_CODE ON TVKO_BUKRS=COMPANY_CODE
GO
