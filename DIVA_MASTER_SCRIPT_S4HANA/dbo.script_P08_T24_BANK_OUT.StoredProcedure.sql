...
EXEC SP_CREATE_INDEX 'P08_T24_00_TT_AM_BANK_ACC', 'P08_T24_00_TT_AM_BANK_ACC_IDX', 'GL_BANK_ACC_HKONT, GL_BANK_ACC_BUKRS'
...
EXEC SP_DROPTABLE 'P08_T24_01_TT_BELNR_BO_D_EQ_C'
 SELECT B04_GL_ACDOCA_RBUKRS, B04_GL_ACDOCA_GJAHR, B04_GL_ACDOCA_BELNR
 INTO P08_T24_01_TT_BELNR_BO_D_EQ_C
 FROM B04_08_IT_FIN_GL
 INNER JOIN P08_T24_00_TT_AM_BANK_ACC
       ON  B04_08_IT_FIN_GL.B04_GL_ACDOCA_RACCT = P08_T24_00_TT_AM_BANK_ACC.GL_BANK_ACC_HKONT
              AND B04_08_IT_FIN_GL.B04_GL_ACDOCA_RBUKRS = P08_T24_00_TT_AM_BANK_ACC.GL_BANK_ACC_BUKRS
 GROUP BY B04_GL_ACDOCA_RBUKRS, B04_GL_ACDOCA_GJAHR, B04_GL_ACDOCA_BELNR
 HAVING SUM(B04_GL_ZF_ACDOCA_HSL_S) = 0
...
EXEC SP_DROPTABLE 'P08_T24_02_TT_AUGBL_BO_D_EQ_C'
 SELECT B04_GL_ACDOCA_RBUKRS, B04_GL_ACDOCA_AUGBL, B04_GL_ACDOCA_AUGDT
 INTO P08_T24_02_TT_AUGBL_BO_D_EQ_C
 FROM B04_08_IT_FIN_GL
 INNER JOIN P08_T24_00_TT_AM_BANK_ACC
       ON  B04_08_IT_FIN_GL.B04_GL_ACDOCA_RACCT = P08_T24_00_TT_AM_BANK_ACC.GL_BANK_ACC_HKONT
              AND B04_08_IT_FIN_GL.B04_GL_ACDOCA_RBUKRS = P08_T24_00_TT_AM_BANK_ACC.GL_BANK_ACC_BUKRS
 GROUP BY B04_GL_ACDOCA_RBUKRS, B04_GL_ACDOCA_AUGBL, B04_GL_ACDOCA_AUGDT
 HAVING SUM(B04_GL_ZF_ACDOCA_HSL_S) = 0

CREATE INDEX BUKRS ON P08_T24_02_TT_AUGBL_BO_D_EQ_C(B04_GL_ACDOCA_RBUKRS)
CREATE INDEX AUGBL ON P08_T24_02_TT_AUGBL_BO_D_EQ_C(B04_GL_ACDOCA_AUGBL)
CREATE INDEX AUGDT ON P08_T24_02_TT_AUGBL_BO_D_EQ_C(B04_GL_ACDOCA_AUGDT)

EXEC SP_CREATE_INDEX 'B02_04_IT_FIN_COA', 'FIN_COA_IDX', 'B02_T001_BUKRS, B02_SKB1_SAKNR'
...
SELECT 
		...
		B04_08_IT_FIN_GL.B04_GL_BKPF_BUDAT,
		...
		B04_08_IT_FIN_GL.B04_GL_ACDOCA_KUNNR,
		B04_08_IT_FIN_GL.B04_GL_ACDOCA_RBUKRS + ' - ' +  A_T001.T001_BUTXT AS B04_ZF_BKPF_BUKRS_BUTXT,
		B04_08_IT_FIN_GL.B04_GL_BKPF_WAERS,
		B04_08_IT_FIN_GL.B04_GL_ZF_ACDOCA_HSL_S,
		B04_08_IT_FIN_GL.B04_GL_AM_GLOBALS_CURRENCY,
		B04_08_IT_FIN_GL.B04_GL_ZF_ACDOCA_HSL_S_CUC,
		B04_08_IT_FIN_GL.B04_GL_ZF_ACDOCA_KSL_S,
		B04_08_IT_FIN_GL.B04_GL_ZF_ACDOCA_OSL_S
INTO P08_T24_03_TT_FIN_GL_NO_BTB 
FROM B04_08_IT_FIN_GL
LEFT JOIN P08_T24_02_TT_AUGBL_BO_D_EQ_C ON 
	 P08_T24_02_TT_AUGBL_BO_D_EQ_C.B04_GL_ACDOCA_AUGDT = B04_08_IT_FIN_GL.B04_GL_ACDOCA_AUGDT 
	 AND P08_T24_02_TT_AUGBL_BO_D_EQ_C.B04_GL_ACDOCA_AUGBL = B04_08_IT_FIN_GL.B04_GL_ACDOCA_AUGBL
	 AND P08_T24_02_TT_AUGBL_BO_D_EQ_C.B04_GL_ACDOCA_RBUKRS = B04_08_IT_FIN_GL.B04_GL_ACDOCA_RBUKRS
LEFT JOIN B02_04_IT_FIN_COA
              ON     B04_08_IT_FIN_GL.B04_GL_ACDOCA_RBUKRS = B02_04_IT_FIN_COA.B02_T001_BUKRS AND
                     B04_08_IT_FIN_GL.B04_GL_ACDOCA_RACCT = B02_04_IT_FIN_COA.B02_SKB1_SAKNR
LEFT JOIN A_T001
	ON A_T001.T001_BUKRS = B04_08_IT_FIN_GL.B04_GL_ACDOCA_RBUKRS
WHERE P08_T24_02_TT_AUGBL_BO_D_EQ_C.B04_GL_ACDOCA_AUGBL IS NULL
...
DELETE P08_T24_03_TT_FIN_GL_NO_BTB
	WHERE EXISTS(SELECT TOP 1 1 FROM P08_T24_01_TT_BELNR_BO_D_EQ_C WHERE 
		 P08_T24_01_TT_BELNR_BO_D_EQ_C.B04_GL_ACDOCA_GJAHR = P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_GJAHR 
		 AND P08_T24_01_TT_BELNR_BO_D_EQ_C.B04_GL_ACDOCA_RBUKRS = P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_RBUKRS
		 AND P08_T24_01_TT_BELNR_BO_D_EQ_C.B04_GL_ACDOCA_BELNR = P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_BELNR)

-- Create index to resolve performance issues
CREATE INDEX AUGBL
ON P08_T24_03_TT_FIN_GL_NO_BTB (B04_GL_ACDOCA_AUGBL);
CREATE INDEX BUKRS
ON P08_T24_03_TT_FIN_GL_NO_BTB (B04_GL_ACDOCA_RBUKRS);
CREATE INDEX GJAHR
ON P08_T24_03_TT_FIN_GL_NO_BTB (B04_GL_ACDOCA_GJAHR);
CREATE INDEX BELNR
ON P08_T24_03_TT_FIN_GL_NO_BTB (B04_GL_ACDOCA_BELNR);
CREATE INDEX AUGDT
ON P08_T24_03_TT_FIN_GL_NO_BTB (B04_GL_ACDOCA_AUGDT);
...
SELECT DISTINCT P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_RBUKRS,
              P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_GJAHR,
              P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_BELNR,
              P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_AUGBL,
             P08_T24_03_TT_FIN_GL_NO_BTB. B04_GL_ACDOCA_AUGDT
INTO P08_T24_04_TT_LIST_BELNR_AUGBL
FROM P08_T24_03_TT_FIN_GL_NO_BTB
WHERE ISNULL(P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_AUGBL, '') <> ''

CREATE INDEX AUGBL ON P08_T24_04_TT_LIST_BELNR_AUGBL (B04_GL_ACDOCA_AUGBL);
CREATE INDEX BUKRS ON P08_T24_04_TT_LIST_BELNR_AUGBL (B04_GL_ACDOCA_RBUKRS);
CREATE INDEX GJAHR ON P08_T24_04_TT_LIST_BELNR_AUGBL (B04_GL_ACDOCA_GJAHR);
CREATE INDEX BELNR ON P08_T24_04_TT_LIST_BELNR_AUGBL (B04_GL_ACDOCA_BELNR);
CREATE INDEX AUGDT ON P08_T24_04_TT_LIST_BELNR_AUGBL (B04_GL_ACDOCA_AUGDT);
...
SELECT DISTINCT 
              P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_RBUKRS, 
              P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_GJAHR, 
              P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_BELNR,
...
INNER JOIN AM_SPEND_CATEGORY
       ON  P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_RACCT = AM_SPEND_CATEGORY.SPCAT_GL_ACCNT
...
EXEC SP_CREATE_INDEX 'P08_T24_05_TT_PAYROLL_BELNR_DOC_TYPE', 'P08_T24_05_TT_PAYROLL_BELNR_DOC_TYPE_IDX', 'B04_GL_ACDOCA_RBUKRS, B04_GL_ACDOCA_GJAHR, B04_GL_ACDOCA_BELNR'
...
EXEC SP_CREATE_INDEX 'P08_T24_06_TT_SUPP_BELNR_DOC_TYPE', 'P08_T24_06_TT_SUPP_BELNR_DOC_TYPE_IDX', 'B07B_ACDOCA_RBUKRS, B07B_ACDOCA_GJAHR, B07B_ACDOCA_BELNR, B07B_ACDOCA_BUZEI'
...
SELECT DISTINCT B07D_ACDOCA_RBUKRS,
                B07D_ACDOCA_GJAHR,
                B07D_ACDOCA_BELNR,
...
EXEC SP_CREATE_INDEX 'P08_T24_07_TT_CUST_BELNR_DOC_TYPE', 'P08_T24_07_TT_CUST_BELNR_DOC_TYPE_IDX', 'B07D_ACDOCA_RBUKRS, B07D_ACDOCA_GJAHR, B07D_ACDOCA_BELNR, B07D_ACDOCA_BUZEI'
...
SELECT DISTINCT 
	...
	P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_BELNR,
	CASE
		WHEN ISNULL(P08_T24_04_TT_LIST_BELNR_AUGBL.B04_GL_ACDOCA_AUGBL, '') <> '' THEN 'Bank out matched'
...
INNER JOIN P08_T24_00_TT_AM_BANK_ACC
       ON  P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_RACCT = P08_T24_00_TT_AM_BANK_ACC.GL_BANK_ACC_HKONT
              AND P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_RBUKRS = P08_T24_00_TT_AM_BANK_ACC.GL_BANK_ACC_BUKRS
			   
-- Check if there is a matching key - to know if it is matched or unmatched bank out 
LEFT JOIN P08_T24_04_TT_LIST_BELNR_AUGBL
       ON P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_RBUKRS = P08_T24_04_TT_LIST_BELNR_AUGBL.B04_GL_ACDOCA_RBUKRS
       AND P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_GJAHR = P08_T24_04_TT_LIST_BELNR_AUGBL.B04_GL_ACDOCA_GJAHR
       AND P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_BELNR = P08_T24_04_TT_LIST_BELNR_AUGBL.B04_GL_ACDOCA_BELNR
-- Filter on bank out lines, based on credit indicator
WHERE P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_DRCRK = 'H'

EXEC SP_CREATE_INDEX 'P08_T24_08_TT_BO_BELNR_DOC_TYPE', 'P08_T24_08_TT_BO_BELNR_DOC_TYPE_IDX', 'B04_GL_ACDOCA_RBUKRS, B04_GL_ACDOCA_GJAHR, B04_GL_ACDOCA_BELNR'
...
SELECT DISTINCT 
              ...
              IIF(ISNULL(P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_AUGBL, '') <> '', P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_AUGBL, P08_T24_04_TT_LIST_BELNR_AUGBL.B04_GL_ACDOCA_AUGBL) B04_GL_ACDOCA_AUGBL,
              IIF(ISNULL(P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_AUGDT,'') <> '', P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_AUGDT, P08_T24_04_TT_LIST_BELNR_AUGBL.B04_GL_ACDOCA_AUGDT) B04_GL_ACDOCA_AUGDT
...
SELECT DISTINCT B04_GL_ACDOCA_RBUKRS, B04_GL_ACDOCA_AUGBL, B04_GL_ACDOCA_AUGDT INTO P08_T24_10_TT_UNIQUE_LIST_BO_AUGBL FROM P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL
EXEC SP_CREATE_INDEX 'P08_T24_10_TT_UNIQUE_LIST_BO_AUGBL', 'P08_T24_10_TT_UNIQUE_LIST_BO_AUGBL_IDX', 'B04_GL_ACDOCA_RBUKRS, B04_GL_ACDOCA_AUGBL, B04_GL_ACDOCA_AUGDT'
...
SELECT DISTINCT B04_GL_ACDOCA_RBUKRS, B04_GL_ACDOCA_GJAHR, B04_GL_ACDOCA_BELNR INTO P08_T24_11_TT_UNIQUE_LIST_BO_BELNR FROM P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL
EXEC SP_CREATE_INDEX 'P08_T24_11_TT_UNIQUE_LIST_BO_BELNR', 'P08_T24_11_TT_UNIQUE_LIST_BO_BELNR_IDX', 'B04_GL_ACDOCA_RBUKRS, B04_GL_ACDOCA_GJAHR, B04_GL_ACDOCA_BELNR'
...
SELECT 
        P08_T24_04_TT_LIST_BELNR_AUGBL.B04_GL_ACDOCA_RBUKRS, 
        P08_T24_04_TT_LIST_BELNR_AUGBL.B04_GL_ACDOCA_GJAHR, 
        P08_T24_04_TT_LIST_BELNR_AUGBL.B04_GL_ACDOCA_BELNR,
        P08_T24_04_TT_LIST_BELNR_AUGBL.B04_GL_ACDOCA_AUGBL,
        P08_T24_04_TT_LIST_BELNR_AUGBL.B04_GL_ACDOCA_AUGDT
...
FROM P08_T24_04_TT_LIST_BELNR_AUGBL
        ...
        OUTER APPLY(SELECT TOP 1 * FROM P08_T24_10_TT_UNIQUE_LIST_BO_AUGBL
                                    WHERE P08_T24_10_TT_UNIQUE_LIST_BO_AUGBL.B04_GL_ACDOCA_RBUKRS  = P08_T24_04_TT_LIST_BELNR_AUGBL.B04_GL_ACDOCA_RBUKRS
                                        AND P08_T24_10_TT_UNIQUE_LIST_BO_AUGBL.B04_GL_ACDOCA_AUGBL  = P08_T24_04_TT_LIST_BELNR_AUGBL.B04_GL_ACDOCA_AUGBL
                                        AND P08_T24_10_TT_UNIQUE_LIST_BO_AUGBL.B04_GL_ACDOCA_AUGDT  = P08_T24_04_TT_LIST_BELNR_AUGBL.B04_GL_ACDOCA_AUGDT
										AND ISNULL(P08_T24_10_TT_UNIQUE_LIST_BO_AUGBL.B04_GL_ACDOCA_AUGDT, '') <> '') XTEMP1
        ...
        OUTER APPLY(SELECT TOP 1 * FROM P08_T24_11_TT_UNIQUE_LIST_BO_BELNR
                                    WHERE P08_T24_11_TT_UNIQUE_LIST_BO_BELNR.B04_GL_ACDOCA_RBUKRS  = P08_T24_04_TT_LIST_BELNR_AUGBL.B04_GL_ACDOCA_RBUKRS
                                        AND P08_T24_11_TT_UNIQUE_LIST_BO_BELNR.B04_GL_ACDOCA_BELNR  = P08_T24_04_TT_LIST_BELNR_AUGBL.B04_GL_ACDOCA_BELNR
                                        AND P08_T24_11_TT_UNIQUE_LIST_BO_BELNR.B04_GL_ACDOCA_GJAHR  = P08_T24_04_TT_LIST_BELNR_AUGBL.B04_GL_ACDOCA_GJAHR) XTEMP2
		-- Where clause to append the matched documents AND exclude those that are already in the file as bank-out
		WHERE XTEMP1.B04_GL_ACDOCA_AUGBL IS NOT NULL AND XTEMP2.B04_GL_ACDOCA_RBUKRS IS NULL 

CREATE INDEX AUGBL ON P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL (B04_GL_ACDOCA_AUGBL);
CREATE INDEX BUKRS ON P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL (B04_GL_ACDOCA_RBUKRS);
CREATE INDEX GJAHR ON P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL (B04_GL_ACDOCA_GJAHR);
CREATE INDEX BELNR ON P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL (B04_GL_ACDOCA_BELNR);
CREATE INDEX AUGDT ON P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL (B04_GL_ACDOCA_AUGDT);
...
DELETE P08_T24_03_TT_FIN_GL_NO_BTB
	WHERE NOT EXISTS(
		SELECT TOP 1 1 FROM P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL B
			WHERE B.B04_GL_ACDOCA_RBUKRS = P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_RBUKRS
				AND B.B04_GL_ACDOCA_GJAHR = P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_GJAHR 
				AND B.B04_GL_ACDOCA_BELNR = P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_BELNR)
		
		AND NOT EXISTS(
		SELECT TOP 1 1 FROM P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL B
			WHERE B.B04_GL_ACDOCA_RBUKRS = P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_RBUKRS
				AND B.B04_GL_ACDOCA_AUGDT = P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_AUGDT 
				AND B.B04_GL_ACDOCA_AUGBL = P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_AUGBL)

EXEC SP_DROPTABLE 'P08_T24_12_TT_LIST_BELNR_DOC_TYPE'
SELECT DISTINCT 
	P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_RBUKRS, 
	P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_GJAHR, 
	P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_BELNR,
	CASE WHEN ISNULL(P08_T24_06_TT_SUPP_BELNR_DOC_TYPE.ZF_DOCUMENT_TYPE, '') <> '' THEN B07B_ACDOCA_BUZEI
	ELSE B07D_ACDOCA_BUZEI END SUPP_CUST_BUZEI,
	-- Add document types: 
	-- !!!!!!!!! Note: 
    ...
    FROM P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL
        ...
        P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_RBUKRS = P08_T24_05_TT_PAYROLL_BELNR_DOC_TYPE.B04_GL_ACDOCA_RBUKRS
        AND P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_GJAHR = P08_T24_05_TT_PAYROLL_BELNR_DOC_TYPE.B04_GL_ACDOCA_GJAHR
        AND P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_BELNR = P08_T24_05_TT_PAYROLL_BELNR_DOC_TYPE.B04_GL_ACDOCA_BELNR

        -- Get document type from suppliers
        LEFT JOIN P08_T24_06_TT_SUPP_BELNR_DOC_TYPE ON 
        P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_RBUKRS = P08_T24_06_TT_SUPP_BELNR_DOC_TYPE.B07B_ACDOCA_RBUKRS
        AND P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_GJAHR = P08_T24_06_TT_SUPP_BELNR_DOC_TYPE.B07B_ACDOCA_GJAHR 
        AND P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_BELNR = P08_T24_06_TT_SUPP_BELNR_DOC_TYPE.B07B_ACDOCA_BELNR

        -- Get document type from customers 
        LEFT JOIN P08_T24_07_TT_CUST_BELNR_DOC_TYPE ON 
        P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_RBUKRS = P08_T24_07_TT_CUST_BELNR_DOC_TYPE.B07D_ACDOCA_RBUKRS
        AND P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_GJAHR = P08_T24_07_TT_CUST_BELNR_DOC_TYPE.B07D_ACDOCA_GJAHR 
        AND P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_BELNR = P08_T24_07_TT_CUST_BELNR_DOC_TYPE.B07D_ACDOCA_BELNR
		AND B07B_ACDOCA_BUZEI = B07D_ACDOCA_BUZEI
                                       
-- Step 12/ Create indexes to increase performance for the next step
CREATE INDEX B04_ACDOCA_BELNR_IDX ON P08_T24_12_TT_LIST_BELNR_DOC_TYPE (B04_GL_ACDOCA_BELNR)
CREATE INDEX B04_ACDOCA_BUKRS_IDX ON P08_T24_12_TT_LIST_BELNR_DOC_TYPE (B04_GL_ACDOCA_RBUKRS)
CREATE INDEX B04_ACDOCA_GJAHR_IDX ON P08_T24_12_TT_LIST_BELNR_DOC_TYPE (B04_GL_ACDOCA_GJAHR)
CREATE INDEX B04_ACDOCA_BUZEI_IDX ON P08_T24_12_TT_LIST_BELNR_DOC_TYPE (SUPP_CUST_BUZEI)

EXEC SP_DROPTABLE 'P08_T24_13_TT_LIST_BELNR_DOC_LIST'
SELECT DISTINCT B04_GL_ACDOCA_RBUKRS, B04_GL_ACDOCA_GJAHR, B04_GL_ACDOCA_BELNR INTO P08_T24_13_TT_LIST_BELNR_DOC_LIST FROM P08_T24_12_TT_LIST_BELNR_DOC_TYPE
EXEC SP_CREATE_INDEX 'P08_T24_13_TT_LIST_BELNR_DOC_LIST', 'P08_T24_13_TT_LIST_BELNR_DOC_LIST_IDX' , 'B04_GL_ACDOCA_RBUKRS, B04_GL_ACDOCA_GJAHR, B04_GL_ACDOCA_BELNR'
...
RAISERROR (@errormsg, 0, 1) WITH NOWAIT
	...
	SELECT  P08_T24_03_TT_FIN_GL_NO_BTB.*,
				  ...
				  ISNULL(P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_AUGBL, P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_BELNR) ZF_AUGBL_BELNR_KEY,
				  ISNULL(P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_AUGDT, P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_GJAHR) ZF_AUGDT_GJAHR_KEY,
				  ...
				  P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_AUGBL ZF_ACDOCA_AUGBL_FILLED,
				  P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_AUGDT ZF_ACDOCA_AUGDT_FILLED,
				  ...
				  CASE 
						 WHEN ISNULL(P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_AUGDT, '') <> '' THEN EOMONTH(P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_AUGDT)          
						 ELSE EOMONTH(P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_BKPF_BUDAT)
				  ...
				  IIF(P08_T24_00_TT_AM_BANK_ACC.GL_BANK_ACC_HKONT IS NOT NULL AND P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_DRCRK = 'H',
					  EOMONTH(P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_BKPF_BUDAT),
					  DATEADD(MONTH, DATEDIFF(MONTH, 0, P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_BKPF_BUDAT), 0)) ZF_DOCUMENT_MONTH,
				  ...
				  CASE
						 ...
						 WHEN P08_T24_00_TT_AM_BANK_ACC.GL_BANK_ACC_HKONT IS NOT NULL
								AND P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_DRCRK = 'H' 
							THEN P08_T24_08_TT_BO_BELNR_DOC_TYPE.ZF_DOCUMENT_TYPE
                     
						 -- Payroll lines for which the document type is payroll 
						 WHEN P08_T24_10_TT_UNIQUE_LIST_BO_AUGBL.B04_GL_ACDOCA_AUGBL IS NOT NULL 
								AND P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_DRCRK = 'H' 
								AND P08_T24_05_TT_PAYROLL_BELNR_DOC_TYPE.B04_GL_ACDOCA_RBUKRS IS NOT NULL 
		   ...
		   INNER JOIN P08_T24_13_TT_LIST_BELNR_DOC_LIST B ON 
				 P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_RBUKRS = B.B04_GL_ACDOCA_RBUKRS
				 AND P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_GJAHR = B.B04_GL_ACDOCA_GJAHR
				 AND P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_BELNR = B.B04_GL_ACDOCA_BELNR
			  
		   LEFT JOIN P08_T24_12_TT_LIST_BELNR_DOC_TYPE ON 
				 P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_RBUKRS = P08_T24_12_TT_LIST_BELNR_DOC_TYPE.B04_GL_ACDOCA_RBUKRS
				 AND P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_GJAHR = P08_T24_12_TT_LIST_BELNR_DOC_TYPE.B04_GL_ACDOCA_GJAHR
				 AND P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_BELNR = P08_T24_12_TT_LIST_BELNR_DOC_TYPE.B04_GL_ACDOCA_BELNR
				 AND B04_GL_ACDOCA_BUZEI = P08_T24_12_TT_LIST_BELNR_DOC_TYPE.SUPP_CUST_BUZEI
			-- Add the matching key on all lines 
			...
			LEFT JOIN P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL ON 
				P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_RBUKRS = P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_RBUKRS
				AND P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_GJAHR = P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_GJAHR
				AND P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_BELNR = P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_BELNR               
		   ...
		   -- Join to the bank account numbers so that we can create the flag for bank-out lines
			...
			LEFT JOIN P08_T24_08_TT_BO_BELNR_DOC_TYPE
				on P08_T24_08_TT_BO_BELNR_DOC_TYPE.B04_GL_ACDOCA_BELNR = P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_BELNR
				AND P08_T24_08_TT_BO_BELNR_DOC_TYPE.B04_GL_ACDOCA_RBUKRS = P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_RBUKRS
				AND P08_T24_08_TT_BO_BELNR_DOC_TYPE.B04_GL_ACDOCA_GJAHR = P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_GJAHR
		   ...
		   ON P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_RBUKRS = P08_T24_05_TT_PAYROLL_BELNR_DOC_TYPE.B04_GL_ACDOCA_RBUKRS
				AND P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_GJAHR = P08_T24_05_TT_PAYROLL_BELNR_DOC_TYPE.B04_GL_ACDOCA_GJAHR
				AND P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_BELNR = P08_T24_05_TT_PAYROLL_BELNR_DOC_TYPE.B04_GL_ACDOCA_BELNR
		   ...
		   LEFT JOIN P08_T24_10_TT_UNIQUE_LIST_BO_AUGBL ON 
				P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_RBUKRS = P08_T24_10_TT_UNIQUE_LIST_BO_AUGBL.B04_GL_ACDOCA_RBUKRS
				AND P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_AUGDT = P08_T24_10_TT_UNIQUE_LIST_BO_AUGBL.B04_GL_ACDOCA_AUGDT
				AND P08_T24_09_TT_LIST_BANK_REL_BELNR_AUGBL.B04_GL_ACDOCA_AUGBL = P08_T24_10_TT_UNIQUE_LIST_BO_AUGBL.B04_GL_ACDOCA_AUGBL        

		   -- Add the supplier name
		   LEFT JOIN A_LFA1 ON
				LFA1_LIFNR = P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_LIFNR

		   -- Add the customer name
		   LEFT JOIN A_KNA1 ON 
				B04_GL_ACDOCA_KUNNR = KNA1_KUNNR

			LEFT JOIN A_T001 ON T001_BUKRS = P08_T24_03_TT_FIN_GL_NO_BTB.B04_GL_ACDOCA_RBUKRS
		WHERE P08_T24_10_TT_UNIQUE_LIST_BO_AUGBL.B04_GL_ACDOCA_AUGBL IS NOT NULL 
			OR P08_T24_08_TT_BO_BELNR_DOC_TYPE.B04_GL_ACDOCA_BELNR IS NOT NULL
	...
	--  16.1 Create a unique list of document types per matching key
		...
		SELECT B04_GL_ACDOCA_RBUKRS, ZF_ACDOCA_AUGBL_FILLED, ZF_ACDOCA_AUGDT_FILLED, ZF_LINE_TYPE
		INTO P08_T24_16_TT_LIST_AUGBL_DOC_TYPE	
		FROM P08_T24_15_TT_BANK_OUT_REM_IGNORE
		GROUP BY B04_GL_ACDOCA_RBUKRS, ZF_ACDOCA_AUGBL_FILLED, ZF_ACDOCA_AUGDT_FILLED, ZF_LINE_TYPE
		...
		ZF_ACDOCA_AUGBL_FILLED, 
		ZF_ACDOCA_AUGDT_FILLED
		--Create a list of document types
		 ,DBO.TRIM(STUFF((SELECT ', ' + ZF_LINE_TYPE
		 FROM P08_T24_16_TT_LIST_AUGBL_DOC_TYPE b
		 WHERE (b.B04_GL_ACDOCA_RBUKRS = P08_T24_16_TT_LIST_AUGBL_DOC_TYPE.B04_GL_ACDOCA_RBUKRS  
			AND b.ZF_ACDOCA_AUGBL_FILLED = P08_T24_16_TT_LIST_AUGBL_DOC_TYPE.ZF_ACDOCA_AUGBL_FILLED
			AND b.ZF_ACDOCA_AUGDT_FILLED = P08_T24_16_TT_LIST_AUGBL_DOC_TYPE.ZF_ACDOCA_AUGDT_FILLED)
	...
	--         -- Calculate pro-rata value for journal entry lines that were repeated
		...
		SELECT P08_T24_15_TT_BANK_OUT_REM_IGNORE.*,
				...
				B04_GL_ZF_ACDOCA_KSL_S / ZF_NUM_OCCURENCES ZF_ACDOCA_KSL_S_PRORATA,
				B04_GL_ZF_ACDOCA_OSL_S / ZF_NUM_OCCURENCES ZF_ACDOCA_OSL_S_PRORATA,
				B04_GL_ZF_ACDOCA_HSL_S / ZF_NUM_OCCURENCES ZF_ACDOCA_HSL_S_PRORATA,
				B04_GL_ZF_ACDOCA_HSL_S_CUC / ZF_NUM_OCCURENCES ZF_ACDOCA_HSL_S_CUC_PRORATA
		...
		LEFT JOIN P08_T24_17_TT_LIST_AUGBL_DOC_TYPE ON
			 P08_T24_17_TT_LIST_AUGBL_DOC_TYPE.B04_GL_ACDOCA_RBUKRS = P08_T24_15_TT_BANK_OUT_REM_IGNORE.B04_GL_ACDOCA_RBUKRS AND
			 P08_T24_17_TT_LIST_AUGBL_DOC_TYPE.ZF_ACDOCA_AUGBL_FILLED = P08_T24_15_TT_BANK_OUT_REM_IGNORE.ZF_ACDOCA_AUGBL_FILLED AND 
			 P08_T24_17_TT_LIST_AUGBL_DOC_TYPE.ZF_ACDOCA_AUGDT_FILLED = P08_T24_15_TT_BANK_OUT_REM_IGNORE.ZF_ACDOCA_AUGDT_FILLED
		...
		LEFT JOIN P08_T24_18_TT_NUM_OCC_JELINE ON
				P08_T24_15_TT_BANK_OUT_REM_IGNORE.B04_GL_ACDOCA_RBUKRS = P08_T24_18_TT_NUM_OCC_JELINE.B04_GL_ACDOCA_RBUKRS
				AND P08_T24_15_TT_BANK_OUT_REM_IGNORE.B04_GL_ACDOCA_GJAHR = P08_T24_18_TT_NUM_OCC_JELINE.B04_GL_ACDOCA_GJAHR
				AND P08_T24_15_TT_BANK_OUT_REM_IGNORE.B04_GL_ACDOCA_BELNR = P08_T24_18_TT_NUM_OCC_JELINE.B04_GL_ACDOCA_BELNR
				AND P08_T24_15_TT_BANK_OUT_REM_IGNORE.B04_GL_ACDOCA_BUZEI = P08_T24_18_TT_NUM_OCC_JELINE.B04_GL_ACDOCA_BUZEI
