...
GO
CREATE PROCEDURE [dbo].[script_PM02_OTC_PROCESS_MINING_NEW]
AS
...
SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,
		...
		B14_01_T001_WAERS
FROM PM_OTC_01_TT_ADD_FLAG_GLOBAL 
WHERE ISNULL(B14_01_ACDOCA_BLDAT,'')<>''
--Add Invoice cancellation keys
UNION
SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,
		B14_02_ZF_CREDIT_NOTE_KEY AS ZF_DOCUMENT_NUMBER,
		B14_02_ACDOCA_BLDAT AS  'ZF_DATE_USED_IN_MODEL',
		...
		B14_02_T001_WAERS
FROM PM_OTC_01_TT_ADD_FLAG_GLOBAL 
WHERE ISNULL(B14_02_ACDOCA_BLDAT,'')<>''
--Add payment keys
UNION
SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,
		B14_03_ZF_CUSTOMER_PAYMENT_KEY AS ZF_DOCUMENT_NUMBER,
		B14_03_ACDOCA_BLDAT AS  'ZF_DATE_USED_IN_MODEL',
...
SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,
		...
		B14_04_T001_WAERS
FROM PM_OTC_01_TT_ADD_FLAG_GLOBAL 
WHERE ISNULL(B14_04_ACDOCA_BLDAT,'')<>''
...
/*SELECT DISTINCT A.ZF_DOCUMENT_FLOW_KEY,
	...
	WHERE 
	 B24_19_CDHDR_UDATE BETWEEN -- A.ZF_START_DATE AND A.ZF_END_DATE
	 (
	 SELECT TOP 1 ZF_START_DATE
	  FROM PM_OTC_05_IT_ADD_START_END
	  WHERE PM_OTC_05_IT_ADD_START_END.ZF_DOCUMENT_FLOW_KEY=A.ZF_DOCUMENT_FLOW_KEY
	 )
	 AND 
	 	 (
	 SELECT TOP 1 ZF_END_DATE
	  FROM PM_OTC_05_IT_ADD_START_END
	  WHERE PM_OTC_05_IT_ADD_START_END.ZF_DOCUMENT_FLOW_KEY=A.ZF_DOCUMENT_FLOW_KEY
	 )*/
SELECT DISTINCT A.ZF_DOCUMENT_FLOW_KEY,
...
FROM B31_05_IT_CENTER_FACT_TABLE_ADD_INV_PAY
 WHERE B14_03_ACDOCA_BLDAT IS NOT NULL
...
--EXEC SP_DROPTABLE TEST1
--SELECT DISTINCT ZF_DOCUMENT_NUMBER
--INTO TEST1
--FROM PM_OTC_11_RT_PROCESS_MINING
--WHERE
--ZF_PATH_DESC='10_FI_invoice'

--EXEC SP_DROPTABLE TEST2
--SELECT DISTINCT B14_01_ZF_CUSTOMER_INVOICE_KEY,
--B14_01_ACDOCA_AUGBL,B14_01_ACDOCA_AUGDT
--INTO TEST2
--FROM B14_SS01_01_IT_CUSTOMER_INVOICE
--WHERE B14_01_ZF_CUSTOMER_INVOICE_KEY
--IN
--(
--	SELECT *
--	FROM TEST1
--)
--AND LEN(B14_01_ACDOCA_AUGBL)>0


--SELECT *
--FROM TEST2
--WHERE LEN(B14_01_ACDOCA_AUGBL)=0

--EXEC SP_DROPTABLE TEST3
--SELECT DISTINCT TEST2.*, B14_ACDOCA_AUGBL,B14_ACDOCA_AUGDT,B14_ZF_AR_DOC_TYPE_BUCKET
--INTO TEST3
--FROM  TEST2
--LEFT JOIN B14_06_IT_ARE
--ON B14_01_ACDOCA_AUGBL=B14_ACDOCA_AUGBL
--AND B14_01_ACDOCA_AUGDT=B14_ACDOCA_AUGDT
--WHERE B14_ZF_AR_DOC_TYPE_BUCKET <>'Customer invoice'
...
--SELECT DISTINCT 
--B14_ACDOCA_BELNR,B14_ACDOCA_GJAHR,B14_ACDOCA_BUZEI,B14_ACDOCA_RBUKRS
--INTO TT2
--FROM B14_06_IT_ARE
--WHERE B14_ACDOCA_AUGBL+CAST(B14_ACDOCA_AUGDT AS NVARCHAR) IN
--(
--SELECT
--B14_01_ACDOCA_AUGBL+CAST(B14_01_ACDOCA_AUGDT AS NVARCHAR)
--FROM TEST3
--)

--SELECT DISTINCT B14_ZF_AR_DOC_TYPE_BUCKET
--FROM 
--B14_06_IT_ARE
--WHERE B14_ACDOCA_BELNR+B14_ACDOCA_GJAHR+B14_ACDOCA_BUZEI+B14_ACDOCA_RBUKRS
--IN
--(
--	SELECT B14_ACDOCA_BELNR+B14_ACDOCA_GJAHR+B14_ACDOCA_BUZEI+B14_ACDOCA_RBUKRS
--	FROM TT2
--)

--WHERE B14_ACDOCA_AUGBL='0466508172' AND B14_ACDOCA_AUGDT='2022-03-23'

--SELECT *
--FROM B31_05_IT_CENTER_FACT_TABLE_ADD_INV_PAY
--WHERE
--ZF_DOCUMENT_FLOW_KEY IN (209552,271355)


--SELECT *
--FROM PM_OTC_11_RT_PROCESS_MINING
--WHERE ZF_DOCUMENT_NUMBER='VN00|2021|3440000054|001'

--SELECT
--*
--FROM B31_05_04_TT_INV_PAY_APPEND
--WHERE B14_01_ZF_CUSTOMER_INVOICE_KEY='VN00|2021|3440000054|001'


--B14_ACDOCA_BELNR	B14_ACDOCA_GJAHR	B14_ACDOCA_BUZEI
		
--SELECT B14_01_ZF_CUSTOMER_INVOICE_KEY
--FROM B14_SS01_01_IT_CUSTOMER_INVOICE 
--WHERE B14_01_ACDOCA_AUGBL='0466501831' AND B14_01_ACDOCA_AUGDT='2021-06-29'
...
--FROM B14_06_IT_ARE
--WHERE 
--B14_ACDOCA_AUGBL='0406500114' AND B14_ACDOCA_AUGDT='2022-02-14'
	
--SELECT DISTINCT *
--FROM TEST3

--SELECT B14_ACDOCA_BELNR,B14_ACDOCA_GJAHR,B14_ACDOCA_BUZEI
--FROM B14_06_IT_ARE
--WHERE 
--B14_ACDOCA_AUGBL='0466507517' AND B14_ACDOCA_AUGDT='2021-04-02'

--SELECT *
--FROM B07_03_IT_FIN_AR_INV_PAY_FLAGS
--WHERE
--B07D_ACDOCA_BELNR='0015190746'	AND B07D_ACDOCA_GJAHR='2020' 


--SELECT *
--FROM B00_ACDOCA
--WHERE 
--ACDOCA_BELNR='0015190746'	AND ACDOCA_GJAHR='2020' AND ACDOCA_RBUKRS='VN00'
...
--SELECT B14_ACDOCA_AUGBL	B14_ACDOCA_AUGDT
--0416507011	2021-08-24

--SELECT B14_ACDOCA_RBUKRS,B14_ACDOCA_BELNR,B14_ACDOCA_GJAHR,B14_ACDOCA_BUZEI,
--B14_ACDOCA_DOCLN,B14_ZF_AR_DOC_TYPE_BUCKET,B14_ACDOCA_AUGBL,B14_ACDOCA_AUGDT,
--B14_ZF_ACDOCA_HSL_S,B14_ZF_ACDOCA_HSL_S_CUC,
--*
--FROM 
--B14_06_IT_ARE
--WHERE EXISTS
...
--	SELECT TOP 1 1
--	FROM TEST3 
--	WHERE B14_06_IT_ARE.B14_ACDOCA_AUGBL=TEST3.B14_ACDOCA_AUGBL 
--	AND B14_06_IT_ARE.B14_ACDOCA_AUGDT=TEST3.B14_ACDOCA_AUGDT
--)
--ORDER BY B14_06_IT_ARE.B14_ACDOCA_AUGBL,B14_06_IT_ARE.B14_ACDOCA_AUGDT
...
--B14_06_IT_ARE 
--WHERE
--B14_ACDOCA_AUGBL='0416503534' AND B14_ACDOCA_AUGDT='2021-06-21'
...
--FROM
--TEST3
--B14_ACDOCA_AUGBL,B14_ACDOCA_AUGDT


--GROUP BY B14_ACDOCA_AUGBL,B14_ACDOCA_AUGDT
--ORDER BY SUM(B14_ZF_ACDOCA_HSL_S_CUC) DESC


--B14_ACDOCA_AUGBL='0416503220' AND B14_ACDOCA_AUGDT='2022-05-18'
