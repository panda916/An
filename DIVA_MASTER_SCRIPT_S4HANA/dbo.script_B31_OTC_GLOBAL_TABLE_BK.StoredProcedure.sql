...
GO
CREATE     PROCEDURE [dbo].[script_B31_OTC_GLOBAL_TABLE_BK] 
AS
...
*/
	...
	FROM B31_04_TT_CENTER_FACT_TABLE_UNION
		...
		FULL OUTER JOIN B14_SS01_01_IT_CUSTOMER_INVOICE  
	...
	AND B30_TVKO_BUKRS_MAPPING=B14_01_ACDOCA_BUKRS_MAPPING
		...
		FULL OUTER JOIN B14_SS01_03_IT_CUSTOMER_PAYMENT
	...
	AND (B14_01_ACDOCA_AUGBL<>'' AND B14_03_ACDOCA_AUGBL<>'')
		...
		FULL OUTER JOIN B14_SS01_04_IT_CUSTOMER_PAYMENT_CANCEL
