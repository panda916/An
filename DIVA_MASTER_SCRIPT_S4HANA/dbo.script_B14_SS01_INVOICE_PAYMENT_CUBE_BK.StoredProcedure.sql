...
CREATE     PROCEDURE [dbo].[script_B14_SS01_INVOICE_PAYMENT_CUBE_BK]
AS 
...
B14_ACDOCA_ZTERM AS ACDOCA_ZTERM,
...
B14_ZF_ACDOCA_VBRK_USED_PMNT_TERM AS ZF_ACDOCA_VBRK_USED_PMNT_TERM,
B14_ACDOCA_ZFBDT AS ACDOCA_ZFBDT,
B14_ACDOCA_ZBD1T AS ACDOCA_ZBD1T,
B14_ACDOCA_ZBD2T AS ACDOCA_ZBD2T,
B14_ACDOCA_ZBD3T AS ACDOCA_ZBD3T,
...
B14_ZF_ACDOCA_CPUDT_MINUS_ZFBDT AS ZF_ACDOCA_CPUDT_MINUS_ZFBDT,
B14_ZF_ACDOCA_BLDAT_MINUS_BUDAT AS ZF_ACDOCA_BLDAT_MINUS_BUDAT,
B14_ZF_ACDOCA_BLDAT_MINUS_ZFBDT AS ZF_ACDOCA_BLDAT_MINUS_ZFBDT,
...
B14_ACDOCA_ZBD1P AS ACDOCA_ZBD1P,
B14_ACDOCA_ZBD2P AS ACDOCA_ZBD2P,
B14_ZF_ACDOCA_WSKTO_ACTUAL_DISCOUNT AS ZF_ACDOCA_WSKTO_ACTUAL_DISCOUNT,
...
CONCAT(
			...
			ACDOCA_GJAHR,'|',
			ACDOCA_BELNR,'|',
			ACDOCA_BUZEI) AS ZF_CUSTOMER_INVOICE_CANCELLATION_KEY
...
--Khoi Update get the incoming payment
EXEC SP_DROPTABLE 'B14_SS01_05_IT_CUSTOMER_INCOMING_PAYMENT'
SELECT *,
CONCAT(
			ACDOCA_RBUKRS,'|',
			ACDOCA_GJAHR,'|',
			ACDOCA_BELNR,'|',
			ACDOCA_BUZEI) AS ZF_CUSTOMER_INCOMING_PAYMENT
INTO B14_SS01_05_IT_CUSTOMER_INCOMING_PAYMENT
FROM B14_SS01_01A_TT_ADD_SALE_ORG
WHERE ZF_AR_DOC_TYPE_BUCKET='Incoming payment'
...
EXEC SP_RENAME_FIELD 'B14_05_',B14_SS01_05_IT_CUSTOMER_INCOMING_PAYMENT
GO
