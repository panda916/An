...
SELECT  ZF_DOCUMENT_FLOW_KEY,
		...
		B26_03_MKPF_CPUTM AS 'ZF_TIME_USED_IN_MODEL',
...
UPDATE PM_OTC_11_RT_PROCESS_MINING
SET ZF_SO_HAS_PRICE_CHANGE=''



UPDATE PM_OTC_11_RT_PROCESS_MINING
SET ZF_SO_HAS_PRICE_CHANGE='X'
WHERE 
ZF_PATH_DESC
LIKE '%2_%' AND ZF_PATH_DESC LIKE '%3_SO change price%'
