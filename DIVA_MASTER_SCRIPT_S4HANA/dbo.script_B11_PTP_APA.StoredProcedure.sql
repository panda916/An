...
/*Change history comments*/
  ...
  Description: Generates up to three cubes:
	...
	15-08-2024		  HL	Changed the logic of due date - using the field ACDOCA_NETDT instead of fields from BSEG
  */
...
--Fields are being calculated as mentioned in SELECT clause below*/ 
	...
	SELECT 	
		...
		B07_03_IT_FIN_AP_INV_PAY_FLAGS.B07B_ACDOCA_NETDT AS  ACDOCA_NETDT,
		...
		B07_03_IT_FIN_AP_INV_PAY_FLAGS.B07B_ACDOCA_MATNR AS ACDOCA_MATNR,
		ACDOCA_KOART,
		...
		DATEDIFF(d,
			...
			END) ZF_ACDOCA_AUGDT_MINUS_NETDT,
		...
		CASE 
			...
			ELSE 'Late Payment' 
		END ZF_ACDOCA_NETDT_AUGDT_EARLY_OR_LATE_DESC,
	  ...
	  FROM B07_03_IT_FIN_AP_INV_PAY_FLAGS
       ...
       -- Add the controlling area in order to be able to add profit center information		
		...
		AND LFB1_BUKRS=B07B_ACDOCA_RBUKRS
...
*/
   ...
   EXEC SP_REMOVE_TABLES 'B11_04_IT_PTP_APA'
	 ...
	 SELECT B11_03_TT_PTP_APA.*
		...
		,CASE 
			WHEN ZF_ACDOCA_AUGDT_MINUS_NETDT < - 10 THEN '< -10' 
			WHEN ZF_ACDOCA_AUGDT_MINUS_NETDT < 0 THEN '-10 - -1'  
			WHEN ZF_ACDOCA_AUGDT_MINUS_NETDT <= 10 THEN '01 - 10'
			WHEN ZF_ACDOCA_AUGDT_MINUS_NETDT <= 20 THEN '11 - 20'
			WHEN ZF_ACDOCA_AUGDT_MINUS_NETDT <= 30 THEN '21 - 30'
			WHEN ZF_ACDOCA_AUGDT_MINUS_NETDT <= 60 THEN '31 - 60'
			WHEN ZF_ACDOCA_AUGDT_MINUS_NETDT <= 90 THEN '61 - 90'
			WHEN ZF_ACDOCA_AUGDT_MINUS_NETDT <= 120 THEN '91 - 120'
			WHEN ZF_ACDOCA_AUGDT_MINUS_NETDT > 120 THEN '121 +'
			ELSE	'No clearinng date or due date'
		END	AS ZF_NETDT_AUGDT_DAYS_LATE_RANGE
		,CASE 
		...
		,CASE
				WHEN ZF_ACDOCA_AUGDT_MINUS_NETDT < -10 THEN '< -10'
				WHEN ZF_ACDOCA_AUGDT_MINUS_NETDT < 0 THEN '-10 - -1'
				WHEN ZF_ACDOCA_AUGDT_MINUS_NETDT = 0 THEN '0'
				WHEN ZF_ACDOCA_AUGDT_MINUS_NETDT <= 10 THEN '>0 - 10'
				WHEN ZF_ACDOCA_AUGDT_MINUS_NETDT <= 20 THEN '11 - 20'
				WHEN ZF_ACDOCA_AUGDT_MINUS_NETDT <= 30 THEN '21 - 30'
				WHEN ZF_ACDOCA_AUGDT_MINUS_NETDT <= 60 THEN '31 - 60'	
				WHEN ZF_ACDOCA_AUGDT_MINUS_NETDT <= 90 THEN '61 - 90'
				...
				WHEN ZF_ACDOCA_AUGDT_MINUS_NETDT > 120 THEN '121 +'
				ELSE 'No clearinng date or due date'
		END ZF_AUGDT_MINUS_NETDT_CATEGORY
		-- Add the value for early payments
		,CASE
			WHEN ZF_ACDOCA_NETDT_AUGDT_EARLY_OR_LATE_DESC = 'Early Payment'
				THEN ZF_ACDOCA_HSL_S_CUC
			ELSE 0
		 END AS ZF_EARLY_PAYMENT_VAL
		 -- Add the value for on-time payments
		,CASE
			WHEN ZF_ACDOCA_NETDT_AUGDT_EARLY_OR_LATE_DESC = 'On-time Payment'
				THEN ZF_ACDOCA_HSL_S_CUC
			ELSE 0
		 END AS ZF_ONTIME_PAYMENT_VAL
		 -- Add the value for late payments
		,CASE
			WHEN ZF_ACDOCA_NETDT_AUGDT_EARLY_OR_LATE_DESC = 'Late Payment'
				THEN ZF_ACDOCA_HSL_S_CUC
			ELSE 0
...
-- add compay code, mandant and fiscal year variant
	...
	SELECT
		B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_RCLNT
		,B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_RBUKRS
		,B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_GJAHR
		,B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BELNR
		,B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BUZEI
		,B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_DOCLN
		,B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END
		,B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_AUGDT
		,B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_LIFNR
		,DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_NETDT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) AS ZF_SNAPSHOT_DATE_MINUS_ACDOCA_DUE_DATE --ZF_ACDOCA_NETDT_DIFF 
		,B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BLDAT -- Document date
		,DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BLDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) AS ZF_SNAPSHOT_DATE_MINUS_ACDOCA_BLDAT --Z_Age (document date)
		,B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BUDAT--Posting date
		,DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BUDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) AS ZF_SNAPSHOT_DATE_MINUS_ACDOCA_BUDAT --Z_Age (posting date)
		,CASE
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_NETDT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) < -360 THEN '1. < -360' 
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_NETDT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN -360 AND -181 THEN '2. -360 to -181'
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_NETDT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN -180 AND -91 THEN '3. -180 to -91'
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_NETDT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN -90 AND -31 THEN '4. -90 to -31'
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_NETDT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN -30 AND -1 THEN '5. -30 to -1'
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_NETDT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) = 0 THEN '6. = 0' 
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_NETDT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN 0  AND 30 THEN '7. 1 to 30' 
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_NETDT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN 30 AND 60 THEN '8. 31 to 60' 
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_NETDT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN 60 AND 90 THEN '9. 61 to 90' 
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_NETDT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN 90 AND 180 THEN '10. 91 to 180' 
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_NETDT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN 180 AND 360 THEN '11. 181 to 360'
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_NETDT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) > 360 THEN '12. > 360'
			ELSE 'No due date available'
		END ZF_ACDOCA_NETDT_AGE_BUCKET
	   ,CASE
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BLDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) < -360 THEN '1. < -360' 
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BLDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN -360 AND -181 THEN '2. -360 to -181'
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BLDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN -180 AND -91 THEN '3. -180 to -91'
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BLDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN -90 AND -31 THEN '4. -90 to -31'
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BLDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN -30 AND -1 THEN '5. -30 to -1'
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BLDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) = 0 THEN '6. = 0' 
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BLDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN 0 AND 30 THEN '7. 1 to 30'
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BLDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN 30 AND 60 THEN '8. 31 to 60'
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BLDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN 60 AND 90 THEN '9. 61 to 90'
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BLDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN 90 AND 180 THEN '10. 91 to 180'
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BLDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN 180 AND 360 THEN '11. 181 to 360'
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BLDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) > 360 THEN '12. > 360'
--			ELSE '0. Unknown'
			ELSE 'No document date available'
		END ZF_BLDAT_AGE_BUCKET
	   ,CASE 
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BUDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) < -360 THEN '< -360' 
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BUDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN -360 AND -181 THEN '-360 to -181'
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BUDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN -180 AND -91 THEN '-180 to -91'
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BUDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN -90 AND -31 THEN '-90 to -31'
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BUDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN -30 AND -1 THEN '-30 to -1'
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BUDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) = 0 THEN '= 0'
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BUDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN 0 AND 30 THEN '2. 1 to 30' 
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BUDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN 30 AND 60 THEN '3. 31 to 60' 
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BUDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN 60 AND 90 THEN '4. 91 to 90' 
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BUDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN 90 AND 180 THEN '5. 91 to 180' 
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BUDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) BETWEEN 180 AND 360 THEN '6. 181 to 360'
			WHEN DATEDIFF(dd, B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BUDAT, B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END) > 360 THEN '7. > 360'
	...
	ON  B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_RBUKRS = B11_12_TT_SNAPSHOT_BUKRS.T001_BUKRS
	WHERE (ISNULL(B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_AUGDT, '') = '' AND B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BUDAT <= B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END )
	--EXTRA SCRIPT
	OR (B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_AUGDT > B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END  AND B11_05_IT_PTP_INVS_AND_CANCS.ACDOCA_BUDAT <= B11_12_TT_SNAPSHOT_BUKRS.ZF_MNTH_END )
...
SELECT A.*, B.*
	   ,CASE 
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BUDAT, B.B11E_ACDOCA_BUDAT) < -360 THEN '< -360' 
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BUDAT, B.B11E_ACDOCA_BUDAT) BETWEEN -360 AND -181 THEN '-360 to -181'
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BUDAT, B.B11E_ACDOCA_BUDAT) BETWEEN -180 AND -91 THEN '-180 to -91'
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BUDAT, B.B11E_ACDOCA_BUDAT) BETWEEN -90 AND -31 THEN '-90 to -31'
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BUDAT, B.B11E_ACDOCA_BUDAT) BETWEEN -30 AND -1 THEN '-30 to -1'
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BUDAT, B.B11E_ACDOCA_BUDAT) = 0 THEN '= 0'
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BUDAT, B.B11E_ACDOCA_BUDAT) BETWEEN 1 AND 33 THEN '1 to 33' 
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BUDAT, B.B11E_ACDOCA_BUDAT) BETWEEN 34 AND 60 THEN '34 t0 60' 
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BUDAT, B.B11E_ACDOCA_BUDAT) BETWEEN 61 AND 90 THEN '61 to 90' 
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BUDAT, B.B11E_ACDOCA_BUDAT) BETWEEN 91 AND 120 THEN '91 to 120' 
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BUDAT, B.B11E_ACDOCA_BUDAT) BETWEEN 121 AND 180 THEN '121 to 180' 
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BUDAT, B.B11E_ACDOCA_BUDAT) BETWEEN 181 AND 360 THEN '181 to 360'
ELSE '> 360'
		END ZF_PAY_MINUS_INV_BUDAT_BUCKET
		,CASE 
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BLDAT, B.B11E_ACDOCA_BLDAT) < -360 THEN '< -360' 
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BLDAT, B.B11E_ACDOCA_BLDAT) BETWEEN -360 AND -181 THEN '-360 to -181'
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BLDAT, B.B11E_ACDOCA_BLDAT) BETWEEN -180 AND -91 THEN '-180 to -91'
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BLDAT, B.B11E_ACDOCA_BLDAT) BETWEEN -90 AND -31 THEN '-90 to -31'
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BLDAT, B.B11E_ACDOCA_BLDAT) BETWEEN -30 AND -1 THEN '-30 to -1'
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BLDAT, B.B11E_ACDOCA_BLDAT) = 0 THEN '= 0' 
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BLDAT, B.B11E_ACDOCA_BLDAT) BETWEEN 1 AND 33 THEN '1 to 33' 
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BLDAT, B.B11E_ACDOCA_BLDAT) BETWEEN 34 AND 60 THEN '34 to 60' 
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BLDAT, B.B11E_ACDOCA_BLDAT) BETWEEN 61 AND 90 THEN '61 to 90' 
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BLDAT, B.B11E_ACDOCA_BLDAT) BETWEEN 91 AND 120 THEN '91 to 120' 
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BLDAT, B.B11E_ACDOCA_BLDAT) BETWEEN 121 AND 180 THEN '121 to 180' 
			WHEN DATEDIFF(dd, A.B11C_ACDOCA_BLDAT, B.B11E_ACDOCA_BLDAT) BETWEEN 181 AND 360 THEN '181 to 360'
			ELSE '> 360'
