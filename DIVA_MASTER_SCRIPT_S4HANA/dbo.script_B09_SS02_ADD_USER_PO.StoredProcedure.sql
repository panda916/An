...
GO
/****** Object:  StoredProcedure [dbo].[script_B09_SS02_ADD_USER_PO]    Script Date: 7/29/2023 11:43:11 PM ******/
...
SELECT DISTINCT
	...
	COALESCE (B08_02_IT_PTP_SMD.B08_LFA1_ERNAM,'')	AS LFA1_ERNAM, --User who create the supplier,
	COALESCE (B08_02_IT_PTP_SMD.B08_LFA1_ERDAT,'')	AS LFA1_ERDAT, --Supplier create date,
	...
	BUKRS_MAPPING AS EKPO_BUKRS_MAPPING
	INTO B09_SS02_01_IT_PTP_POS
FROM B09_13_IT_PTP_POS
LEFT JOIN 	B08_02_IT_PTP_SMD
		ON B09_EKKO_LIFNR = B08_02_IT_PTP_SMD.B08_EKKO_LIFNR 
