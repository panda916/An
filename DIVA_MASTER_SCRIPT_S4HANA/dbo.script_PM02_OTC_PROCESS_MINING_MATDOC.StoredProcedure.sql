...
GO
CREATE   PROCEDURE [dbo].[script_PM02_OTC_PROCESS_MINING_MATDOC]
AS
...
SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,
		...
		B28_VBAP_ERZET AS 'ZF_TIME_USED_IN_MODEL',
		...
		'X' AS ZF_SALE_DOC,
		B28_T001_WAERS AS ZF_COMPANY_CURRENCY
...
SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,
		...
		B29_LIPS_ERZET AS 'ZF_TIME_USED_IN_MODEL',
		...
		'' AS ZF_BILLING_DOCUMENT,
		'',
		B29_T001_WAERS  AS ZF_COMPANY_CURRENCY
FROM PM_OTC_01_TT_ADD_FLAG_GLOBAL 
...
SELECT  ZF_DOCUMENT_FLOW_KEY,
		...
		B26_03_MATDOC_CPUDT AS  'ZF_DATE_USED_IN_MODEL',
		B26_03_MATDOC_CPUTM AS 'ZF_TIME_USED_IN_MODEL',
		B26_03_MATDOC_USNAM AS 'ZF_USER',
		B26_03_V_USERNAME_NAME_TEXT,
		B26_03_ZF_MATDOC_DMBTR_SIGNED AS 'ZF_AMOUNT_COC',
		B26_03_ZF_MATDOC_DMBTR_SIGNED_CUC AS 'ZF_AMOUNT_CUC',
		B26_03_ZF_MATDOC_DMBTR_SIGNED_CUC,
		B26_03_ZF_MATDOC_DMBTR_SIGNED_CUC,
		B26_03_MATDOC_KUNNR AS 'ZF_CUSTOMER',
		B26_03_MATDOC_BUKRS AS 'ZF_COMPANY_CODE',
		'6_Good_issue' AS ZF_CONCECPT_NAME_WITH_NUM,
		'Good issue' AS ZF_CONCECPT_NAME,
		B26_03_MATDOC_BLART AS ZF_DOCUMENT_TYPE,
		ZF_INVOICE_HAS_SO_FLAG,
		ZF_PAYMENT_HAS_SO_FLAG,
		6 AS ZF_STAGE,
		'' AS ZF_BILLING_DOCUMENT,
		...
		B26_03_MATDOC_WAERS
FROM PM_OTC_01_TT_ADD_FLAG_GLOBAL
WHERE ISNULL(B26_03_MATDOC_CPUDT,'')<>''
...
SELECT  ZF_DOCUMENT_FLOW_KEY,
		...
		B30_VBRK_ERZET AS 'ZF_TIME_USED_IN_MODEL',
		...
		'',
		B30_T001_WAERS AS ZF_COMPANY_CURRENCY
FROM PM_OTC_01_TT_ADD_FLAG_GLOBAL 
...
SELECT DISTINCT ZF_DOCUMENT_FLOW_KEY,
		...
		B14_01_ACDOCA_CPUDT AS  'ZF_DATE_USED_IN_MODEL',
		B14_01_ACDOCA_CPUTM AS 'ZF_TIME_USED_IN_MODEL',
		...
		B14_01_T001_WAERS
FROM PM_OTC_01_TT_ADD_FLAG_GLOBAL 
WHERE ISNULL(B14_01_ACDOCA_KUNNR,'')<>''
...
SELECT DISTINCT
	...
	CONCAT(
		...
		B24_21_CDHDR_UTIME AS  'ZF_TIME_USED_IN_MODEL',
...
SELECT DISTINCT A.ZF_DOCUMENT_FLOW_KEY,
	CONCAT(
		...
		B24_23_CDHDR_UTIME AS  'ZF_TIME_USED_IN_MODEL',
...
SELECT DISTINCT A.ZF_DOCUMENT_FLOW_KEY,
	CONCAT(
		...
		B24_25_CDHDR_UTIME AS  'ZF_TIME_USED_IN_MODEL',
...
SELECT DISTINCT A.ZF_DOCUMENT_FLOW_KEY,
	CONCAT(
		...
		B24_19_CDHDR_UTIME AS  'ZF_TIME_USED_IN_MODEL',
...
FROM B31_05_IT_CENTER_FACT_TABLE_ADD_INV_PAY
 WHERE B14_01_ACDOCA_BLART IS NOT NULL
