...
UPDATE TEMP1
SET Entity = 'RCD-SIE', Entity_new_mapping = 'RCD-SIE'
WHERE Entity = 'SIE'
...
INTO TT_TABLE_LIST
FROM INFORMATION_SCHEMA.TABLES 
WHERE TABLE_NAME LIKE 'FY21%' OR TABLE_NAME LIKE 'FY22%'
...
INTO TT_TABLE_LIST
FROM INFORMATION_SCHEMA.TABLES 
WHERE TABLE_NAME LIKE 'B_03_IT_FY21%' OR TABLE_NAME LIKE 'B_03_IT_FY22%'
...
UPDATE B_04_IT_SOX_TEST_FINAL SET Entity_new_mapping='RCD-SIE' WHERE Entity='SIE'
...
UPDATE B_04_IT_SOX_TEST_FINAL SET FY_Week_new='2.FY21Mar' WHERE FY_Week_new='FY21Mar'
...
UPDATE B_04_IT_SOX_TEST_FINAL  SET Quarter_compare='FY20Mar_FY21Mar' WHERE FY_Week IN ('FY20Mar','FY21Mar')
UPDATE B_04_IT_SOX_TEST_FINAL  SET Quarter_compare='FY20Apr_FY21Apr' WHERE FY_Week IN ('FY20Apr','FY21Apr')
UPDATE B_04_IT_SOX_TEST_FINAL  SET Quarter_compare='FY21June' WHERE FY_Week IN ('FY21June')

--  13/09/2022 Update B_04 table with excel file from FY22

UPDATE B_04_IT_SOX_TEST_FINAL
SET [Fiscal year] = 'FY22'
WHERE ZF_SOURCE LIKE 'FY22%'

-- 203 : SMOK : have in bussie
-- 23 : SMOJ :


UPDATE B_04_IT_SOX_TEST_FINAL
SET Entity = 'SMOJ', Entity_new_mapping = 'SMOJ', Business = 'Entertainment, Technology & Services (ET&S)', [Office / Segment] = 'Japan'
WHERE Entity_new_mapping = 'SOMK'

UPDATE B_04_IT_SOX_TEST_FINAL
SET Entity = 'SMOJ', Entity_new_mapping = 'SMOJ', Business = 'Entertainment, Technology & Services (ET&S)', [Office / Segment] = 'Japan'
WHERE Entity_new_mapping = 'SMOJ'


-- Update value based on request from YeanChoo

SELECT * INTO B_04_IT_SOX_TEST_FINAL_BK FROM B_04_IT_SOX_TEST_FINAL
UPDATE B_04_IT_SOX_TEST_FINAL
SET Entity = 'SMOJ'
WHERE Entity = 'SOMK'

--UPDATE B_04_IT_SOX_TEST_FINAL
--SET Entity_new_mapping = 'SMOJ'
--WHERE Entity_new_mapping = 'SOMK'
...
UPDATE B_04_IT_SOX_TEST_FINAL
SET Entity_new_mapping = 'SFGI'
WHERE Entity_new_mapping = 'SFG'

UPDATE B_04_IT_SOX_TEST_FINAL
SET Business = 'Entertainment, Technology & Services (ET&S)'
WHERE Business = 'Electronics Products & Solutions (EP&S)'

UPDATE B_04_IT_SOX_TEST_FINAL
SET [Office / Segment] = 'Japan', Business = 'Entertainment, Technology & Services (ET&S)'
WHERE Entity = 'SNC'
...
SELECT * FROM B_04_IT_SOX_TEST_FINAL
WHERE ZF_SOURCE LIKE 'FY22%'

SELECT * FROM B_04_IT_SOX_TEST_FINAL
WHERE Entity = 'SIE' AND [Significant Account ( 20F Basis )] = 'FSCP'

END


SELECT DISTINCT FY_Week , Quarter_compare, * FROM B_04_IT_SOX_TEST_FINAL
WHERE Entity = 'STTB' AND [Fiscal year] = 'FY22'

SELECT * FROM FY22Sep_SGTS_SGTS
GO
